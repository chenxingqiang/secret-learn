...
"""
Secret Sharing adapter for KNeighborsClassifier

KNeighborsClassifier is a SUPERVISED algorithm.
...
class SSKNeighborsClassifier:
    """Secret Sharing KNeighborsClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKNeighborsClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSKNeighborsClassifier training in SPU")
