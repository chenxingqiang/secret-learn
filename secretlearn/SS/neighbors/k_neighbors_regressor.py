...
"""
Secret Sharing adapter for KNeighborsRegressor

KNeighborsRegressor is a SUPERVISED algorithm.
...
class SSKNeighborsRegressor:
    """Secret Sharing KNeighborsRegressor (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKNeighborsRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSKNeighborsRegressor training in SPU")
