...
"""
Secret Sharing adapter for RadiusNeighborsClassifier

RadiusNeighborsClassifier is a SUPERVISED algorithm.
...
try:
    from xlearn.neighbors import RadiusNeighborsClassifier
    USING_XLEARN = True
except ImportError:
...
class SSRadiusNeighborsClassifier:
    """Secret Sharing RadiusNeighborsClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSRadiusNeighborsClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSRadiusNeighborsClassifier training in SPU")
        ...
        def _spu_fit(X_parts, y_parts, **kwargs):
            ...
            model = RadiusNeighborsClassifier(**kwargs)
            model.fit(X, y)
            return model
