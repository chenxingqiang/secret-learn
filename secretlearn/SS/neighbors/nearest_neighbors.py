...
"""
Secret Sharing adapter for NearestNeighbors
...
class SSNearestNeighbors:
    """Secret Sharing NearestNeighbors (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSNearestNeighbors with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSNearestNeighbors training in SPU")
