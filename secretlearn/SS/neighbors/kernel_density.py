...
"""
Secret Sharing adapter for KernelDensity
...
class SSKernelDensity:
    """Secret Sharing KernelDensity (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKernelDensity with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSKernelDensity training in SPU")
