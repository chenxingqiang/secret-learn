...
"""
Secret Sharing adapter for IsotonicRegression

IsotonicRegression is a SUPERVISED algorithm.
...
class SSIsotonicRegression:
    """Secret Sharing IsotonicRegression (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSIsotonicRegression with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSIsotonicRegression training in SPU")
