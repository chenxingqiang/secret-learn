...
"""
Secret Sharing adapter for DecisionTreeClassifier

DecisionTreeClassifier is a SUPERVISED algorithm.
...
class SSDecisionTreeClassifier:
    """Secret Sharing DecisionTreeClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSDecisionTreeClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSDecisionTreeClassifier training in SPU")
