...
"""
Secret Sharing adapter for ExtraTreeRegressor
...
class SSExtraTreeRegressor:
    """Secret Sharing ExtraTreeRegressor (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSExtraTreeRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSExtraTreeRegressor training in SPU")
