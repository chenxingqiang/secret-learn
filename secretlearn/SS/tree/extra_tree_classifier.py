...
"""
Secret Sharing adapter for ExtraTreeClassifier
...
class SSExtraTreeClassifier:
    """Secret Sharing ExtraTreeClassifier (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSExtraTreeClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSExtraTreeClassifier training in SPU")
