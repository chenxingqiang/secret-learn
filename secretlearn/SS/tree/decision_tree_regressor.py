...
"""
Secret Sharing adapter for DecisionTreeRegressor

DecisionTreeRegressor is a SUPERVISED algorithm.
...
class SSDecisionTreeRegressor:
    """Secret Sharing DecisionTreeRegressor (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSDecisionTreeRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSDecisionTreeRegressor training in SPU")
