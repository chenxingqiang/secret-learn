...
"""
Secret Sharing adapter for Plsregression

Plsregression is a SUPERVISED algorithm.
...
class SSPlsregression:
    """Secret Sharing Plsregression (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSPlsregression with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSPlsregression training in SPU")
