...
"""
Secret Sharing adapter for ExtraTreesRegressor

ExtraTreesRegressor is a SUPERVISED algorithm.
...
class SSExtraTreesRegressor:
    """Secret Sharing ExtraTreesRegressor (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSExtraTreesRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSExtraTreesRegressor training in SPU")
