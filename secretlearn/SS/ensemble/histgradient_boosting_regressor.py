...
"""
Secret Sharing adapter for HistgradientBoostingRegressor

HistgradientBoostingRegressor is a SUPERVISED algorithm.
...
class SSHistgradientBoostingRegressor:
    """Secret Sharing HistgradientBoostingRegressor (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSHistgradientBoostingRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSHistgradientBoostingRegressor training in SPU")
