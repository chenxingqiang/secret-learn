...
"""
Secret Sharing adapter for GradientBoostingRegressor

GradientBoostingRegressor is a SUPERVISED algorithm.
...
class SSGradientBoostingRegressor:
    """Secret Sharing GradientBoostingRegressor (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSGradientBoostingRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSGradientBoostingRegressor training in SPU")
