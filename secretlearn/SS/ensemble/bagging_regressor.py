...
"""
Secret Sharing adapter for BaggingRegressor

BaggingRegressor is a SUPERVISED algorithm.
...
class SSBaggingRegressor:
    """Secret Sharing BaggingRegressor (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSBaggingRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSBaggingRegressor training in SPU")
