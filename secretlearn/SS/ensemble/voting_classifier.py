...
"""
Secret Sharing adapter for VotingClassifier

VotingClassifier is a SUPERVISED algorithm.
...
class SSVotingClassifier:
    """Secret Sharing VotingClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSVotingClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSVotingClassifier training in SPU")
