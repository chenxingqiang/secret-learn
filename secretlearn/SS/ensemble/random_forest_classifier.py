...
"""
Secret Sharing adapter for RandomForestClassifier

RandomForestClassifier is a SUPERVISED algorithm.
...
class SSRandomForestClassifier:
    """Secret Sharing RandomForestClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSRandomForestClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSRandomForestClassifier training in SPU")
