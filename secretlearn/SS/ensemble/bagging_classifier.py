...
"""
Secret Sharing adapter for BaggingClassifier

BaggingClassifier is a SUPERVISED algorithm.
...
class SSBaggingClassifier:
    """Secret Sharing BaggingClassifier (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSBaggingClassifier with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSBaggingClassifier training in SPU")
