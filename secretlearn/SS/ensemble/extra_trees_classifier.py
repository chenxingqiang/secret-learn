...
"""
Secret Sharing adapter for ExtraTreesClassifier

ExtraTreesClassifier is a SUPERVISED algorithm.
...
class SSExtraTreesClassifier:
    """Secret Sharing ExtraTreesClassifier (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSExtraTreesClassifier with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSExtraTreesClassifier training in SPU")
