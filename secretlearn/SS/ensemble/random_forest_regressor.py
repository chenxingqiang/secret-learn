...
"""
Secret Sharing adapter for RandomForestRegressor

RandomForestRegressor is a SUPERVISED algorithm.
...
class SSRandomForestRegressor:
    """Secret Sharing RandomForestRegressor (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSRandomForestRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSRandomForestRegressor training in SPU")
