...
"""
Secret Sharing adapter for HistgradientBoostingClassifier

HistgradientBoostingClassifier is a SUPERVISED algorithm.
...
class SSHistgradientBoostingClassifier:
    """Secret Sharing HistgradientBoostingClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSHistgradientBoostingClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSHistgradientBoostingClassifier training in SPU")
