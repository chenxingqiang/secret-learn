...
"""
Secret Sharing adapter for GradientBoostingClassifier

GradientBoostingClassifier is a SUPERVISED algorithm.
...
class SSGradientBoostingClassifier:
    """Secret Sharing GradientBoostingClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSGradientBoostingClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSGradientBoostingClassifier training in SPU")
