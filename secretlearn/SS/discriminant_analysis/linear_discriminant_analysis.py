...
"""
Secret Sharing adapter for LinearDiscriminantAnalysis

LinearDiscriminantAnalysis is a SUPERVISED algorithm.
...
class SSLinearDiscriminantAnalysis:
    """Secret Sharing LinearDiscriminantAnalysis (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLinearDiscriminantAnalysis with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSLinearDiscriminantAnalysis training in SPU")
