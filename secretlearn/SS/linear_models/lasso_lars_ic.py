...
"""
Secret Sharing adapter for LassoLarsIC
...
class SSLassoLarsIC:
    """Secret Sharing LassoLarsIC (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLassoLarsIC with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSLassoLarsIC training in SPU")
