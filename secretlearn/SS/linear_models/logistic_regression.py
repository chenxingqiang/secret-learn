...
"""
Secret Sharing adapter for LogisticRegression

LogisticRegression is a SUPERVISED algorithm.
...
class SSLogisticRegression:
    """Secret Sharing LogisticRegression (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLogisticRegression with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSLogisticRegression training in SPU")
