...
"""
Secret Sharing adapter for LassoCv

LassoCv is a SUPERVISED algorithm.
...
class SSLassoCv:
    """Secret Sharing LassoCv (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLassoCv with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSLassoCv training in SPU")
