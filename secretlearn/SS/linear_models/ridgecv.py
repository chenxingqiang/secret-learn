...
"""
Secret Sharing adapter for Ridgecv

Ridgecv is a SUPERVISED algorithm.
...
class SSRidgecv:
    """Secret Sharing Ridgecv (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSRidgecv with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSRidgecv training in SPU")
