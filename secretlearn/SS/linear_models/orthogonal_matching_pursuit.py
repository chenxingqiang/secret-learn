...
"""
Secret Sharing adapter for OrthogonalMatchingPursuit
...
class SSOrthogonalMatchingPursuit:
    """Secret Sharing OrthogonalMatchingPursuit (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSOrthogonalMatchingPursuit with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSOrthogonalMatchingPursuit training in SPU")
