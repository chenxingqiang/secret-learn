...
"""
Secret Sharing adapter for QuantileRegressor
...
class SSQuantileRegressor:
    """Secret Sharing QuantileRegressor (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSQuantileRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSQuantileRegressor training in SPU")
