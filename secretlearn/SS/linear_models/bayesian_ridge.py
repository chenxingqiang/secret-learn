...
"""
Secret Sharing adapter for BayesianRidge
...
class SSBayesianRidge:
    """Secret Sharing BayesianRidge (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSBayesianRidge with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSBayesianRidge training in SPU")
