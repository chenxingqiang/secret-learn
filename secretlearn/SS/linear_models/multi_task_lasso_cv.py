...
"""
Secret Sharing adapter for MultiTaskLassoCV
...
class SSMultiTaskLassoCV:
    """Secret Sharing MultiTaskLassoCV (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMultiTaskLassoCV with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSMultiTaskLassoCV training in SPU")
