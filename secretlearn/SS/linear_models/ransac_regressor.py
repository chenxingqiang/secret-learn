...
"""
Secret Sharing adapter for RansacRegressor

RansacRegressor is a SUPERVISED algorithm.
...
class SSRansacRegressor:
    """Secret Sharing RansacRegressor (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSRansacRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSRansacRegressor training in SPU")
