...
"""
Secret Sharing adapter for SgdClassifier

SgdClassifier is a SUPERVISED algorithm.
...
class SSSgdClassifier:
    """Secret Sharing SgdClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSSgdClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSSgdClassifier training in SPU")
