...
"""
Secret Sharing adapter for Lasso

Lasso is a SUPERVISED algorithm.
...
class SSLasso:
    """Secret Sharing Lasso (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLasso with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSLasso training in SPU")
