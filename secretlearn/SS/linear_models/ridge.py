...
"""
Secret Sharing adapter for Ridge

Ridge is a SUPERVISED algorithm.
...
class SSRidge:
    """Secret Sharing Ridge (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSRidge with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSRidge training in SPU")
