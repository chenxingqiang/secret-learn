...
"""
Secret Sharing adapter for LinearRegression

LinearRegression is a SUPERVISED algorithm.
...
class SSLinearRegression:
    """Secret Sharing LinearRegression (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLinearRegression with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSLinearRegression training in SPU")
