...
"""
Secret Sharing adapter for PoissonRegressor
...
class SSPoissonRegressor:
    """Secret Sharing PoissonRegressor (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSPoissonRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSPoissonRegressor training in SPU")
