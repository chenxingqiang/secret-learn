...
"""
Secret Sharing adapter for LogisticRegressionCV
...
class SSLogisticRegressionCV:
    """Secret Sharing LogisticRegressionCV (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLogisticRegressionCV with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSLogisticRegressionCV training in SPU")
