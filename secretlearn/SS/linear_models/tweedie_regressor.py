...
"""
Secret Sharing adapter for TweedieRegressor
...
class SSTweedieRegressor:
    """Secret Sharing TweedieRegressor (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSTweedieRegressor with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSTweedieRegressor training in SPU")
