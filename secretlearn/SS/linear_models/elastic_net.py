...
"""
Secret Sharing adapter for ElasticNet

ElasticNet is a SUPERVISED algorithm.
...
class SSElasticNet:
    """Secret Sharing ElasticNet (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSElasticNet with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSElasticNet training in SPU")
