...
"""
Secret Sharing adapter for KernelRidge

KernelRidge is a SUPERVISED algorithm.
...
class SSKernelRidge:
    """Secret Sharing KernelRidge (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKernelRidge with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSKernelRidge training in SPU")
