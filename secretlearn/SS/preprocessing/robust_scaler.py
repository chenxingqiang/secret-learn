...
"""
Secret Sharing adapter for RobustScaler

RobustScaler is an UNSUPERVISED algorithm.
...
class SSRobustScaler:
    """Secret Sharing RobustScaler (Unsupervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSRobustScaler with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSRobustScaler training in SPU")
