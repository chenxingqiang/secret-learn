...
"""
Secret Sharing adapter for QuantileTransformer

QuantileTransformer is an UNSUPERVISED algorithm.
...
class SSQuantileTransformer:
    """Secret Sharing QuantileTransformer (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSQuantileTransformer with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSQuantileTransformer training in SPU")
