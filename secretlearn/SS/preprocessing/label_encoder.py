...
"""
Secret Sharing adapter for LabelEncoder

LabelEncoder is a SUPERVISED algorithm.
...
class SSLabelEncoder:
    """Secret Sharing LabelEncoder (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLabelEncoder with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSLabelEncoder training in SPU")
