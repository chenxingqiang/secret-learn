...
"""
Secret Sharing adapter for PolynomialFeatures

PolynomialFeatures is an UNSUPERVISED algorithm.
...
class SSPolynomialFeatures:
    """Secret Sharing PolynomialFeatures (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSPolynomialFeatures with JAX acceleration")
