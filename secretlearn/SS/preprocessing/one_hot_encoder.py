...
"""
Secret Sharing adapter for OneHotEncoder
...
class SSOneHotEncoder:
    """Secret Sharing OneHotEncoder (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSOneHotEncoder with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSOneHotEncoder training in SPU")
