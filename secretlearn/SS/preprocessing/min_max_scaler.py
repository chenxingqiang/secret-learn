...
"""
Secret Sharing adapter for MinMaxScaler

MinMaxScaler is an UNSUPERVISED algorithm.
...
class SSMinMaxScaler:
    """Secret Sharing MinMaxScaler (Unsupervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMinMaxScaler with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSMinMaxScaler training in SPU")
