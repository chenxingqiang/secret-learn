...
"""
Secret Sharing adapter for KernelCenterer
...
class SSKernelCenterer:
    """Secret Sharing KernelCenterer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKernelCenterer with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSKernelCenterer training in SPU")
