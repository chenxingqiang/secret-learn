...
"""
Secret Sharing adapter for OrdinalEncoder

OrdinalEncoder is a SUPERVISED algorithm.
...
class SSOrdinalEncoder:
    """Secret Sharing OrdinalEncoder (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSOrdinalEncoder with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSOrdinalEncoder training in SPU")
