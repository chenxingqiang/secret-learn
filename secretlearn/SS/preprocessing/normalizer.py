...
"""
Secret Sharing adapter for Normalizer

Normalizer is an UNSUPERVISED algorithm.
...
class SSNormalizer:
    """Secret Sharing Normalizer (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSNormalizer with JAX acceleration")
