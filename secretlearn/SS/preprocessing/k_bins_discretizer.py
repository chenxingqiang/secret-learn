...
"""
Secret Sharing adapter for KBinsDiscretizer

KBinsDiscretizer is an UNSUPERVISED algorithm.
...
class SSKBinsDiscretizer:
    """Secret Sharing KBinsDiscretizer (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKBinsDiscretizer with JAX acceleration")
