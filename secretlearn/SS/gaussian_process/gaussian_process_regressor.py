...
"""
Secret Sharing adapter for GaussianProcessRegressor

GaussianProcessRegressor is a SUPERVISED algorithm.
...
class SSGaussianProcessRegressor:
    """Secret Sharing GaussianProcessRegressor (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSGaussianProcessRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSGaussianProcessRegressor training in SPU")
