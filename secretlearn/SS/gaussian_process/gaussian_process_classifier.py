...
"""
Secret Sharing adapter for GaussianProcessClassifier

GaussianProcessClassifier is a SUPERVISED algorithm.
...
class SSGaussianProcessClassifier:
    """Secret Sharing GaussianProcessClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSGaussianProcessClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSGaussianProcessClassifier training in SPU")
