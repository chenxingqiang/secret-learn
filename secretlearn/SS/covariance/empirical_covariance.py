...
"""
Secret Sharing adapter for EmpiricalCovariance

EmpiricalCovariance is an UNSUPERVISED algorithm.
...
try:
    from xlearn.covariance import EmpiricalCovariance
    USING_XLEARN = True
except ImportError:
...
class SSEmpiricalCovariance:
    """Secret Sharing EmpiricalCovariance (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSEmpiricalCovariance with JAX acceleration")
