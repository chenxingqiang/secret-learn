...
"""
Secret Sharing adapter for GraphicalLasso
...
class SSGraphicalLasso:
    """Secret Sharing GraphicalLasso (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSGraphicalLasso with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSGraphicalLasso training in SPU")
