...
"""
Secret Sharing adapter for EllipticEnvelope

EllipticEnvelope is an UNSUPERVISED algorithm.
...
class SSEllipticEnvelope:
    """Secret Sharing EllipticEnvelope (Unsupervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSEllipticEnvelope with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSEllipticEnvelope training in SPU")
