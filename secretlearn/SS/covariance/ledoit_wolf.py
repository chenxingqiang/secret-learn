...
"""
Secret Sharing adapter for LedoitWolf

LedoitWolf is an UNSUPERVISED algorithm.
...
class SSLedoitWolf:
    """Secret Sharing LedoitWolf (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLedoitWolf with JAX acceleration")
