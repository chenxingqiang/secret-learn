...
"""
Secret Sharing adapter for LabelBinarizer
...
class SSLabelBinarizer:
    """Secret Sharing LabelBinarizer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLabelBinarizer with JAX acceleration")
