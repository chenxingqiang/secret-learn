...
"""
Secret Sharing adapter for GaussianNb

GaussianNb is a SUPERVISED algorithm.
...
class SSGaussianNb:
    """Secret Sharing GaussianNb (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSGaussianNb with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSGaussianNb training in SPU")
