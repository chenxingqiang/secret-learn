...
"""
Secret Sharing adapter for MultinomialNb

MultinomialNb is a SUPERVISED algorithm.
...
class SSMultinomialNb:
    """Secret Sharing MultinomialNb (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMultinomialNb with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSMultinomialNb training in SPU")
