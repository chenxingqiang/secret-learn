...
"""
Secret Sharing adapter for IncrementalPca

IncrementalPca is a SUPERVISED algorithm.
...
class SSIncrementalPca:
    """Secret Sharing IncrementalPca (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSIncrementalPca with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSIncrementalPca training in SPU")
