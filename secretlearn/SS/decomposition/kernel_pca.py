...
"""
Secret Sharing adapter for KernelPca

KernelPca is a SUPERVISED algorithm.
...
class SSKernelPca:
    """Secret Sharing KernelPca (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKernelPca with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSKernelPca training in SPU")
