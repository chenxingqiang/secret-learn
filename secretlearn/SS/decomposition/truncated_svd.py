...
"""
Secret Sharing adapter for TruncatedSvd

TruncatedSvd is a SUPERVISED algorithm.
...
class SSTruncatedSvd:
    """Secret Sharing TruncatedSvd (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSTruncatedSvd with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSTruncatedSvd training in SPU")
