...
"""
Secret Sharing adapter for MiniBatchNmf

MiniBatchNmf is a SUPERVISED algorithm.
...
class SSMiniBatchNmf:
    """Secret Sharing MiniBatchNmf (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMiniBatchNmf with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSMiniBatchNmf training in SPU")
