...
"""
Secret Sharing adapter for GaussianMixture
...
class SSGaussianMixture:
    """Secret Sharing GaussianMixture (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSGaussianMixture with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSGaussianMixture training in SPU")
