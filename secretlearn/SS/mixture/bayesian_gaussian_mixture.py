...
"""
Secret Sharing adapter for BayesianGaussianMixture
...
class SSBayesianGaussianMixture:
    """Secret Sharing BayesianGaussianMixture (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSBayesianGaussianMixture with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSBayesianGaussianMixture training in SPU")
