...
"""
Secret Sharing adapter for SpectralClustering

SpectralClustering is an UNSUPERVISED algorithm.
...
class SSSpectralClustering:
    """Secret Sharing SpectralClustering (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSSpectralClustering with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSSpectralClustering training in SPU")
