...
"""
Secret Sharing adapter for AgglomerativeClustering

AgglomerativeClustering is an UNSUPERVISED algorithm.
...
class SSAgglomerativeClustering:
    """Secret Sharing AgglomerativeClustering (Unsupervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSAgglomerativeClustering with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSAgglomerativeClustering training in SPU")
