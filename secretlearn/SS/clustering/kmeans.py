...
"""
Secret Sharing adapter for Kmeans

Kmeans is a SUPERVISED algorithm.
...
class SSKmeans:
    """Secret Sharing Kmeans (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKmeans with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSKmeans training in SPU")
