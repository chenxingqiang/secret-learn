...
"""
Secret Sharing adapter for HDBSCAN
...
class SSHDBSCAN:
    """Secret Sharing HDBSCAN (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSHDBSCAN with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSHDBSCAN training in SPU")
