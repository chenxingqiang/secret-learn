...
"""
Secret Sharing adapter for Birch

Birch is an UNSUPERVISED algorithm.
...
class SSBirch:
    """Secret Sharing Birch (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSBirch with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSBirch training in SPU")
