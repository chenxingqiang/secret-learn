...
"""
Secret Sharing adapter for MiniBatchKmeans

MiniBatchKmeans is a SUPERVISED algorithm.
...
class SSMiniBatchKmeans:
    """Secret Sharing MiniBatchKmeans (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMiniBatchKmeans with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSMiniBatchKmeans training in SPU")
