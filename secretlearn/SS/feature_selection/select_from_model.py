...
"""
Secret Sharing adapter for SelectFromModel

SelectFromModel is a SUPERVISED algorithm.
...
class SSSelectFromModel:
    """Secret Sharing SelectFromModel (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSSelectFromModel with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSSelectFromModel training in SPU")
