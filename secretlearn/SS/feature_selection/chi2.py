...
"""
Secret Sharing adapter for Chi2

Chi2 is a SUPERVISED algorithm.
...
class SSChi2:
    """Secret Sharing Chi2 (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSChi2 with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSChi2 training in SPU")
