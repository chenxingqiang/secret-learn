...
"""
Secret Sharing adapter for SelectPercentile
...
class SSSelectPercentile:
    """Secret Sharing SelectPercentile (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSSelectPercentile with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSSelectPercentile training in SPU")
