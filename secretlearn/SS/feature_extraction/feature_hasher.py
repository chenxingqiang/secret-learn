...
"""
Secret Sharing adapter for FeatureHasher
...
class SSFeatureHasher:
    """Secret Sharing FeatureHasher (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSFeatureHasher with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSFeatureHasher training in SPU")
