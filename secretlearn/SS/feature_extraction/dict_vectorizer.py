...
"""
Secret Sharing adapter for DictVectorizer
...
class SSDictVectorizer:
    """Secret Sharing DictVectorizer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSDictVectorizer with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSDictVectorizer training in SPU")
