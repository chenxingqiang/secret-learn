...
"""
Secret Sharing adapter for Isomap

Isomap is an UNSUPERVISED algorithm.
...
class SSIsomap:
    """Secret Sharing Isomap (Unsupervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSIsomap with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSIsomap training in SPU")
