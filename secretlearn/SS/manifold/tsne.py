...
"""
Secret Sharing adapter for Tsne

Tsne is a SUPERVISED algorithm.
...
class SSTsne:
    """Secret Sharing Tsne (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSTsne with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSTsne training in SPU")
