...
"""
Secret Sharing adapter for SimpleImputer
...
class SSSimpleImputer:
    """Secret Sharing SimpleImputer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSSimpleImputer with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSSimpleImputer training in SPU")
