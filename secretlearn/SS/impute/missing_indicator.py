...
"""
Secret Sharing adapter for MissingIndicator
...
class SSMissingIndicator:
    """Secret Sharing MissingIndicator (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMissingIndicator with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSMissingIndicator training in SPU")
