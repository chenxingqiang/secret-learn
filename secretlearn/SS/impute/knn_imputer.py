...
"""
Secret Sharing adapter for KNNImputer
...
class SSKNNImputer:
    """Secret Sharing KNNImputer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSKNNImputer with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSKNNImputer training in SPU")
