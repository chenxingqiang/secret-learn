...
"""
Secret Sharing adapter for BernoulliRBM
...
class SSBernoulliRBM:
    """Secret Sharing BernoulliRBM (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSBernoulliRBM with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSBernoulliRBM training in SPU")
