...
"""
Secret Sharing adapter for MlpRegressor

MlpRegressor is a SUPERVISED algorithm.
...
class SSMlpRegressor:
    """Secret Sharing MlpRegressor (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMlpRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSMlpRegressor training in SPU")
