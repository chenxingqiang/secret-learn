...
"""
Secret Sharing adapter for MlpClassifier

MlpClassifier is a SUPERVISED algorithm.
...
class SSMlpClassifier:
    """Secret Sharing MlpClassifier (Supervised)"""
    ...
    def __init__(self, spu: 'SPU', **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSMlpClassifier with JAX acceleration")
    ...
    def fit(self, x: 'Union[FedNdarray, VDataFrame]', y: 'Union[FedNdarray, VDataFrame]'):
        ...
        logging.info(f"[SS] SSMlpClassifier training in SPU")
