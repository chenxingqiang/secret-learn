...
"""
Secret Sharing adapter for LabelSpreading

LabelSpreading is a SUPERVISED algorithm.
...
class SSLabelSpreading:
    """Secret Sharing LabelSpreading (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLabelSpreading with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSLabelSpreading training in SPU")
