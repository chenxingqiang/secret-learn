...
"""
Secret Sharing adapter for LabelPropagation

LabelPropagation is a SUPERVISED algorithm.
...
class SSLabelPropagation:
    """Secret Sharing LabelPropagation (Supervised)"""
    ...
    def __init__(self, spu: SPU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SS] SSLabelPropagation with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SS] SSLabelPropagation training in SPU")
