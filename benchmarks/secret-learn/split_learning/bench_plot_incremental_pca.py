...
from secretlearn.split_learning.decomposition.incremental_pca import SLIncrementalPCA
...
def plot_feature_times(all_times, batch_size, all_components, data):
    plt.figure()
    plot_results(all_components, all_times["pca"], label="SLPCA")
    plot_results(
        all_components, all_times["ipca"], label="SLIncrementalPCA, bsize=%i" % batch_size
...
def plot_feature_errors(all_errors, batch_size, all_components, data):
    plt.figure()
    plot_results(all_components, all_errors["pca"], label="SLPCA")
    plot_results(
        all_components,
        all_errors["ipca"],
        label="SLIncrementalPCA, bsize=%i" % batch_size,
...
def plot_batch_times(all_times, n_features, all_batch_sizes, data):
    plt.figure()
    plot_results(all_batch_sizes, all_times["pca"], label="SLPCA")
    plot_results(all_batch_sizes, all_times["ipca"], label="SLIncrementalPCA")
    plt.legend(loc="lower left")
    plt.suptitle(
...
def plot_batch_errors(all_errors, n_features, all_batch_sizes, data):
    plt.figure()
    plot_results(all_batch_sizes, all_errors["pca"], label="SLPCA")
    plot_results(all_batch_sizes, all_errors["ipca"], label="SLIncrementalPCA")
    plt.legend(loc="lower left")
    plt.suptitle(
...
def fixed_batch_size_comparison(data):
    ...
    for n_components in all_features:
        pca = SLPCA(n_components=n_components)
        ipca = SLIncrementalPCA(n_components=n_components, batch_size=batch_size)
        results_dict = {
