...
from secretlearn.split_learning.random_projection.gaussian_random_projection import SLGaussianRandomProjection
from secretlearn.split_learning.random_projection.sparse_random_projection import SLSparseRandomProjection
...
if __name__ == "__main__":
    ...
    op.add_option(
        ...
        default="SLGaussianRandomProjection,SLSparseRandomProjection",
        type=str,
        help=(
            "Comma-separated list of transformer to benchmark. "
            "Default: %default. Available: "
            "SLGaussianRandomProjection,SLSparseRandomProjection"
        ),
    ...
    ###########################################################################
    # Set SLGaussianRandomProjection input
    gaussian_matrix_params = {
        "n_components": opts.n_components,
        "random_state": opts.random_seed,
    }
    transformers["SLGaussianRandomProjection"] = SLGaussianRandomProjection(
        **gaussian_matrix_params

    ###########################################################################
    # Set SLSparseRandomProjection input
    ...
    transformers["SLSparseRandomProjection"] = SLSparseRandomProjection(
        **sparse_matrix_params
