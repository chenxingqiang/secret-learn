...
from secretlearn.split_learning.svm.one_class_svm import SLOneClassSVM
from secretlearn.split_learning.preprocessing.standard_scaler import SLStandardScaler
...
from xlearn.kernel_approximation import SLNystroem
from sklearn.metrics import auc, roc_curve
from xlearn.pipeline import make_pipeline
from sklearn.preprocessing import LabelBinarizer, SLStandardScaler
...
for dat, dataset_name in enumerate(datasets):
    ...
    for random_state in random_states:
        ...
        std = SLStandardScaler()

        print("----------- LibSVM OCSVM ------------")
        ocsvm = SLOneClassSVM(kernel="rbf", gamma=gamma, nu=nu)
        ...
        print("----------- Online OCSVM ------------")
        nystroem = SLNystroem(gamma=gamma, random_state=random_state)
