...
from secretlearn.split_learning.naive_bayes.gaussian_nb import SLGaussianNB
from secretlearn.split_learning.ensemble.gradient_boosting_classifier import SLGradientBoostingClassifier
...
ESTIMATORS = {
    "GBRT": SLGradientBoostingClassifier(n_estimators=250),
    "ExtraTrees": SLExtraTreesClassifier(n_estimators=20),
    "RandomForest": SLRandomForestClassifier(n_estimators=20),
    "CART": SLDecisionTreeClassifier(min_samples_split=5),
    "SGD": SLSGDClassifier(alpha=0.001),
    "SLGaussianNB": SLGaussianNB(),
    "liblinear": SLLinearSVC(loss="l2", penalty="l2", C=1000, dual=False, tol=1e-3),
    "SAG": SLLogisticRegression(solver="sag", max_iter=2, C=1000),
}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=ESTIMATORS,
        type=str,
        default=["liblinear", "SLGaussianNB", "SGD", "CART"],
