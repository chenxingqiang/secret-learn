...
from secretlearn.secret_sharing.random_projection.gaussian_random_projection import SSGaussianRandomProjection
from secretlearn.secret_sharing.random_projection.sparse_random_projection import SSSparseRandomProjection
...
if __name__ == "__main__":
    ...
    op.add_option(
        ...
        default="SSGaussianRandomProjection,SSSparseRandomProjection",
        type=str,
        help=(
            "Comma-separated list of transformer to benchmark. "
            "Default: %default. Available: "
            "SSGaussianRandomProjection,SSSparseRandomProjection"
        ),
    ...
    ###########################################################################
    # Set SSGaussianRandomProjection input
    gaussian_matrix_params = {
        "n_components": opts.n_components,
        "random_state": opts.random_seed,
    }
    transformers["SSGaussianRandomProjection"] = SSGaussianRandomProjection(
        **gaussian_matrix_params

    ###########################################################################
    # Set SSSparseRandomProjection input
    ...
    transformers["SSSparseRandomProjection"] = SSSparseRandomProjection(
        **sparse_matrix_params
