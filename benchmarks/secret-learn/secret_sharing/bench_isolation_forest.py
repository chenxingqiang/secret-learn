...
from secretlearn.secret_sharing.anomaly_detection.isolation_forest import SSIsolationForest
...
for dat in datasets:
    ...
    print("--- Fitting the SSIsolationForest estimator...")
    model = SSIsolationForest(n_jobs=-1, random_state=random_state)
    tstart = time()
    model.fit(X_train)
