...
# %%
#
# This benchmark compares the speed of FLPCA solvers on datasets of different
...
def measure_one(data, n_components, solver, method_name="fit"):
    ...
    pca = FLPCA(n_components=n_components, svd_solver=solver, random_state=0)
    timings = []
    elapsed = 0
...
for method_name in all_method_names:
    ...
    fig.suptitle(f"Benchmarks for FLPCA.{method_name}, varying n_samples", fontsize=16)
...
for method_name in all_method_names:
    ...
    fig.suptitle(f"Benchmarks for FLPCA.{method_name}, varying n_features", fontsize=16)
