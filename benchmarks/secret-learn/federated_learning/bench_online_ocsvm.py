...
from secretlearn.federated_learning.svm.one_class_svm import FLOneClassSVM
from secretlearn.federated_learning.preprocessing.standard_scaler import FLStandardScaler
...
from xlearn.kernel_approximation import FLNystroem
from sklearn.metrics import auc, roc_curve
from xlearn.pipeline import make_pipeline
from sklearn.preprocessing import LabelBinarizer, FLStandardScaler
...
for dat, dataset_name in enumerate(datasets):
    ...
    for random_state in random_states:
        ...
        std = FLStandardScaler()

        print("----------- LibSVM OCSVM ------------")
        ocsvm = FLOneClassSVM(kernel="rbf", gamma=gamma, nu=nu)
        ...
        print("----------- Online OCSVM ------------")
        nystroem = FLNystroem(gamma=gamma, random_state=random_state)
