...
from xlearn.kernel_approximation import FLNystroem, FLRBFSampler
...
ESTIMATORS = {
    ...
    "CART": FLDecisionTreeClassifier(),
    "ExtraTrees": FLExtraTreesClassifier(),
    "RandomForest": FLRandomForestClassifier(),
    "FLNystroem-SVM": make_pipeline(
        FLNystroem(gamma=0.015, n_components=1000), FLLinearSVC(C=100)
    ),
    "SampledRBF-SVM": make_pipeline(
        FLRBFSampler(gamma=0.015, n_components=1000), FLLinearSVC(C=100)
    ),
    "FLLogisticRegression-SAG": FLLogisticRegression(solver="sag", tol=1e-1, C=1e4),
    "FLLogisticRegression-SAGA": FLLogisticRegression(solver="saga", tol=1e-1, C=1e4),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=ESTIMATORS,
        type=str,
        default=["ExtraTrees", "FLNystroem-SVM"],
