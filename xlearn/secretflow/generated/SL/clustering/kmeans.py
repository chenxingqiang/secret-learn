    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLKMeans initialized with JAX acceleration")
        else:
            logging.info("[SL] FLKMeans initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated KMeans clustering (unsupervised)")
        ...
        logging.info("[SL] Federated KMeans clustering completed")
        return self
