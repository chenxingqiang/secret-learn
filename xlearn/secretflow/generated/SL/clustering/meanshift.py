    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLMeanShift initialized with JAX acceleration")
        else:
            logging.info("[SL] FLMeanShift initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated MeanShift clustering (unsupervised)")
        ...
        for party_name, device in self.devices.items():
            if device in x.partitions:
                ...
                logging.info(f"[SL] Party '{party_name}' completed local clustering")
        
        self._is_fitted = True
        logging.info("[SL] Federated MeanShift clustering completed")
        return self
    ...
    def _secure_aggregate_labels(self, labels_list):
        ...
        """
        logging.info("[SL] Secure label aggregation via HEU")
