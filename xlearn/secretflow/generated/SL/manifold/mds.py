    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLMDS initialized with JAX acceleration")
        else:
            logging.info("[SL] FLMDS initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated MDS manifold learning (unsupervised)")
        ...
        logging.info("[SL] Federated MDS manifold learning completed")
        return self
