    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLIsomap initialized with JAX acceleration")
        else:
            logging.info("[SL] SLIsomap initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated Isomap manifold learning (unsupervised)")
        ...
        logging.info("[SL] Federated Isomap manifold learning completed")
        return self
