    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLLocallyLinearEmbedding initialized with JAX acceleration")
        else:
            logging.info("[SL] FLLocallyLinearEmbedding initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated LocallyLinearEmbedding manifold learning (unsupervised)")
        ...
        for party_name, device in self.devices.items():
            if device in x.partitions:
                ...
                logging.info(f"[SL] Party '{party_name}' completed local manifold learning")
        
        self._is_fitted = True
        logging.info("[SL] Federated LocallyLinearEmbedding manifold learning completed")
        return self
