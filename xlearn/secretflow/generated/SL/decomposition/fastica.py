    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLFastICA initialized with JAX acceleration")
        else:
            logging.info("[SL] FLFastICA initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated FastICA dimensionality reduction (unsupervised)")
        ...
        logging.info("[SL] Federated FastICA dimensionality reduction completed")
        return self
