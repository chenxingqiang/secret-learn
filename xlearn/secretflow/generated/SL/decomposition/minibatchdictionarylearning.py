    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLMiniBatchDictionaryLearning initialized with JAX acceleration")
        else:
            logging.info("[SL] FLMiniBatchDictionaryLearning initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated MiniBatchDictionaryLearning dimensionality reduction (unsupervised)")
        ...
        logging.info("[SL] Federated MiniBatchDictionaryLearning dimensionality reduction completed")
        return self
