    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLKernelPCA initialized with JAX acceleration")
        else:
            logging.info("[SL] FLKernelPCA initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated KernelPCA dimensionality reduction (unsupervised)")
        ...
        logging.info("[SL] Federated KernelPCA dimensionality reduction completed")
        return self
