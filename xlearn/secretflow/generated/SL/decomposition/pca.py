    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLPCA initialized with JAX acceleration")
        else:
            logging.info("[SL] FLPCA initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated PCA dimensionality reduction (unsupervised)")
        ...
        logging.info("[SL] Federated PCA dimensionality reduction completed")
        return self
