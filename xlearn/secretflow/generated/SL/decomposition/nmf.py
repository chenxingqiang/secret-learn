    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLNMF initialized with JAX acceleration")
        else:
            logging.info("[SL] FLNMF initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated NMF dimensionality reduction (unsupervised)")
        ...
        logging.info("[SL] Federated NMF dimensionality reduction completed")
        return self
