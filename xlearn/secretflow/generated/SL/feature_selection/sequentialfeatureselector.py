...
class FLSequentialFeatureSelector:
    ...
    **kwargs
    ...
    def __init__(self, devices: Dict[str, PYU], heu: HEU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] FLSequentialFeatureSelector with JAX acceleration")
        else:
            logging.info(f"[SL] FLSequentialFeatureSelector with sklearn")
    ...
    def fit(
        ...
        logging.info(f"[SL] Starting federated training: {epochs} epochs")
