    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLSVC initialized with JAX acceleration")
        else:
            logging.info("[SL] FLSVC initialized with sklearn")
    ...
    def fit(
        ...
        logging.info("[SL] Starting federated SVC training (supervised, non-iterative)")
        ...
        logging.info("[SL] Federated SVC training completed")
        return self
