    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLSVR initialized with JAX acceleration")
        else:
            logging.info("[SL] FLSVR initialized with sklearn")
    ...
    def fit(
        ...
        logging.info("[SL] Starting federated SVR training (supervised, non-iterative)")
        ...
        logging.info("[SL] Federated SVR training completed")
        return self
