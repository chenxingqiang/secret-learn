    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLMinCovDet initialized with JAX acceleration")
        else:
            logging.info("[SL] FLMinCovDet initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated MinCovDet covariance estimation (unsupervised)")
        ...
        logging.info("[SL] Federated MinCovDet covariance estimation completed")
        return self
