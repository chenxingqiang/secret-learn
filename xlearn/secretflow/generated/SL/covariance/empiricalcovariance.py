    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLEmpiricalCovariance initialized with JAX acceleration")
        else:
            logging.info("[SL] FLEmpiricalCovariance initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated EmpiricalCovariance covariance estimation (unsupervised)")
        ...
        for party_name, device in self.devices.items():
            if device in x.partitions:
                ...
                logging.info(f"[SL] Party '{party_name}' completed local covariance estimation")
        
        self._is_fitted = True
        logging.info("[SL] Federated EmpiricalCovariance covariance estimation completed")
        return self
