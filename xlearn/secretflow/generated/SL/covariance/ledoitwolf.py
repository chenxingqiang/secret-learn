    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLLedoitWolf initialized with JAX acceleration")
        else:
            logging.info("[SL] FLLedoitWolf initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated LedoitWolf covariance estimation (unsupervised)")
        ...
        logging.info("[SL] Federated LedoitWolf covariance estimation completed")
        return self
