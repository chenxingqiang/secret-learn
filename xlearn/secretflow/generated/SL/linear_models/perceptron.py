    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLPerceptron initialized with JAX acceleration")
        else:
            logging.info("[SL] SLPerceptron initialized with sklearn")
    ...
    def fit(
        ...
        logging.info(f"[SL] Starting federated Perceptron training (iterative, {epochs} epochs)")
        ...
        logging.info("[SL] Federated Perceptron training completed")
        return self
