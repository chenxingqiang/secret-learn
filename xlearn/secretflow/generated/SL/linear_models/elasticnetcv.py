    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLElasticNetCV initialized with JAX acceleration")
        else:
            logging.info("[SL] FLElasticNetCV initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated ElasticNetCV training (CV)")
        ...
        for party_name, device in self.devices.items():
            if device in x.partitions:
                ...
                logging.info(f"[SL] Party '{party_name}' completed CV training")
