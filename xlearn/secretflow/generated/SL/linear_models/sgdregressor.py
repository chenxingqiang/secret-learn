    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLSGDRegressor initialized with JAX acceleration")
        else:
            logging.info("[SL] FLSGDRegressor initialized with sklearn")
    ...
    def fit(
        ...
        logging.info(f"[SL] Starting federated SGDRegressor training (iterative, {epochs} epochs)")
        ...
        logging.info("[SL] Federated SGDRegressor training completed")
        return self
