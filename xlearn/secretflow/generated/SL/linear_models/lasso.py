    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLLasso initialized with JAX acceleration")
        else:
            logging.info("[SL] SLLasso initialized with sklearn")
    ...
    def fit(
        ...
        logging.info("[SL] Starting federated Lasso training (supervised, non-iterative)")
        ...
        logging.info("[SL] Federated Lasso training completed")
        return self
