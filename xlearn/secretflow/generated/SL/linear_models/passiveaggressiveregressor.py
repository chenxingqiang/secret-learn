    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLPassiveAggressiveRegressor initialized with JAX acceleration")
        else:
            logging.info("[SL] FLPassiveAggressiveRegressor initialized with sklearn")
    ...
    def fit(
        ...
        logging.info(f"[SL] Starting federated PassiveAggressiveRegressor training (iterative, {epochs} epochs)")
        ...
        logging.info("[SL] Federated PassiveAggressiveRegressor training completed")
        return self
