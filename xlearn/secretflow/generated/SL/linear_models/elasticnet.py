    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLElasticNet initialized with JAX acceleration")
        else:
            logging.info("[SL] FLElasticNet initialized with sklearn")
    ...
    def fit(
        ...
        logging.info("[SL] Starting federated ElasticNet training (supervised, non-iterative)")
        ...
        logging.info("[SL] Federated ElasticNet training completed")
        return self
