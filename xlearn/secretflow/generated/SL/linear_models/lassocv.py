    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLLassoCV initialized with JAX acceleration")
        else:
            logging.info("[SL] FLLassoCV initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated LassoCV training (CV)")
