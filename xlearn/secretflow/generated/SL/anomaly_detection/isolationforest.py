    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLIsolationForest initialized with JAX acceleration")
        else:
            logging.info("[SL] FLIsolationForest initialized with sklearn")
    ...
    def _secure_aggregate_scores(self, scores_list):
        ...
        if self.aggregation_method == 'mean':
            ...
            logging.info("[SL] Secure aggregation (mean) via HEU")
            ...
            logging.info("[SL] Secure aggregation (max) via HEU")
