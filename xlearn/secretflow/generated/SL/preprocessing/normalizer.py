    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLNormalizer initialized with JAX acceleration")
        else:
            logging.info("[SL] SLNormalizer initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated Normalizer fitting (unsupervised)")
        ...
        logging.info("[SL] Federated Normalizer fitting completed")
        return self
