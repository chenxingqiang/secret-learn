    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLRobustScaler initialized with JAX acceleration")
        else:
            logging.info("[SL] FLRobustScaler initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated RobustScaler fitting (unsupervised)")
        ...
        logging.info("[SL] Federated RobustScaler fitting completed")
        return self
