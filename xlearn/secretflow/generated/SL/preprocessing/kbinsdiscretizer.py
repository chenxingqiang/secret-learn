    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] FLKBinsDiscretizer initialized with JAX acceleration")
        else:
            logging.info("[SL] FLKBinsDiscretizer initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[SL] Starting federated KBinsDiscretizer fitting (unsupervised)")
        ...
        logging.info("[SL] Federated KBinsDiscretizer fitting completed")
        return self
