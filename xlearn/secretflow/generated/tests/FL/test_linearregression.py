...
def test_linearregression_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_linearregression_consistency():
    ...
    sf_model = FLLinearRegression(spu)
...
if __name__ == "__main__":
    print(f"Testing FLLinearRegression...")
