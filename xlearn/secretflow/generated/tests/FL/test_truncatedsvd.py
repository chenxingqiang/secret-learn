...
from xlearn.secretflow.generated.fl_truncatedsvd import FLTruncatedSVD


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_truncatedsvd_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_truncatedsvd_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLTruncatedSVD...")
