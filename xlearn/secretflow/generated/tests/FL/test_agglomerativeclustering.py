...
"""
Tests for FLAgglomerativeClustering
"""
...
def test_agglomerativeclustering_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_agglomerativeclustering_consistency():
    ...
    sf_model = FLAgglomerativeClustering(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLAgglomerativeClustering...")
