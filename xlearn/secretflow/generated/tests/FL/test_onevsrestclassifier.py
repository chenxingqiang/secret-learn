...
"""
Tests for FLOneVsRestClassifier
"""
...
from xlearn.secretflow.generated.fl_onevsrestclassifier import FLOneVsRestClassifier
...
def test_onevsrestclassifier_basic():
    ...
    # Test model
    model = FLOneVsRestClassifier(spu)
...
def test_onevsrestclassifier_consistency():
    ...
    sf_model = FLOneVsRestClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLOneVsRestClassifier...")
