...
from xlearn.secretflow.generated.fl_elasticnetcv import FLElasticNetCV
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_elasticnetcv_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLElasticNetCV...")
