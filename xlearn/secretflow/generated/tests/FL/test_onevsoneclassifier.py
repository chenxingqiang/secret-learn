...
"""
Tests for FLOneVsOneClassifier
"""
...
from xlearn.secretflow.generated.fl_onevsoneclassifier import FLOneVsOneClassifier
...
def test_onevsoneclassifier_basic():
    ...
    # Test model
    model = FLOneVsOneClassifier(spu)
...
def test_onevsoneclassifier_consistency():
    ...
    sf_model = FLOneVsOneClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLOneVsOneClassifier...")
