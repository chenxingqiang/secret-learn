...
"""
Tests for FLPassiveAggressiveClassifier
"""
...
from xlearn.secretflow.generated.fl_passiveaggressiveclassifier import FLPassiveAggressiveClassifier


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_passiveaggressiveclassifier_basic():
    ...
    # Test model
    model = FLPassiveAggressiveClassifier(spu)
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_passiveaggressiveclassifier_consistency():
    ...
    sklearn_model = PassiveAggressiveClassifier()
    ...
    sf_model = FLPassiveAggressiveClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLPassiveAggressiveClassifier...")
