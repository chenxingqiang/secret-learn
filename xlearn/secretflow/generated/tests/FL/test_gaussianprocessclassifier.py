...
"""
Tests for FLGaussianProcessClassifier
"""
...
from xlearn.secretflow.generated.fl_gaussianprocessclassifier import FLGaussianProcessClassifier


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_gaussianprocessclassifier_basic():
    ...
    # Test model
    model = FLGaussianProcessClassifier(spu)
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_gaussianprocessclassifier_consistency():
    ...
    sklearn_model = GaussianProcessClassifier()
    ...
    sf_model = FLGaussianProcessClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLGaussianProcessClassifier...")
