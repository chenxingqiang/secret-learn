...
from xlearn.secretflow.generated.fl_isolationforest import FLIsolationForest


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_isolationforest_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_isolationforest_consistency():
    ...
    sf_model = FLIsolationForest(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLIsolationForest...")
