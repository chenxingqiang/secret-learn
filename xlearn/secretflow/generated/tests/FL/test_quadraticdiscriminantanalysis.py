...
"""
Tests for FLQuadraticDiscriminantAnalysis
"""
...
from xlearn.secretflow.generated.fl_quadraticdiscriminantanalysis import FLQuadraticDiscriminantAnalysis


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_quadraticdiscriminantanalysis_basic():
    ...
    # Test model
    model = FLQuadraticDiscriminantAnalysis(spu)
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_quadraticdiscriminantanalysis_consistency():
    ...
    sf_model = FLQuadraticDiscriminantAnalysis(spu)
...
if __name__ == "__main__":
    print(f"Testing FLQuadraticDiscriminantAnalysis...")
