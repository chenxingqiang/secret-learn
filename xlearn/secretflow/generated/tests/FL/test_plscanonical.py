...
from xlearn.secretflow.generated.fl_plscanonical import FLPLSCanonical


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_plscanonical_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_plscanonical_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLPLSCanonical...")
