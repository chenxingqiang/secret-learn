...
from xlearn.secretflow.generated.fl_factoranalysis import FLFactorAnalysis


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_factoranalysis_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_factoranalysis_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLFactorAnalysis...")
