...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_ordinalencoder_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLOrdinalEncoder...")
