...
from xlearn.secretflow.generated.fl_baggingregressor import FLBaggingRegressor
...
def test_baggingregressor_consistency():
    ...
    sf_model = FLBaggingRegressor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLBaggingRegressor...")
