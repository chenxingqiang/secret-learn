...
from xlearn.secretflow.generated.fl_votingclassifier import FLVotingClassifier


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_votingclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_votingclassifier_consistency():
    ...
    sklearn_model = VotingClassifier()
    ...
    sf_model = FLVotingClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLVotingClassifier...")
