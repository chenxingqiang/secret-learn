...
"""
Tests for FLEmpiricalCovariance
"""
...
from xlearn.secretflow.generated.fl_empiricalcovariance import FLEmpiricalCovariance
...
def test_empiricalcovariance_consistency():
    ...
    sf_model = FLEmpiricalCovariance(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLEmpiricalCovariance...")
