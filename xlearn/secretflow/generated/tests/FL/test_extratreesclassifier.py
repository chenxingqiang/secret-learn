...
"""
Tests for FLExtraTreesClassifier
"""
...
def test_extratreesclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_extratreesclassifier_consistency():
    ...
    sf_model = FLExtraTreesClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLExtraTreesClassifier...")
