...
"""
Tests for FLLocalOutlierFactor
"""
...
from xlearn.secretflow.generated.fl_localoutlierfactor import FLLocalOutlierFactor


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_localoutlierfactor_basic():
    ...
    # Test model
    model = FLLocalOutlierFactor(spu)
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_localoutlierfactor_consistency():
    ...
    sklearn_model = LocalOutlierFactor()
    ...
    sf_model = FLLocalOutlierFactor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLLocalOutlierFactor...")
