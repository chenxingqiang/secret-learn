...
from xlearn.secretflow.generated.fl_minibatchkmeans import FLMiniBatchKMeans


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_minibatchkmeans_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_minibatchkmeans_consistency():
    ...
    sf_model = FLMiniBatchKMeans(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLMiniBatchKMeans...")
