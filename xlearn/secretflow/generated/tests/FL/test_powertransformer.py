...
from xlearn.secretflow.generated.fl_powertransformer import FLPowerTransformer
...
def test_powertransformer_consistency():
    ...
    sf_model = FLPowerTransformer(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLPowerTransformer...")
