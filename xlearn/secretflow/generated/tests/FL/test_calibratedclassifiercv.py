...
"""
Tests for FLCalibratedClassifierCV
"""
...
from xlearn.secretflow.generated.fl_calibratedclassifiercv import FLCalibratedClassifierCV


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_calibratedclassifiercv_basic():
    ...
    # Test model
    model = FLCalibratedClassifierCV(spu)
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_calibratedclassifiercv_consistency():
    ...
    sklearn_model = CalibratedClassifierCV()
    ...
    sf_model = FLCalibratedClassifierCV(spu)
...
if __name__ == "__main__":
    print(f"Testing FLCalibratedClassifierCV...")
