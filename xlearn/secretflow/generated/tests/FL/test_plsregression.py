...
from xlearn.secretflow.generated.fl_plsregression import FLPLSRegression


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_plsregression_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_plsregression_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLPLSRegression...")
