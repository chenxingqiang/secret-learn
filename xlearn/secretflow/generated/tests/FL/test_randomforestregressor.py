...
"""
Tests for FLRandomForestRegressor
"""
...
def test_randomforestregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_randomforestregressor_consistency():
    ...
    sf_model = FLRandomForestRegressor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLRandomForestRegressor...")
