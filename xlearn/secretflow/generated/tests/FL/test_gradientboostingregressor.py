...
"""
Tests for FLGradientBoostingRegressor
"""
...
def test_gradientboostingregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_gradientboostingregressor_consistency():
    ...
    sf_model = FLGradientBoostingRegressor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLGradientBoostingRegressor...")
