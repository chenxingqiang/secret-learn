...
"""
Tests for FLMultiOutputClassifier
"""
...
from xlearn.secretflow.generated.sl_multioutputclassifier import FLMultiOutputClassifier
...
def test_multioutputclassifier_basic():
    ...
    # Test model
    model = FLMultiOutputClassifier(spu)
...
def test_multioutputclassifier_consistency():
    ...
    sf_model = FLMultiOutputClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLMultiOutputClassifier...")
