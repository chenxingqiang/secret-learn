...
"""
Tests for FLLinearDiscriminantAnalysis
"""
...
from xlearn.secretflow.generated.sl_lineardiscriminantanalysis import FLLinearDiscriminantAnalysis


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_lineardiscriminantanalysis_basic():
    ...
    # Test model
    model = FLLinearDiscriminantAnalysis(spu)
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_lineardiscriminantanalysis_consistency():
    ...
    sklearn_model = LinearDiscriminantAnalysis()
    ...
    sf_model = FLLinearDiscriminantAnalysis(spu)
...
if __name__ == "__main__":
    print(f"Testing FLLinearDiscriminantAnalysis...")
