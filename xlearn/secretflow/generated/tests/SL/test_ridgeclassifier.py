...
def test_ridgeclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_ridgeclassifier_consistency():
    ...
    sf_model = FLRidgeClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLRidgeClassifier...")
