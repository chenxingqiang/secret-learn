...
"""
Tests for FLDecisionTreeClassifier
"""
...
def test_decisiontreeclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_decisiontreeclassifier_consistency():
    ...
    sf_model = FLDecisionTreeClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLDecisionTreeClassifier...")
