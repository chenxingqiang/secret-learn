...
"""
Tests for FLAffinityPropagation
"""
...
from xlearn.secretflow.generated.sl_affinitypropagation import FLAffinityPropagation
...
def test_affinitypropagation_basic():
    ...
    # Test model
    model = FLAffinityPropagation(spu)
    model.fit(fed_X)
...
def test_affinitypropagation_consistency():
    ...
    sf_model = FLAffinityPropagation(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLAffinityPropagation...")
