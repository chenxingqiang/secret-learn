...
from xlearn.secretflow.generated.sl_standardscaler import FLStandardScaler


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_standardscaler_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_standardscaler_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLStandardScaler...")
