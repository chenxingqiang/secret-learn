...
from xlearn.secretflow.generated.sl_labelpropagation import FLLabelPropagation
...
def test_labelpropagation_consistency():
    ...
    sf_model = FLLabelPropagation(spu)
...
if __name__ == "__main__":
    print(f"Testing FLLabelPropagation...")
