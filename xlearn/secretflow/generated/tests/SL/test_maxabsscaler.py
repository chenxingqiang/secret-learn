...
from xlearn.secretflow.generated.sl_maxabsscaler import FLMaxAbsScaler


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_maxabsscaler_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_maxabsscaler_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLMaxAbsScaler...")
