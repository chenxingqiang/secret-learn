...
"""
Tests for FLHistGradientBoostingClassifier
"""
...
def test_histgradientboostingclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_histgradientboostingclassifier_consistency():
    ...
    sf_model = FLHistGradientBoostingClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLHistGradientBoostingClassifier...")
