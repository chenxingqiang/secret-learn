...
from xlearn.secretflow.generated.sl_categoricalnb import FLCategoricalNB


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_categoricalnb_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_categoricalnb_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLCategoricalNB...")
