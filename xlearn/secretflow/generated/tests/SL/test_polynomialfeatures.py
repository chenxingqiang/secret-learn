...
"""
Tests for FLPolynomialFeatures
"""
...
from xlearn.secretflow.generated.sl_polynomialfeatures import FLPolynomialFeatures
...
def test_polynomialfeatures_basic():
    ...
    # Test model
    model = FLPolynomialFeatures(spu)
    model.fit(fed_X)
...
def test_polynomialfeatures_consistency():
    ...
    sf_model = FLPolynomialFeatures(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLPolynomialFeatures...")
