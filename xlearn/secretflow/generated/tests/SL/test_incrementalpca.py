...
from xlearn.secretflow.generated.sl_incrementalpca import FLIncrementalPCA


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_incrementalpca_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_incrementalpca_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLIncrementalPCA...")
