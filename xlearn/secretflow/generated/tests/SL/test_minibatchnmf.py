...
from xlearn.secretflow.generated.sl_minibatchnmf import FLMiniBatchNMF


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_minibatchnmf_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_minibatchnmf_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLMiniBatchNMF...")
