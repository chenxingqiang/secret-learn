...
from xlearn.secretflow.generated.sl_adaboostregressor import FLAdaBoostRegressor
...
def test_adaboostregressor_consistency():
    ...
    sf_model = FLAdaBoostRegressor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLAdaBoostRegressor...")
