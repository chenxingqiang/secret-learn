...
from xlearn.secretflow.generated.sl_labelspreading import FLLabelSpreading


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_labelspreading_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_labelspreading_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLLabelSpreading...")
