...
def test_nearestcentroid_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_nearestcentroid_consistency():
    ...
    sf_model = FLNearestCentroid(spu)
...
if __name__ == "__main__":
    print(f"Testing FLNearestCentroid...")
