...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_dummyregressor_consistency():
...
if __name__ == "__main__":
    print(f"Testing FLDummyRegressor...")
