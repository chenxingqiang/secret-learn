...
"""
Tests for FLExtraTreesRegressor
"""
...
def test_extratreesregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_extratreesregressor_consistency():
    ...
    sf_model = FLExtraTreesRegressor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLExtraTreesRegressor...")
