...
def test_baggingclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_baggingclassifier_consistency():
    ...
    sf_model = FLBaggingClassifier(spu)
...
if __name__ == "__main__":
    print(f"Testing FLBaggingClassifier...")
