...
from xlearn.secretflow.generated.sl_ransacregressor import FLRANSACRegressor
...
def test_ransacregressor_consistency():
    ...
    sf_model = FLRANSACRegressor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLRANSACRegressor...")
