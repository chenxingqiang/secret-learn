...
"""
Tests for FLIsotonicRegression
"""
...
def test_isotonicregression_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_isotonicregression_consistency():
    ...
    sf_model = FLIsotonicRegression(spu)
...
if __name__ == "__main__":
    print(f"Testing FLIsotonicRegression...")
