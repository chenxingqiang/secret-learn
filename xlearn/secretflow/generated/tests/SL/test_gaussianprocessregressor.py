...
"""
Tests for FLGaussianProcessRegressor
"""
...
def test_gaussianprocessregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_gaussianprocessregressor_consistency():
    ...
    sf_model = FLGaussianProcessRegressor(spu)
...
if __name__ == "__main__":
    print(f"Testing FLGaussianProcessRegressor...")
