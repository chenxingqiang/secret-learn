...
def test_ellipticenvelope_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_ellipticenvelope_consistency():
    ...
    sf_model = FLEllipticEnvelope(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing FLEllipticEnvelope...")
