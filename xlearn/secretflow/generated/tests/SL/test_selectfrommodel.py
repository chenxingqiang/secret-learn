...
from xlearn.secretflow.generated.sl_selectfrommodel import FLSelectFromModel


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_selectfrommodel_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_selectfrommodel_consistency():
    ...
    sf_model = FLSelectFromModel(spu)
...
if __name__ == "__main__":
    print(f"Testing FLSelectFromModel...")
