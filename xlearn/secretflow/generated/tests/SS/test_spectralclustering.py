...
"""
Tests for SSSpectralClustering
"""
...
def test_spectralclustering_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_spectralclustering_consistency():
    ...
    sf_model = SSSpectralClustering(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSSpectralClustering...")
