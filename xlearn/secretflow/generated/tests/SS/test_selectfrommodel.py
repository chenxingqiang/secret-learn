...
from xlearn.secretflow.generated.ss_selectfrommodel import SSSelectFromModel
...
def test_selectfrommodel_consistency():
    ...
    sf_model = SSSelectFromModel(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSSelectFromModel...")
