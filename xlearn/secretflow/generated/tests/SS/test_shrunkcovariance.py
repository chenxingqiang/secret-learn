...
from xlearn.secretflow.generated.ss_shrunkcovariance import SSShrunkCovariance
...
def test_shrunkcovariance_consistency():
    ...
    sf_model = SSShrunkCovariance(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSShrunkCovariance...")
