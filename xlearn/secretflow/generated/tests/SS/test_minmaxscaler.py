...
from xlearn.secretflow.generated.ss_minmaxscaler import SSMinMaxScaler


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_minmaxscaler_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_minmaxscaler_consistency():
...
if __name__ == "__main__":
    print(f"Testing SSMinMaxScaler...")
