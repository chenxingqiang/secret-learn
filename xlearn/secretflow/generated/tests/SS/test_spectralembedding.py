...
from xlearn.secretflow.generated.ss_spectralembedding import SSSpectralEmbedding
...
def test_spectralembedding_consistency():
    ...
    sf_model = SSSpectralEmbedding(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSSpectralEmbedding...")
