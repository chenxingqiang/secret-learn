...
from xlearn.secretflow.generated.ss_selectkbest import SSSelectKBest


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_selectkbest_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_selectkbest_consistency():
