...
from xlearn.secretflow.generated.ss_variancethreshold import SSVarianceThreshold
...
def test_variancethreshold_consistency():
    ...
    sf_model = SSVarianceThreshold(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSVarianceThreshold...")
