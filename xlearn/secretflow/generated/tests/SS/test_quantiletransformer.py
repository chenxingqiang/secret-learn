...
"""
Tests for SSQuantileTransformer
"""
...
from xlearn.secretflow.generated.ss_quantiletransformer import SSQuantileTransformer
...
def test_quantiletransformer_consistency():
    ...
    sf_model = SSQuantileTransformer(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSQuantileTransformer...")
