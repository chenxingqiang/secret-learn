...
"""
Tests for SSLogisticRegression
"""
...
def test_logisticregression_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_logisticregression_consistency():
    ...
    sf_model = SSLogisticRegression(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSLogisticRegression...")
