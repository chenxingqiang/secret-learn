...
"""
Tests for SSMultiOutputRegressor
"""
...
def test_multioutputregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_multioutputregressor_consistency():
    ...
    sf_model = SSMultiOutputRegressor(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSMultiOutputRegressor...")
