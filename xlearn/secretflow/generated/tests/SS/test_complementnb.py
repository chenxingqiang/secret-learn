...
from xlearn.secretflow.generated.ss_complementnb import SSComplementNB


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_complementnb_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_complementnb_consistency():
...
if __name__ == "__main__":
    print(f"Testing SSComplementNB...")
