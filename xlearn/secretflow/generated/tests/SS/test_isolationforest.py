...
from xlearn.secretflow.generated.ss_isolationforest import SSIsolationForest
...
def test_isolationforest_consistency():
    ...
    sf_model = SSIsolationForest(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSIsolationForest...")
