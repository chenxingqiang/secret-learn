...
"""
Tests for SSRandomForestClassifier
"""
...
def test_randomforestclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_randomforestclassifier_consistency():
    ...
    sf_model = SSRandomForestClassifier(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSRandomForestClassifier...")
