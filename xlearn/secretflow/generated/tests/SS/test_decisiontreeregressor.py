...
"""
Tests for SSDecisionTreeRegressor
"""
...
def test_decisiontreeregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_decisiontreeregressor_consistency():
    ...
    sf_model = SSDecisionTreeRegressor(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSDecisionTreeRegressor...")
