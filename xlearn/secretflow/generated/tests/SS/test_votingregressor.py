...
def test_votingregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_votingregressor_consistency():
    ...
    sf_model = SSVotingRegressor(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSVotingRegressor...")
