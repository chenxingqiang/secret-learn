...
from xlearn.secretflow.generated.ss_ransacregressor import SSRANSACRegressor


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_ransacregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_ransacregressor_consistency():
    ...
    sf_model = SSRANSACRegressor(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSRANSACRegressor...")
