...
"""
Tests for SSOneVsRestClassifier
"""
...
from xlearn.secretflow.generated.ss_onevsrestclassifier import SSOneVsRestClassifier


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_onevsrestclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_onevsrestclassifier_consistency():
    ...
    sklearn_model = OneVsRestClassifier()
    ...
    sf_model = SSOneVsRestClassifier(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSOneVsRestClassifier...")
