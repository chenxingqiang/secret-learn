...
from xlearn.secretflow.generated.ss_minibatchkmeans import SSMiniBatchKMeans
...
def test_minibatchkmeans_consistency():
    ...
    sf_model = SSMiniBatchKMeans(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSMiniBatchKMeans...")
