...
from xlearn.secretflow.generated.ss_votingclassifier import SSVotingClassifier
...
def test_votingclassifier_consistency():
    ...
    sf_model = SSVotingClassifier(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSVotingClassifier...")
