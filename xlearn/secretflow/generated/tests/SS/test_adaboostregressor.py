...
from xlearn.secretflow.generated.ss_adaboostregressor import SSAdaBoostRegressor


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_adaboostregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_adaboostregressor_consistency():
    ...
    sf_model = SSAdaBoostRegressor(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSAdaBoostRegressor...")
