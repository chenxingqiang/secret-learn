...
"""
Tests for SSQuadraticDiscriminantAnalysis
"""
...
from xlearn.secretflow.generated.ss_quadraticdiscriminantanalysis import SSQuadraticDiscriminantAnalysis
...
def test_quadraticdiscriminantanalysis_consistency():
    ...
    sf_model = SSQuadraticDiscriminantAnalysis(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSQuadraticDiscriminantAnalysis...")
