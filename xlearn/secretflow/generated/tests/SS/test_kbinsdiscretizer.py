...
from xlearn.secretflow.generated.ss_kbinsdiscretizer import SSKBinsDiscretizer
...
def test_kbinsdiscretizer_consistency():
    ...
    sf_model = SSKBinsDiscretizer(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSKBinsDiscretizer...")
