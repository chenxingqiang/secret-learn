...
"""
Tests for SSLocalOutlierFactor
"""
...
from xlearn.secretflow.generated.ss_localoutlierfactor import SSLocalOutlierFactor
...
def test_localoutlierfactor_consistency():
    ...
    sf_model = SSLocalOutlierFactor(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSLocalOutlierFactor...")
