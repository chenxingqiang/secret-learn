...
from xlearn.secretflow.generated.ss_robustscaler import SSRobustScaler


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_robustscaler_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_robustscaler_consistency():
...
if __name__ == "__main__":
    print(f"Testing SSRobustScaler...")
