...
"""
Tests for SSKNeighborsClassifier
"""
...
def test_kneighborsclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_kneighborsclassifier_consistency():
    ...
    sf_model = SSKNeighborsClassifier(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSKNeighborsClassifier...")
