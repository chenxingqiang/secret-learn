...
"""
Tests for SSOneVsOneClassifier
"""
...
from xlearn.secretflow.generated.ss_onevsoneclassifier import SSOneVsOneClassifier


@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_onevsoneclassifier_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_onevsoneclassifier_consistency():
    ...
    sklearn_model = OneVsOneClassifier()
    ...
    sf_model = SSOneVsOneClassifier(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSOneVsOneClassifier...")
