...
from xlearn.secretflow.generated.ss_splinetransformer import SSSplineTransformer
...
def test_splinetransformer_consistency():
    ...
    sf_model = SSSplineTransformer(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSSplineTransformer...")
