...
"""
Tests for SSKNeighborsRegressor
"""
...
def test_kneighborsregressor_basic():
...
@pytest.mark.skipif(not SECRETFLOW_AVAILABLE, reason="SecretFlow not available")
def test_kneighborsregressor_consistency():
    ...
    sf_model = SSKNeighborsRegressor(spu)
    sf_model.fit(fed_X)
...
if __name__ == "__main__":
    print(f"Testing SSKNeighborsRegressor...")
