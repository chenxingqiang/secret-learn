...
class MethodMetadataRequest:
    ...
    def _route_params(self, params, parent, caller):
        ...
        -------
        params : Bunch
            A :class:`~xlearn.utils.Bunch` of {metadata: value} which can be
...
class MetadataRequest:
    ...
    def _route_params(self, *, params, method, parent, caller):
        ...
        -------
        params : Bunch
            A :class:`~xlearn.utils.Bunch` of {metadata: value} which can be given to
...
class MetadataRouter:
    ...
    is an instance of :class:`~xlearn.utils.metadata_routing.MethodMapping` and
    ``router`` is either a
    :class:`~xlearn.utils.metadata_routing.MetadataRequest` or another
    :class:`~xlearn.utils.metadata_routing.MetadataRouter` instance.
    ...
    def add_self_request(self, obj):
        ...
        :class:`~xlearn.utils.metadata_routing.MetadataRequest`.
    ...
    def add(self, *, method_mapping, **objs):
        ...
        **objs : dict
            ...
            :func:`~xlearn.utils.metadata_routing.get_routing_for_object` on them.
    ...
    def route_params(self, *, caller, params):
        ...
        Returns a :class:`~xlearn.utils.Bunch` containing the metadata that this
        ...
        -------
        params : Bunch
            A :class:`~xlearn.utils.Bunch` of the form
...
def get_routing_for_object(obj=None):
    ...
    :class:`~xlearn.utils.metadata_routing.MetadataRouter` or a
    :class:`~xlearn.utils.metadata_routing.MetadataRequest` from the given input.
    ...
    obj : object
        ...
        - If the object is already a
            :class:`~xlearn.utils.metadata_routing.MetadataRequest` or a
            :class:`~xlearn.utils.metadata_routing.MetadataRouter`, return a copy
            of that.
        - Returns an empty :class:`~xlearn.utils.metadata_routing.MetadataRequest`
            otherwise.
...
Configure whether metadata should be requested to be passed to the ``{method}`` method.
        ...
        with ``enable_metadata_routing=True`` (see :func:`xlearn.set_config`).
...
this given alias instead of the original name.
        ...
        The default (``xlearn.utils.metadata_routing.UNCHANGED``) retains the
...
REQUESTER_DOC_PARAM = """        {metadata} : str, True, False, or None, \
                    default=xlearn.utils.metadata_routing.UNCHANGED
...
class _MetadataRequester:
    ...
    def _get_metadata_request(self):
        ...
        request : MetadataRequest
            A :class:`~xlearn.utils.metadata_routing.MetadataRequest` instance.
        """
    ...
    def get_metadata_routing(self):
        ...
        routing : MetadataRequest
            A :class:`~xlearn.utils.metadata_routing.MetadataRequest` encapsulating
            routing information.
        """
...
def process_routing(_obj, _method, /, **kwargs):
    ...
    **kwargs : dict
    ...
    routed_params : Bunch
        ...
        A :class:`~xlearn.utils.Bunch` of the form ``{"object_name": {"method_name":
        {metadata: value}}}`` which can be used to pass the required metadata to
