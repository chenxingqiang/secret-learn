...
warnings.warn(
    "Importing from xlearn.utils._estimator_html_repr is deprecated. The tools have "
    "been moved to xlearn.utils._repr_html. Be aware that this module is private and "
