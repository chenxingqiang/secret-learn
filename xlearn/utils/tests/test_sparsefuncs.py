...
from xlearn.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS, LIL_CONTAINERS
from xlearn.utils.sparsefuncs import (
...
from xlearn.utils.sparsefuncs_fast import (
    assign_rows_csr,
    csr_row_norms,
