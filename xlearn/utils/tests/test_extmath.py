...
from xlearn.datasets import make_low_rank_matrix, make_sparse_spd_matrix
...
from xlearn.utils.extmath import (
    _approximate_mode,
...
def test_approximate_mode():
    """Make sure xlearn.utils.extmath._approximate_mode returns valid
