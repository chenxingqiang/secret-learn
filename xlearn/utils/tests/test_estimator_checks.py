...
from xlearn import config_context, get_config
from xlearn.base import BaseEstimator, ClassifierMixin, OutlierMixin, TransformerMixin
...
from xlearn.svm import SVC, NuSVC
from xlearn.utils import _array_api, all_estimators, deprecated
from xlearn.utils._param_validation import Interval, StrOptions
from xlearn.utils._test_common.instance_generator import (
...
from xlearn.utils.fixes import CSR_CONTAINERS, SPARRAY_PRESENT
from xlearn.utils.metaestimators import available_if
from xlearn.utils.multiclass import type_of_target
...
class BadBalancedWeightsClassifier(BaseBadClassifier):
    ...
    def fit(self, X, y):
        from xlearn.preprocessing import LabelEncoder
...
def test_check_estimator_tags_renamed():
    ...
    # This shouldn't fail since we allow both __xlearn_tags__ and _more_tags
    # to exist so that third party estimators can easily support multiple xlearn
    # versions.
