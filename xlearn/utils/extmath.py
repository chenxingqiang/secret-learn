...
def randomized_range_finder(
    ...
    --------
    >>> import numpy as np
    >>> from xlearn.utils.extmath import randomized_range_finder
...
def weighted_mode(a, w, *, axis=0):
    ...
    Examples
    --------
    >>> from xlearn.utils.extmath import weighted_mode
    >>> x = [4, 1, 4, 2, 4, 2]
    >>> weights = [1, 1, 1, 1, 1, 1]
...
def cartesian(arrays, out=None):
    ...
    Examples
    --------
    >>> from xlearn.utils.extmath import cartesian
...
def svd_flip(u, v, u_based_decision=True):
    ...
    u : ndarray
        ...
        :func:`~xlearn.utils.extmath.randomized_svd`, with matching inner
...
def safe_sqr(X, *, copy=True):
    ...
    Examples
    --------
    >>> from xlearn.utils import safe_sqr
    >>> safe_sqr([1, 2, 3])
    array([1, 4, 9])
    """
...
def _approximate_mode(class_counts, n_draws, rng):
    ...
    --------
    >>> import numpy as np
    >>> from xlearn.utils.extmath import _approximate_mode
