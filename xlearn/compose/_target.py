...
class TransformedTargetRegressor(RegressorMixin, BaseEstimator):
    ...
    such as the :class:`~xlearn.preprocessing.QuantileTransformer` or as a
    ...
    regressor : object, default=None
        ...
        :class:`~xlearn.base.RegressorMixin`. This regressor will
        automatically be cloned each time prior to fitting. If `regressor is
        None`, :class:`~xlearn.linear_model.LinearRegression` is created and used.

    transformer : object, default=None
        Estimator object such as derived from
        :class:`~xlearn.base.TransformerMixin`. Cannot be set at the same time
    ...
    See Also
    --------
    xlearn.preprocessing.FunctionTransformer : Construct a transformer from an
        arbitrary callable.
