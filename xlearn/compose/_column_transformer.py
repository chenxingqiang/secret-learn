"""
The :mod:`xlearn.compose._column_transformer` module implements utilities
...
class ColumnTransformer(TransformerMixin, _BaseComposition):
    ...
    transformers_ : list
        ...
        :class:`~xlearn.preprocessing.FunctionTransformer`. In case there were
    ...
    named_transformers_ : :class:`~xlearn.utils.Bunch`
...
def make_column_transformer(
    ...
    *transformers : tuples
    ...
    Examples
    --------
    >>> from xlearn.preprocessing import StandardScaler, OneHotEncoder
