...
def make_classification(
    ...
    *,
    ...
    Returns
    -------
    data : :class:`~xlearn.utils.Bunch` if `return_X_y` is `False`.
...
/ X[:, 0]) + noise * N(0, 1).
    ...
    Examples
    --------
    >>> from xlearn.datasets import make_friedman3
...
def make_sparse_uncorrelated(n_samples=100, n_features=10, *, random_state=None):
    ...
    Examples
    --------
    >>> from xlearn.datasets import make_sparse_uncorrelated
...
def make_s_curve(n_samples=100, *, noise=0.0, random_state=None):
    ...
    Examples
    --------
    >>> from xlearn.datasets import make_s_curve
