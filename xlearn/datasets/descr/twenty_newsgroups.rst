...
:func:`xlearn.datasets.fetch_20newsgroups`,
returns a list of the raw texts that can be fed to text feature
extractors such as :class:`~xlearn.feature_extraction.text.CountVectorizer`
with custom parameters so as to extract feature vectors.
The second one, :func:`xlearn.datasets.fetch_20newsgroups_vectorized`,
...
.. dropdown:: Usage
  ...
  The :func:`xlearn.datasets.fetch_20newsgroups` function is a data
  ...
  :func:`xlearn.datasets.load_files` on either the training or
  ...
  :func:`xlearn.datasets.fetch_20newsgroups` function::
...
.. dropdown:: Converting text to vectors
  ...
  ``xlearn.feature_extraction.text`` as demonstrated in the following
  ...
  :func:`xlearn.datasets.fetch_20newsgroups_vectorized` is a function which
