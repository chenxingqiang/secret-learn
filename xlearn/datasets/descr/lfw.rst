...
.. dropdown:: Usage
  ...
  is a pair of two picture belonging or not to the same person::
    ...
    >>> from xlearn.datasets import fetch_lfw_pairs
  ...
  Both for the :func:`xlearn.datasets.fetch_lfw_people` and
  :func:`xlearn.datasets.fetch_lfw_pairs` function it is
  possible to get an additional dimension with the RGB color channels by
  passing ``color=True``, in that case the shape will be
  ``(2200, 2, 62, 47, 3)``.

  The :func:`xlearn.datasets.fetch_lfw_pairs` datasets is subdivided into
