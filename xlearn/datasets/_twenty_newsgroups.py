...
(classification).
    ...
    Returns
    -------
    bunch : :class:`~xlearn.utils.Bunch`
...
def fetch_20newsgroups_vectorized(
    *,
    ...
    :class:`~xlearn.feature_extraction.text.CountVectorizer`. For more
    advanced usage (stopword filtering, n-gram extraction, etc.), combine
    fetch_20newsgroups with a custom
    :class:`~xlearn.feature_extraction.text.CountVectorizer`,
    :class:`~xlearn.feature_extraction.text.HashingVectorizer`,
    :class:`~xlearn.feature_extraction.text.TfidfTransformer` or
    :class:`~xlearn.feature_extraction.text.TfidfVectorizer`.

    The resulting counts are normalized using
    :func:`xlearn.preprocessing.normalize` unless normalize is set to False.
    ...
    normalize : bool, default=True
        ...
        :func:`xlearn.preprocessing.normalize`.
