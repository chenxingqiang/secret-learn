...
DATA_MODULE = "xlearn.datasets.data"
DESCR_MODULE = "xlearn.datasets.descr"
IMAGES_MODULE = "xlearn.datasets.images"
...
def clear_data_home(data_home=None):
    ...
    Examples
    --------
    >>> from xlearn.datasets import clear_data_home
...
def load_files(
    ...
    *,
    ...
    to use most functions in :mod:`~xlearn.feature_extraction.text`.
...
def load_csv_data(
    ...
    *,
    ...
    data_module : str or module, default='xlearn.datasets.data'
        Module where data lives. The default is `'xlearn.datasets.data'`.
    ...
    descr_module : str or module, default='xlearn.datasets.descr'
        Module where `descr_file_name` lives. See also :func:`load_descr`.
        The default is `'xlearn.datasets.descr'`.
...
def load_linnerud(*, return_X_y=False, as_frame=False):
    ...
    Examples
    --------
    >>> from xlearn.datasets import load_linnerud
...
def load_sample_images():
    ...
    >>> from xlearn.datasets import load_sample_images
