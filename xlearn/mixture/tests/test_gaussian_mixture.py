...
from xlearn.datasets import make_spd_matrix
...
from xlearn.mixture._gaussian_mixture import (
...
from xlearn.utils.extmath import fast_logdet
...
def test_gaussian_mixture_all_init_does_not_estimate_gaussian_parameters(
    ...
    monkeypatch.setattr(
        xlearn.mixture._gaussian_mixture, "_estimate_gaussian_parameters", mock
    )
