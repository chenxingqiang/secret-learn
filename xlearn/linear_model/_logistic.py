...
class LogisticRegression(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    solver : {'lbfgs', 'liblinear', 'newton-cg', 'newton-cholesky', 'sag', 'saga'}, \
        ...
        .. note::
           ...
           a scaler from :mod:`xlearn.preprocessing`.
    ...
    multi_class : {'auto', 'ovr', 'multinomial'}, default='auto'
        ...
        .. deprecated:: 1.5
           ...
           Use `xlearn.multiclass.OneVsRestClassifier(LogisticRegression())` if you
...
class LogisticRegressionCV(LogisticRegression, LinearClassifierMixin, BaseEstimator):
    ...
    :class:`~xlearn.model_selection.StratifiedKFold`, but it can be changed
    ...
    cv : int or cross-validation generator, default=None
        ...
        See the module :mod:`xlearn.model_selection` module for the
    ...
    multi_class : {'auto, 'ovr', 'multinomial'}, default='auto'
        ...
        .. deprecated:: 1.5
           ...
           `n_classes >= 3`.
           Solvers that do not support 'multinomial' will raise an error.
           Use `xlearn.multiclass.OneVsRestClassifier(LogisticRegressionCV())` if you
           still want to use OvR.
