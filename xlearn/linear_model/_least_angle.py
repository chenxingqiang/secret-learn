...
# mypy error: Module 'xlearn.utils' has no attribute 'arrayfuncs'
from ..utils import (
    Bunch,
    arrayfuncs,
    as_float_array,
...
def lars_path(
    ...
    *,
    ...
    xlearn.decomposition.sparse_encode : Sparse coding.
...
def lars_path_gram(
    ...
    *,
    ...
    Examples
    --------
    >>> from xlearn.linear_model import lars_path_gram
    >>> from xlearn.datasets import make_regression
    >>> X, y, true_coef = make_regression(
    ...    n_samples=100, n_features=5, n_informative=2, coef=True, random_state=0
    ... )
...
class LarsCV(Lars):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        For integer/None inputs, :class:`~xlearn.model_selection.KFold` is used.
    ...
    Examples
    --------
    >>> from xlearn.linear_model import LarsCV
    >>> from xlearn.datasets import make_regression
...
class LassoLarsCV(LarsCV):
    ...
    :class:`~xlearn.linear_model.LassoCV` object. However, unlike the
    :class:`~xlearn.linear_model.LassoCV`, it find the relevant alphas values
    by itself. In general, because of this property, it will be more stable.
    However, it is more fragile to heavily multicollinear datasets.

    It is more efficient than the :class:`~xlearn.linear_model.LassoCV` if
