...
# mypy error: Module 'xlearn.linear_model' has no attribute '_cd_fast'
...
def lasso_path(
    ...
    **params : kwargs
    ...
    xlearn.decomposition.sparse_encode : Estimator that can be used to
    ...
    >>> import numpy as np
    >>> from xlearn.linear_model import lasso_path
    ...
    >>> # same path
    >>> from xlearn.linear_model import lars_path
...
def enet_path(
    ...
    **params : kwargs
    ...
    Examples
    --------
    >>> from xlearn.linear_model import enet_path
...
class Lasso(ElasticNet):
    ...
    xlearn.decomposition.sparse_encode : Sparse coding array estimator.
    ...
    models such as :class:`~xlearn.linear_model.LogisticRegression` or
    :class:`~xlearn.svm.LinearSVC`.
    ...
    It should not be confused with :class:`~xlearn.linear_model.MultiTaskLasso` which
...
class LassoCV(RegressorMixin, LinearModelCV):
    ...
    cv : int, cross-validation generator or iterable, default=None
        ...
        For int/None inputs, :class:`~xlearn.model_selection.KFold` is used.
    ...
    search using :class:`~xlearn.model_selection.GridSearchCV` with a
...
class ElasticNetCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from xlearn.linear_model import ElasticNetCV
    >>> from xlearn.datasets import make_regression
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from xlearn.linear_model import MultiTaskLassoCV
    >>> from xlearn.datasets import make_regression
