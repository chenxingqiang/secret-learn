...
def orthogonal_mp(
    ...
    *,
    ...
    >>> from xlearn.linear_model import orthogonal_mp
...
def orthogonal_mp_gram(
    ...
    *,
    ...
    lars_path : Compute Least Angle Regression or Lasso path using
        LARS algorithm.
    xlearn.decomposition.sparse_encode : Generic sparse coding.
    ...
    --------
    >>> from xlearn.datasets import make_regression
    >>> from xlearn.linear_model import orthogonal_mp_gram
    >>> X, y = make_regression(noise=4, random_state=0)
...
class OrthogonalMatchingPursuit(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from xlearn.linear_model import OrthogonalMatchingPursuit
    >>> from xlearn.datasets import make_regression
    >>> X, y = make_regression(noise=4, random_state=0)
