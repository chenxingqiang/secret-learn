...
from xlearn._loss import HalfMultinomialLoss
...
from xlearn.linear_model._logistic import (
...
from xlearn.metrics import get_scorer, log_loss
...
from xlearn.preprocessing import LabelEncoder, StandardScaler, scale
from xlearn.svm import l1_min_c
from xlearn.utils import compute_class_weight, shuffle
from xlearn.utils._testing import ignore_warnings, skip_if_no_parallel
from xlearn.utils.fixes import _IS_32BIT, COO_CONTAINERS, CSR_CONTAINERS

pytestmark = pytest.mark.filterwarnings(
    "error::xlearn.exceptions.ConvergenceWarning:xlearn.*"
)
