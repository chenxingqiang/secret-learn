...
from xlearn.linear_model import HuberRegressor, QuantileRegressor
...
def test_error_interior_point_future(X_y_data, monkeypatch):
    ...
    """
    X, y = X_y_data
    import xlearn.linear_model._quantile

    with monkeypatch.context() as m:
        m.setattr(xlearn.linear_model._quantile, "sp_version", parse_version("1.11.0"))
