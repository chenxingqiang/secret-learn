...
from xlearn.base import clone, config_context, is_classifier
from xlearn.datasets import load_diabetes, make_regression
...
from xlearn.linear_model._coordinate_descent import _set_order
from xlearn.model_selection import (
    BaseCrossValidator,
    GridSearchCV,
    LeaveOneGroupOut,
)
from xlearn.model_selection._split import GroupsConsumerMixin
...
def test_lassoCV_does_not_set_precompute(monkeypatch, precompute, inner_precompute):
    ...
    monkeypatch.setattr("xlearn.linear_model._coordinate_descent.Lasso", LassoMock)
