...
from xlearn._loss import HalfBinomialLoss, HalfPoissonLoss, HalfTweedieLoss
from xlearn._loss.link import IdentityLink, LogLink
from xlearn.base import clone
from xlearn.datasets import make_low_rank_matrix, make_regression
...
from xlearn.linear_model._glm import _GeneralizedLinearRegressor
from xlearn.linear_model._glm._newton_solver import NewtonCholeskySolver
from xlearn.linear_model._linear_loss import LinearModelLoss
from xlearn.metrics import d2_tweedie_score, mean_poisson_deviance
...
def test_glm_regression_unpenalized(solver, fit_intercept, glm_dataset):
    ...
    if n_samples > n_features:
        ...
        if solver == "newton-cholesky":
            ...
            # See https://github.com/chenxingqiang/secret-learn/issues/23670.
...
def test_tags(estimator, value):
    ...
    assert estimator.__xlearn_tags__().target_tags.positive_only is value
