    ...
    *,
    ...
    solver : {'auto', 'svd', 'cholesky', 'lsqr', 'sparse_cg', \
        ...
        - 'sag' uses a Stochastic Average Gradient descent, and 'saga' uses
          ...
          scaler from xlearn.preprocessing.
    ...
    return_intercept : bool, default=False
        ...
        data, use xlearn.linear_model._preprocess_data before your regression.
    ...
    :class:`~xlearn.svm.LinearSVC`. If an array is passed, penalties are
    ...
    >>> from xlearn.linear_model import ridge_regression
...
class Ridge(MultiOutputMixin, RegressorMixin, _BaseRidge):
    ...
    :class:`~xlearn.kernel_ridge.KernelRidge` : Kernel ridge regression
...
class RidgeCV(MultiOutputMixin, RegressorMixin, _BaseRidgeCV):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~xlearn.model_selection.StratifiedKFold` is used, else,
        :class:`~xlearn.model_selection.KFold` is used.
