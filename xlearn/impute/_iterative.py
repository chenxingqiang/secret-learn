...
class IterativeImputer(_BaseImputer):
    ...
    .. note::
      ...
      you need to explicitly import `enable_iterative_imputer`::
        ...
        >>> # now you can import normally from xlearn.impute
    ...
    initial_strategy : {'mean', 'median', 'most_frequent', 'constant'}, \
        ...
        `strategy` parameter in :class:`~xlearn.impute.SimpleImputer`.
    ...
    Attributes
    ----------
    initial_imputer_ : object of type :class:`~xlearn.impute.SimpleImputer`
    ...
    indicator_ : :class:`~xlearn.impute.MissingIndicator`
    ...
    def _impute_one_feature(
        ...
        estimator : estimator with xlearn API
    ...
    def fit_transform(self, X, y=None, **params):
        ...
        **params : dict
            ...
            .. versionadded:: 1.5
              Only available if
              `xlearn.set_config(enable_metadata_routing=True)` is set. See
