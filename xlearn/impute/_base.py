...
class SimpleImputer(_BaseImputer):
    ...
    .. versionadded:: 0.20
       `SimpleImputer` replaces the previous `xlearn.preprocessing.Imputer`
    ...
    :class:`~xlearn.impute.IterativeImputer` or :class:`~xlearn.impute.KNNImputer`.
...
class MissingIndicator(TransformerMixin, BaseEstimator):
    ...
    :class:`~xlearn.pipeline.Pipeline` consisting of transformers and a
