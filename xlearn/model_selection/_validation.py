"""
The :mod:`xlearn.model_selection._validation` module includes classes and
...
def _check_groups_routing_disabled(groups):
    if groups is not None and _routing_enabled():
        raise ValueError(
            ...
            " `xlearn.set_config(enable_metadata_routing=True)`. When routing is"
    ...
    *,
    ...
    groups : array-like of shape (n_samples,), default=None
        ...
        .. versionchanged:: 1.4
            ...
            via ``xlearn.set_config(enable_metadata_routing=True)``. When routing
    ...
    xlearn.metrics.make_scorer : Make a scorer from a performance metric or
        loss function.
    ...
    if n_classes != len(classes):
        ...
        if method == "decision_function":
            if predictions.ndim == 2 and predictions.shape[1] != len(classes):
                ...
                # it with. This case is found when xlearn.svm.SVC is
...
def permutation_test_score(
    ...
    *,
    ...
    >>> from xlearn.model_selection import permutation_test_score
