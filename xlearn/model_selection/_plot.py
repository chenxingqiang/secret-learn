...
class LearningCurveDisplay(_BaseCurveDisplay):
    ...
    :meth:`~xlearn.model_selection.LearningCurveDisplay.from_estimator` to
    create a :class:`~xlearn.model_selection.LearningCurveDisplay` instance.
    ...
    See Also
    --------
    xlearn.model_selection.learning_curve : Compute the learning curve.

    Examples
    --------
    >>> import matplotlib.pyplot as plt
    >>> from xlearn.datasets import load_iris
    >>> from xlearn.model_selection import LearningCurveDisplay, learning_curve
    ...
    def plot(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~xlearn.model_selection.LearningCurveDisplay`
    ...
    def from_estimator(
        ...
        *,
        ...
        cv : int, cross-validation generator or an iterable, default=None
            ...
            :class:`~xlearn.model_selection.StratifiedKFold` is used. In all
            other cases, :class:`~xlearn.model_selection.KFold` is used. These
...
class ValidationCurveDisplay(_BaseCurveDisplay):
    ...
    It is recommended to use
    :meth:`~xlearn.model_selection.ValidationCurveDisplay.from_estimator` to
    create a :class:`~xlearn.model_selection.ValidationCurveDisplay` instance.
    All parameters are stored as attributes.
    ...
    See Also
    --------
    xlearn.model_selection.validation_curve : Compute the validation curve.
    ...
    >>> from xlearn.model_selection import ValidationCurveDisplay, validation_curve
    ...
    def plot(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~xlearn.model_selection.ValidationCurveDisplay`
            Object that stores computed values.
        """
        self._plot_curve(
            self.param_range,
