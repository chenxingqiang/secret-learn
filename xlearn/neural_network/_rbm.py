...
class BernoulliRBM(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    xlearn.neural_network.MLPRegressor : Multi-layer Perceptron regressor.
    xlearn.neural_network.MLPClassifier : Multi-layer Perceptron classifier.
    xlearn.decomposition.PCA : An unsupervised linear dimensionality
        reduction model.
