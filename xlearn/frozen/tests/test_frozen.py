...
from xlearn.preprocessing import RobustScaler, StandardScaler
from xlearn.utils._testing import set_random_state
...
def test_frozen_tags():
    ...
    estimator = Estimator()
    frozen = FrozenEstimator(estimator)
    frozen_tags = frozen.__xlearn_tags__()
    estimator_tags = estimator.__xlearn_tags__()
