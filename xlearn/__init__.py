...
# vcomp shared library runtime for OpenMP embedded in the xlearn/.libs
# sub-folder.
...
def __getattr__(name):
    if name in _submodules:
        ...
        try:
            ...
            raise AttributeError(f"Module 'xlearn' has no attribute '{name}'")


_BUILT_WITH_MESON = False
try:
    import xlearn._built_with_meson  # noqa: F401
