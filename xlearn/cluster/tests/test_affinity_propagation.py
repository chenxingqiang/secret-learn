...
from xlearn.cluster import AffinityPropagation, affinity_propagation
from xlearn.cluster._affinity_propagation import _equal_similarities_and_preferences
