...
class Birch(
    ...
    n_clusters : int, instance of xlearn.cluster model or None, default=3
        ...
        - :mod:`xlearn.cluster` Estimator : If a model is provided, the model
    ...
    comparison with :class:`~xlearn.cluster.MiniBatchKMeans`.
    ...
    * Roberto Perdisci
    ...
    Examples
    --------
    >>> from xlearn.cluster import Birch
