...
# mypy error: Module 'xlearn.cluster' has no attribute '_hierarchical_fast'
...
def ward_tree(X, *, connectivity=None, n_clusters=None, return_distance=False):
    ...
    --------
    >>> import numpy as np
    >>> from xlearn.cluster import ward_tree
...
def linkage_tree(
    ...
    if connectivity is None:
        ...
        if affinity == "precomputed":
            ...
            # by xlearn.metrics.pairwise_distances.
...
class AgglomerativeClustering(ClusterMixin, BaseEstimator):
    ...
    connectivity : array-like, sparse matrix, or callable, default=None
        ...
        :class:`~xlearn.neighbors.kneighbors_graph`, see
...
class FeatureAgglomeration(
    ...
    --------
    >>> import numpy as np
    >>> from xlearn import datasets, cluster
