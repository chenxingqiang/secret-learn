...
class Isomap(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    metric : str, or callable, default="minkowski"
        ...
        the options allowed by :func:`xlearn.metrics.pairwise_distances` for
    ...
    p : float, default=2
        ...
        xlearn.metrics.pairwise.pairwise_distances. When p = 1, this is
    ...
    kernel_pca_ : object
        :class:`~xlearn.decomposition.KernelPCA` object used to implement the
        embedding.

    nbrs_ : xlearn.neighbors.NearestNeighbors instance
