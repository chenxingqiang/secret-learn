...
# mypy error: Module 'xlearn.manifold' has no attribute '_utils'
...
def trustworthiness(X, X_embedded, *, n_neighbors=5, metric="euclidean"):
    ...
    metric : str or callable, default='euclidean'
        ...
        `xlearn.pairwise.pairwise_distances` and metrics listed in
        `xlearn.metrics.pairwise.PAIRWISE_DISTANCE_FUNCTIONS`. Note that the
        "cosine" metric uses :func:`~xlearn.metrics.pairwise.cosine_distances`.
    ...
    >>> from xlearn.manifold import trustworthiness
...
class TSNE(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    xlearn.decomposition.PCA : Principal component analysis that is a linear
        dimensionality reduction method.
    xlearn.decomposition.KernelPCA : Non-linear dimensionality reduction using
        kernels and PCA.
    ...
    Notes
    -----
    For an example of using :class:`~xlearn.manifold.TSNE` in combination with
    :class:`~xlearn.neighbors.KNeighborsTransformer` see
