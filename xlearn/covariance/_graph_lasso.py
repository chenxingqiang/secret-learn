...
def graphical_lasso(
    ...
    *,
    ...
    >>> from xlearn.covariance import empirical_covariance, graphical_lasso
...
class GraphicalLasso(BaseGraphicalLasso):
    ...
    --------
    >>> import numpy as np
    >>> from xlearn.covariance import GraphicalLasso
...
class GraphicalLassoCV(BaseGraphicalLasso):
    ...
    For an example comparing :class:`xlearn.covariance.GraphicalLassoCV`,
    :func:`xlearn.covariance.ledoit_wolf` shrinkage and the empirical covariance
