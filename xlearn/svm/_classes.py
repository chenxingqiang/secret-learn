...
class LinearSVC(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    The main differences between :class:`~xlearn.svm.LinearSVC` and
    :class:`~xlearn.svm.SVC` lie in the loss function used by default, and in
...
class LinearSVR(RegressorMixin, LinearModel):
    ...
    The main differences between :class:`~xlearn.svm.LinearSVR` and
    :class:`~xlearn.svm.SVR` lie in the loss function used by default, and in
    the handling of intercept regularization between those two implementations.
    ...
    SVR : Implementation of Support Vector Machine regression using libsvm:
        ...
        large number of samples as :class:`~xlearn.svm.LinearSVR` does.
