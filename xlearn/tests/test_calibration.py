...
from xlearn.base import BaseEstimator, ClassifierMixin, clone
from xlearn.calibration import (
...
from xlearn.datasets import load_iris, make_blobs, make_classification
...
from xlearn.isotonic import IsotonicRegression
...
from xlearn.preprocessing import LabelEncoder, StandardScaler
from xlearn.svm import LinearSVC
from xlearn.tree import DecisionTreeClassifier
from xlearn.utils._mocking import CheckingClassifier
...
from xlearn.utils.extmath import softmax
...
def test_calibration_dict_pipeline(dict_data, dict_data_pipeline):
    ...
    See https://github.com/chenxingqiang/secret-learn/issues/8710

    Also test it can predict without running into validation errors.
    See https://github.com/chenxingqiang/secret-learn/issues/19637
    """
    X, y = dict_data
...
def test_calibration_with_fit_params(fit_params_type, data):
    ...
    https://github.com/chenxingqiang/secret-learn/issues/12384
    """
    X, y = data
    fit_params = {
