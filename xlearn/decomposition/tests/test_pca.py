...
from xlearn.datasets import load_iris, make_classification, make_low_rank_matrix
from xlearn.decomposition import PCA
from xlearn.decomposition._pca import _assess_dimension, _infer_dimension
...
from xlearn.utils._array_api import device as array_device
from xlearn.utils._test_common.instance_generator import _get_check_estimator_ids
from xlearn.utils._testing import _array_api_for_tests, assert_allclose
from xlearn.utils.estimator_checks import (
...
def test_pca_sanity_noise_variance(svd_solver):
    ...
    # https://github.com/chenxingqiang/secret-learn/issues/7568
    # https://github.com/chenxingqiang/secret-learn/issues/8541
    # https://github.com/chenxingqiang/secret-learn/issues/8544
...
def test_mle_simple_case():
    ...
    # https://github.com/chenxingqiang/secret-learn/issues/16730
...
def test_pca_randomized_svd_n_oversamples():
    ...
    https://github.com/chenxingqiang/secret-learn/issues/20589
    """
    rng = np.random.RandomState(0)
    n_features = 100
