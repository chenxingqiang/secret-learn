...
from xlearn.decomposition import PCA, FastICA, fastica
from xlearn.decomposition._fastica import _gs_decorrelation
from xlearn.exceptions import ConvergenceWarning
from xlearn.utils._testing import assert_allclose, ignore_warnings
...
def test_fastica_simple(add_noise, global_random_seed, global_dtype):
    if (
        ...
        pytest.xfail(
            ...
            "https://github.com/chenxingqiang/secret-learn/issues/24131#issuecomment-1208091119"
        )
