...
class KernelPCA(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def inverse_transform(self, X):
        ...
        .. note:
            :meth:`~xlearn.decomposition.fit` internally uses a centered
        ...
        .. note::
            ...
            :class:`~xlearn.decomposition.PCA` instead. Unlike
            :class:`~xlearn.decomposition.PCA`,
            :class:`~xlearn.decomposition.KernelPCA`'s ``inverse_transform``
