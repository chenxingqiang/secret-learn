...
class TruncatedSVD(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    returned by the vectorizers in :mod:`xlearn.feature_extraction.text`. In
    ...
    n_iter : int, default=5
        ...
        :func:`~xlearn.utils.extmath.randomized_svd` to handle sparse
        matrices that may have large slowly decaying spectrum.

    n_oversamples : int, default=10
        Number of oversamples for randomized SVD solver. Not used by ARPACK.
        See :func:`~xlearn.utils.extmath.randomized_svd` for a complete
        description.
    ...
    power_iteration_normalizer : {'auto', 'QR', 'LU', 'none'}, default='auto'
        ...
        Not used by ARPACK. See :func:`~xlearn.utils.extmath.randomized_svd`
        for more details.
