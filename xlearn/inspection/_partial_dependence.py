...
def _partial_dependence_recursion(est, grid, features):
    ...
    (:func:`~xlearn.inspection._partial_dependence._partial_dependence_brute`).
    ...
    est : BaseEstimator
        ...
        estimators (namely
        :class:`~xlearn.ensemble.GradientBoostingClassifier`,
        :class:`~xlearn.ensemble.GradientBoostingRegressor`,
        :class:`~xlearn.ensemble.HistGradientBoostingClassifier`,
        :class:`~xlearn.ensemble.HistGradientBoostingRegressor`,
        :class:`~xlearn.tree.DecisionTreeRegressor`,
        :class:`~xlearn.ensemble.RandomForestRegressor`,
        ).
...
def _partial_dependence_brute(
    ...
    (:func:`~xlearn.inspection._partial_dependence._partial_dependence_recursion`)
...
def partial_dependence(
    ...
    *,
    ...
    .. warning::
        ...
        For :class:`~xlearn.ensemble.GradientBoostingClassifier` and
        :class:`~xlearn.ensemble.GradientBoostingRegressor`, the
        ...
        :class:`~xlearn.ensemble.GradientBoostingClassifier` and
        :class:`~xlearn.ensemble.GradientBoostingRegressor`, not to
    ...
    Returns
    -------
    predictions : :class:`~xlearn.utils.Bunch`
