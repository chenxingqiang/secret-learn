...
from xlearn.ensemble import RandomForestClassifier, RandomForestRegressor
...
from xlearn.preprocessing import KBinsDiscretizer, OneHotEncoder, StandardScaler, scale
...
def test_permutation_importance_large_memmaped_data(input_type):
    ...
    # https://github.com/chenxingqiang/secret-learn/issues/15810
