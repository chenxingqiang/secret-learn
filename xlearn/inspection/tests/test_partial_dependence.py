...
import xlearn
from xlearn.base import BaseEstimator, ClassifierMixin, clone, is_regressor
from xlearn.cluster import KMeans
from xlearn.compose import make_column_transformer
from xlearn.datasets import load_iris, make_classification, make_regression
...
from xlearn.inspection._partial_dependence import (
    _grid_from_X,
    _partial_dependence_brute,
    _partial_dependence_recursion,
)
from xlearn.linear_model import LinearRegression, LogisticRegression, MultiTaskLasso
...
from xlearn.tree.tests.test_tree import assert_is_subtree
...
@pytest.mark.parametrize(
    "Estimator",
    (
        xlearn.tree.DecisionTreeClassifier,
        xlearn.tree.ExtraTreeClassifier,
        xlearn.ensemble.ExtraTreesClassifier,
        xlearn.neighbors.KNeighborsClassifier,
        xlearn.neighbors.RadiusNeighborsClassifier,
        xlearn.ensemble.RandomForestClassifier,
    ),
)
