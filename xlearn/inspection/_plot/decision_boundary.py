...
class DecisionBoundaryDisplay:
    ...
    :func:`~xlearn.inspection.DecisionBoundaryDisplay.from_estimator`
    ...
    def plot(self, plot_method="contourf", ax=None, xlabel=None, ylabel=None, **kwargs):
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display: :class:`~xlearn.inspection.DecisionBoundaryDisplay`
    ...
    def from_estimator(
        ...
        **kwargs : dict
        ...
        xlearn.metrics.ConfusionMatrixDisplay.from_estimator : Plot the
            confusion matrix given an estimator, the data, and the label.
        xlearn.metrics.ConfusionMatrixDisplay.from_predictions : Plot the
