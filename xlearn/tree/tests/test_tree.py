"""
Testing for the tree module (xlearn.tree).
"""
...
from xlearn import clone, datasets, tree
...
from xlearn.metrics import accuracy_score, mean_poisson_deviance, mean_squared_error
...
from xlearn.tree import (
    DecisionTreeClassifier,
    DecisionTreeRegressor,
    ExtraTreeClassifier,
    ExtraTreeRegressor,
)
from xlearn.tree._classes import (
    CRITERIA_CLF,
    CRITERIA_REG,
    DENSE_SPLITTERS,
    SPARSE_SPLITTERS,
)
from xlearn.tree._partitioner import _py_sort
from xlearn.tree._tree import (
    NODE_DTYPE,
    TREE_LEAF,
    TREE_UNDEFINED,
...
from xlearn.utils import compute_sample_weight
...
def test_realloc():
    from xlearn.tree._utils import _realloc_test
...
def get_different_bitness_node_ndarray(node_ndarray):
    ...
    # field names in Node struct with SIZE_t types (see xlearn/tree/_tree.pxd)
