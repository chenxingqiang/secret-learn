...
def check_increasing(x, y):
    ...
    Examples
    --------
    >>> from xlearn.isotonic import check_increasing
...
class IsotonicRegression(RegressorMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    xlearn.linear_model.LinearRegression : Ordinary least squares Linear
        Regression.
    xlearn.ensemble.HistGradientBoostingRegressor : Gradient boosting that
