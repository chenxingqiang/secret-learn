...
def get_equivalent_estimator(estimator, lib="lightgbm", n_classes=None):
    ...
    This utility function takes care of renaming the xlearn parameters into
    ...
    lightgbm_params = {
        "objective": lightgbm_loss_mapping[xlearn_params["loss"]],
        "learning_rate": xlearn_params["learning_rate"],
        "n_estimators": xlearn_params["max_iter"],
        "num_leaves": xlearn_params["max_leaf_nodes"],
        "max_depth": xlearn_params["max_depth"],
        "min_data_in_leaf": xlearn_params["min_samples_leaf"],
        "reg_lambda": xlearn_params["l2_regularization"],
        "max_bin": xlearn_params["max_bins"],
        "min_data_in_bin": 1,
        "min_sum_hessian_in_leaf": 1e-3,
        "min_split_gain": 0,
        "verbosity": 10 if xlearn_params["verbose"] else -10,
        ...
        "feature_fraction_bynode": xlearn_params["max_features"],
    }

    if xlearn_params["loss"] == "log_loss" and n_classes > 2:
    ...
    xgboost_params = {
        ...
        "learning_rate": xlearn_params["learning_rate"],
        "n_estimators": xlearn_params["max_iter"],
        "max_leaves": xlearn_params["max_leaf_nodes"],
        "max_depth": xlearn_params["max_depth"] or 0,
        "lambda": xlearn_params["l2_regularization"],
        "max_bin": xlearn_params["max_bins"],
        "min_child_weight": 1e-3,
        "verbosity": 2 if xlearn_params["verbose"] else 0,
        "silent": xlearn_params["verbose"] == 0,
        "n_jobs": -1,
        "colsample_bynode": xlearn_params["max_features"],
    }
    ...
    catboost_params = {
        "loss_function": catboost_loss_mapping[xlearn_params["loss"]],
        "learning_rate": xlearn_params["learning_rate"],
        "iterations": xlearn_params["max_iter"],
        "depth": xlearn_params["max_depth"],
        "reg_lambda": xlearn_params["l2_regularization"],
        "max_bin": xlearn_params["max_bins"],
        "feature_border_type": "Median",
        "leaf_estimation_method": "Newton",
        "verbose": bool(xlearn_params["verbose"]),
    }
