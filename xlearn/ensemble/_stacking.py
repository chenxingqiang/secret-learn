...
class StackingClassifier(ClassifierMixin, _BaseStacking):
    ...
    cv : int, cross-validation generator, iterable, or "prefit", default=None
        ...
        * `"prefit"`, to assume the `estimators` are prefit. In this case, the
        ...
        :class:`~xlearn.model_selection.StratifiedKFold` is used.
        In all other cases, :class:`~xlearn.model_selection.KFold` is used.
    ...
    named_estimators_ : :class:`~xlearn.utils.Bunch`
    ...
    def fit(self, X, y, **fit_params):
        ...
        **fit_params : dict
            ...
            .. versionadded:: 1.6
                ...
                set by using ``xlearn.set_config(enable_metadata_routing=True)``.
...
class StackingRegressor(RegressorMixin, _BaseStacking):
    ...
    final_estimator : estimator, default=None
        ...
        The default regressor is a :class:`~xlearn.linear_model.RidgeCV`.
