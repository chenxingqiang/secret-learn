...
from xlearn.datasets import load_diabetes, load_iris, make_hastie_10_2
from xlearn.dummy import DummyClassifier, DummyRegressor
...
from xlearn.linear_model import LogisticRegression, Perceptron
from xlearn.model_selection import GridSearchCV, ParameterGrid, train_test_split
from xlearn.neighbors import KNeighborsClassifier, KNeighborsRegressor
from xlearn.pipeline import make_pipeline
from xlearn.preprocessing import FunctionTransformer, scale
...
from xlearn.utils._testing import assert_array_almost_equal, assert_array_equal
from xlearn.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS
...
def test_bagging_allow_nan_tag(bagging, expected_allow_nan):
    ...
    assert bagging.__xlearn_tags__().input_tags.allow_nan == expected_allow_nan
...
def test_metadata_routing_with_dynamic_method_selection(sub_estimator, caller, callee):
    ...
    xlearn/tests/test_metaestimators_metadata_routing.py: `BaggingClassifier.predict()`
