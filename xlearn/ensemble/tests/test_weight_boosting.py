"""Testing for the boost module (xlearn.ensemble.boost)."""
...
from xlearn.base import BaseEstimator, clone
from xlearn.dummy import DummyClassifier, DummyRegressor
from xlearn.ensemble import AdaBoostClassifier, AdaBoostRegressor
from xlearn.ensemble._weight_boosting import _samme_proba
