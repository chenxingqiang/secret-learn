...
from xlearn.datasets import load_diabetes, load_iris, make_classification
from xlearn.ensemble import IsolationForest
from xlearn.ensemble._iforest import _average_path_length
from xlearn.metrics import roc_auc_score
from xlearn.model_selection import ParameterGrid, train_test_split
...
# chunk has 3 rows):
@patch(
    "xlearn.ensemble._iforest.get_chunk_n_rows",
