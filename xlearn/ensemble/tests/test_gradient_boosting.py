"""
Testing for the gradient boosting module (xlearn.ensemble.gradient_boosting).
"""
...
from xlearn.ensemble import GradientBoostingClassifier, GradientBoostingRegressor
from xlearn.ensemble._gb import _safe_divide
from xlearn.ensemble._gradient_boosting import predict_stages
from xlearn.exceptions import DataConversionWarning, NotFittedError
...
from xlearn.utils._mocking import NoSampleWeightWrapper
from xlearn.utils._param_validation import InvalidParameterError
from xlearn.utils._testing import (
    assert_array_almost_equal,
    assert_array_equal,
    skip_if_32bit,
)
from xlearn.utils.fixes import COO_CONTAINERS, CSC_CONTAINERS, CSR_CONTAINERS
...
def test_complete_classification():
    ...
    from xlearn.tree._tree import TREE_LEAF
...
def test_gradient_boosting_with_init(
    ...
    # Check that GradientBoostingRegressor works when init is a xlearn
    # estimator.
