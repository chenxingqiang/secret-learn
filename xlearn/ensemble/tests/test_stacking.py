...
from xlearn.base import BaseEstimator, ClassifierMixin, RegressorMixin, clone
...
from xlearn.exceptions import ConvergenceWarning, NotFittedError
...
from xlearn.model_selection import KFold, StratifiedKFold, train_test_split
...
from xlearn.svm import SVC, LinearSVC, LinearSVR
