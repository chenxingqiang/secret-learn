...
- :class:`~xlearn.ensemble.AdaBoostClassifier` implements adaptive boosting
  (AdaBoost-SAMME) for classification problems.

- :class:`~xlearn.ensemble.AdaBoostRegressor` implements adaptive boosting
...
class AdaBoostClassifier(
    ...
    estimator : object, default=None
        ...
        the base estimator is :class:`~xlearn.tree.DecisionTreeClassifier`
    ...
    xlearn.tree.DecisionTreeClassifier : A non-parametric supervised learning
...
class AdaBoostRegressor(_RoutingNotSupportedMixin, RegressorMixin, BaseWeightBoosting):
    ...
    estimator : object, default=None
        ...
        :class:`~xlearn.tree.DecisionTreeRegressor` initialized with
        `max_depth=3`.
    ...
    For a detailed example of utilizing :class:`~xlearn.ensemble.AdaBoostRegressor`
