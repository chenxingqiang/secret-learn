...
class IsolationForest(OutlierMixin, BaseBagging):
    ...
    See Also
    --------
    xlearn.covariance.EllipticEnvelope : An object for detecting outliers in a
        Gaussian distributed dataset.
    xlearn.svm.OneClassSVM : Unsupervised Outlier Detection.
        Estimate the support of a high-dimensional distribution.
        The implementation is based on libsvm.
    xlearn.neighbors.LocalOutlierFactor : Unsupervised Outlier Detection
    ...
    def _compute_chunked_score_samples(self, X):
        ...
        # (defined by xlearn.get_config()['working_memory']) to store
