...
class BaseGradientBoosting(BaseEnsemble, metaclass=ABCMeta):
    ...
    def _get_loss(self, sample_weight):
        """Get loss object from xlearn._loss.loss."""
...
class GradientBoostingClassifier(ClassifierMixin, BaseGradientBoosting):
    ...
    :class:`~xlearn.ensemble.HistGradientBoostingClassifier` is a much faster variant
...
class GradientBoostingRegressor(RegressorMixin, BaseGradientBoosting):
    ...
    :class:`~xlearn.ensemble.HistGradientBoostingRegressor` is a much faster variant
    of this algorithm for intermediate and large datasets (`n_samples >= 10_000`) and
    supports monotonic constraints.
