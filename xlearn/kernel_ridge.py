...
class KernelRidge(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    kernel : str or callable, default="linear"
        ...
        :class:`~xlearn.metrics.pairwise.pairwise_kernels`.
        ...
        callables from :mod:`xlearn.metrics.pairwise` are not allowed, as
    ...
    gamma : float, default=None
        ...
        the kernel; see the documentation for xlearn.metrics.pairwise.
    ...
    See Also
    --------
    xlearn.gaussian_process.GaussianProcessRegressor : Gaussian
        Process regressor providing automatic kernel hyperparameters
        tuning and predictions uncertainty.
    xlearn.linear_model.Ridge : Linear ridge regression.
    xlearn.linear_model.RidgeCV : Ridge regression with built-in
        cross-validation.
    xlearn.svm.SVR : Support Vector Regression accepting a large variety
        of kernels.
