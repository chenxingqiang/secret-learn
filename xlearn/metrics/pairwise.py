...
def nan_euclidean_distances(
    ...
    * John K. Dixon, "Pattern Recognition with Partly Missing Data",
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import nan_euclidean_distances
    >>> nan = float("NaN")
    >>> X = [[0, 1], [1, nan]]
...
def pairwise_distances_argmin_min(
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import pairwise_distances_argmin_min
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def pairwise_distances_argmin(X, Y, *, axis=1, metric="euclidean", metric_kwargs=None):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import pairwise_distances_argmin
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def haversine_distances(X, Y=None):
    ...
    >>> from xlearn.metrics.pairwise import haversine_distances
...
def manhattan_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import manhattan_distances
...
def cosine_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_euclidean_distances(X, Y):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import paired_euclidean_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_manhattan_distances(X, Y):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import paired_manhattan_distances
    >>> import numpy as np
...
def paired_cosine_distances(X, Y):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import paired_cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_distances(X, Y, *, metric="euclidean", **kwds):
    ...
    **kwds : dict
    ...
    See Also
    --------
    xlearn.metrics.pairwise_distances : Computes the distance between every pair of
        samples.

    Examples
    --------
    >>> from xlearn.metrics.pairwise import paired_distances
    >>> X = [[0, 1], [1, 1]]
    >>> Y = [[0, 1], [2, 1]]
...
def linear_kernel(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import linear_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> linear_kernel(X, Y)
    array([[0., 0.],
...
def polynomial_kernel(X, Y=None, degree=3, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import polynomial_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def sigmoid_kernel(X, Y=None, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import sigmoid_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> sigmoid_kernel(X, Y)
    array([[0.76, 0.76],
...
def laplacian_kernel(X, Y=None, gamma=None):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import laplacian_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def cosine_similarity(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import cosine_similarity
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def additive_chi2_kernel(X, Y=None):
    ...
    chi2_kernel : The exponentiated version of the kernel, which is usually
        preferable.
    xlearn.kernel_approximation.AdditiveChi2Sampler : A Fourier approximation
        to this kernel.
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    Examples
    --------
    >>> from xlearn.metrics.pairwise import additive_chi2_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def pairwise_distances_chunked(
    ...
    **kwds,
    ...
    working_memory : float, default=None
        ...
        ``xlearn.get_config()['working_memory']`` is used.
...
def pairwise_distances(
    ...
    **kwds : optional keyword parameters
    ...
    xlearn.metrics.pairwise.paired_distances : Computes the distances between
...
def kernel_metrics():
    ...
    The valid distance metrics, and the function they map to, are:
      ...
      metric            Function
      ===============   ========================================
      'additive_chi2'   xlearn.pairwise.additive_chi2_kernel
      'chi2'            xlearn.pairwise.chi2_kernel
      'linear'          xlearn.pairwise.linear_kernel
      'poly'            xlearn.pairwise.polynomial_kernel
      'polynomial'      xlearn.pairwise.polynomial_kernel
      'rbf'             xlearn.pairwise.rbf_kernel
      'laplacian'       xlearn.pairwise.laplacian_kernel
      'sigmoid'         xlearn.pairwise.sigmoid_kernel
      'cosine'          xlearn.pairwise.cosine_similarity
      ===============   ========================================
...
def pairwise_kernels(
    ...
    metric : str or callable, default="linear"
        ...
        :mod:`xlearn.metrics.pairwise` are not allowed, as they operate on
