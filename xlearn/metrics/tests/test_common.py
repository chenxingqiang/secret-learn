...
from xlearn.exceptions import UndefinedMetricWarning
...
from xlearn.metrics._base import _average_binary_score
from xlearn.metrics.pairwise import (
...
from xlearn.utils.fixes import COO_CONTAINERS, parse_version, sp_version
from xlearn.utils.multiclass import type_of_target
from xlearn.utils.validation import _num_samples, check_random_state
...
def precision_recall_curve_padded_thresholds(*args, **kwargs):
    ...
    func:`xlearn.metrics.precision_recall_curve`
