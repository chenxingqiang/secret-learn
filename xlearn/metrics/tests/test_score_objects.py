...
from xlearn.linear_model import LogisticRegression, Perceptron, Ridge
...
from xlearn.metrics import cluster as cluster_module
from xlearn.metrics._scorer import (
...
from xlearn.model_selection import GridSearchCV, cross_val_score, train_test_split
...
from xlearn.utils.metadata_routing import MetadataRouter, MethodMapping
...
def memmap_data_and_estimators(tmp_path_factory):
    temp_folder = tmp_path_factory.mktemp("xlearn_test_score_objects")
