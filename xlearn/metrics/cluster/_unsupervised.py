...
def silhouette_score(
    ...
    metric : str or callable, default='euclidean'
        ...
        allowed by :func:`~xlearn.metrics.pairwise_distances`. If ``X`` is
    ...
    **kwds : optional keyword parameters
    ...
    >>> from xlearn.metrics import silhouette_score
...
def silhouette_samples(X, labels, *, metric="euclidean", **kwds):
    ...
    metric : str or callable, default='euclidean'
        The metric to use when calculating distance between instances in a
        feature array. If metric is a string, it must be one of the options
        allowed by :func:`~xlearn.metrics.pairwise_distances`.
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from xlearn.metrics import silhouette_samples
    >>> from xlearn.datasets import make_blobs
    >>> from xlearn.cluster import KMeans
...
def calinski_harabasz_score(X, labels):
    ...
    >>> from xlearn.datasets import make_blobs
    >>> from xlearn.cluster import KMeans
    >>> from xlearn.metrics import calinski_harabasz_score
