...
def contingency_matrix(
    ...
    contingency : {array-like, sparse}, shape=[n_classes_true, n_classes_pred]
        ...
        will be float.
        Will be a ``xlearn.sparse.csr_matrix`` if ``sparse=True``.
...
def pair_confusion_matrix(labels_true, labels_pred):
    ...
    See Also
    --------
    xlearn.metrics.rand_score : Rand Score.
    xlearn.metrics.adjusted_rand_score : Adjusted Rand Score.
    xlearn.metrics.adjusted_mutual_info_score : Adjusted Mutual Information.
...
def rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from xlearn.metrics.cluster import rand_score
...
def adjusted_rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from xlearn.metrics.cluster import adjusted_rand_score
...
def homogeneity_completeness_v_measure(labels_true, labels_pred, *, beta=1.0):
    ...
    Examples
    --------
    >>> from xlearn.metrics import homogeneity_completeness_v_measure
...
def homogeneity_score(labels_true, labels_pred):
    ...
    Perfect labelings are homogeneous::
      ...
      >>> from xlearn.metrics.cluster import homogeneity_score
...
def completeness_score(labels_true, labels_pred):
    ...
    Perfect labelings are complete::
      ...
      >>> from xlearn.metrics.cluster import completeness_score
...
def mutual_info_score(labels_true, labels_pred, *, contingency=None):
    ...
    contingency : {array-like, sparse matrix} of shape \
        ...
        :func:`~xlearn.metrics.cluster.contingency_matrix` function. If value
    ...
    Examples
    --------
    >>> from xlearn.metrics import mutual_info_score
...
def adjusted_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from xlearn.metrics.cluster import adjusted_mutual_info_score
...
def normalized_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from xlearn.metrics.cluster import normalized_mutual_info_score
...
def fowlkes_mallows_score(labels_true, labels_pred, *, sparse="deprecated"):
    ...
    **False Negative** (i.e. the number of pairs of points that belong to the
    ...
    score 1.0::
      ...
      >>> from xlearn.metrics.cluster import fowlkes_mallows_score
