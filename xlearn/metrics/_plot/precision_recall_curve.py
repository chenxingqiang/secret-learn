...
class PrecisionRecallDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    :func:`~xlearn.metrics.PrecisionRecallDisplay.from_estimator` or
    :func:`~xlearn.metrics.PrecisionRecallDisplay.from_predictions` to create
    ...
    def plot(
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~xlearn.metrics.PrecisionRecallDisplay`
