...
class RocCurveDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    :func:`~xlearn.metrics.RocCurveDisplay.from_estimator` or
    :func:`~xlearn.metrics.RocCurveDisplay.from_predictions` or
    :func:`~xlearn.metrics.RocCurveDisplay.from_cv_results` to create
    ...
    def plot(
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~xlearn.metrics.RocCurveDisplay`
    ...
    def from_cv_results(
        ...
        *,
        ...
        ----------
        cv_results : dict
            Dictionary as returned by :func:`~xlearn.model_selection.cross_validate`
