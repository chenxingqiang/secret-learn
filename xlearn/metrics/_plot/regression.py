...
class PredictionErrorDisplay:
    ...
    :func:`~xlearn.metrics.PredictionErrorDisplay.from_estimator` or
    ...
    def plot(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~xlearn.metrics.PredictionErrorDisplay`
    ...
    def from_estimator(
        ...
        *,
        ...
        estimator : estimator instance
            Fitted regressor or a fitted :class:`~xlearn.pipeline.Pipeline`
