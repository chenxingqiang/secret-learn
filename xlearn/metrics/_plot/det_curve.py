...
class DetCurveDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    It is recommended to use :func:`~xlearn.metrics.DetCurveDisplay.from_estimator`
    ...
    >>> from xlearn.metrics import det_curve, DetCurveDisplay
    ...
    def from_estimator(
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~xlearn.metrics.DetCurveDisplay`
        ...
        >>> import matplotlib.pyplot as plt
        >>> from xlearn.datasets import make_classification
        >>> from xlearn.metrics import DetCurveDisplay
        >>> from xlearn.model_selection import train_test_split
        >>> from xlearn.svm import SVC
        >>> X, y = make_classification(n_samples=1000, random_state=0)
        >>> X_train, X_test, y_train, y_test = train_test_split(
