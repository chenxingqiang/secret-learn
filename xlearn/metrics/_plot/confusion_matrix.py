...
class ConfusionMatrixDisplay:
    ...
    :func:`~xlearn.metrics.ConfusionMatrixDisplay.from_estimator` or
    :func:`~xlearn.metrics.ConfusionMatrixDisplay.from_predictions` to
    ...
    >>> from xlearn.metrics import confusion_matrix, ConfusionMatrixDisplay
    ...
    def plot(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~xlearn.metrics.ConfusionMatrixDisplay`
            Returns a :class:`~xlearn.metrics.ConfusionMatrixDisplay` instance
