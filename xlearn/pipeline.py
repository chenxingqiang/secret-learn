...
class Pipeline(_BaseComposition):
    ...
    :class:`~xlearn.model_selection.GridSearchCV`, refer to
    ...
    transform_input : list of str, default=None
        ...
        can enable using ``xlearn.set_config(enable_metadata_routing=True)``.
    ...
    Attributes
    ----------
    named_steps : :class:`~xlearn.utils.Bunch`
...
class FeatureUnion(TransformerMixin, _BaseComposition):
    ...
    Attributes
    ----------
    named_transformers : :class:`~xlearn.utils.Bunch`
        Dictionary-like object, with the following attributes.
...
def make_union(
    ...
    *transformers : list of estimators
    ...
    --------
    >>> from xlearn.decomposition import PCA, TruncatedSVD
    >>> from xlearn.pipeline import make_union
