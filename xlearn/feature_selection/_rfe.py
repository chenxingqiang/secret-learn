...
class RFE(SelectorMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    importance_getter : str or callable, default='auto'
        ...
        :class:`~xlearn.compose.TransformedTargetRegressor`  or
        `named_steps.clf.feature_importances_` in case of
        class:`~xlearn.pipeline.Pipeline` with its last step named `clf`.
...
class RFECV(RFE):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~xlearn.model_selection.StratifiedKFold` is used. If the
    ...
    :class:`~xlearn.linear_model.LogisticRegression`, see
    :ref:`sphx_glr_auto_examples_feature_selection_plot_rfe_with_cross_validation.py`.
    """
    ...
    def fit(self, X, y, *, groups=None, **params):
        ...
        groups : array-like of shape (n_samples,) or None, default=None
            ...
            instance (e.g., :class:`~xlearn.model_selection.GroupKFold`).
