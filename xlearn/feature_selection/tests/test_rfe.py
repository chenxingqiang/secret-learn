...
from xlearn.base import BaseEstimator, ClassifierMixin, is_classifier
from xlearn.compose import TransformedTargetRegressor
from xlearn.cross_decomposition import CCA, PLSCanonical, PLSRegression
from xlearn.datasets import load_iris, make_classification, make_friedman1
from xlearn.ensemble import RandomForestClassifier
from xlearn.feature_selection import RFE, RFECV
from xlearn.impute import SimpleImputer
from xlearn.linear_model import LinearRegression, LogisticRegression
from xlearn.metrics import get_scorer, make_scorer, zero_one_loss
from xlearn.model_selection import GroupKFold, cross_val_score
from xlearn.pipeline import make_pipeline
from xlearn.preprocessing import StandardScaler
from xlearn.svm import SVC, SVR, LinearSVR
