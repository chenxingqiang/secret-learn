...
def kneighbors_graph(
    ...
    *,
    ...
    metric : str, default='minkowski'
        ...
        :class:`~xlearn.metrics.pairwise.distance_metrics` for valid metric
        values.
...
def radius_neighbors_graph(
    ...
    *,
    ...
    --------
    >>> X = [[0], [3], [1]]
    >>> from xlearn.neighbors import radius_neighbors_graph
...
class KNeighborsTransformer(
    ...
    Notes
    -----
    For an example of using :class:`~xlearn.neighbors.KNeighborsTransformer`
    in combination with :class:`~xlearn.manifold.TSNE` see
