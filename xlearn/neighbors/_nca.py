...
class NeighborhoodComponentsAnalysis(
    ...
    init : {'auto', 'pca', 'lda', 'identity', 'random'} or ndarray of shape \
        ...
        - `'pca'`
            ...
            (See :class:`~xlearn.decomposition.PCA`)
    ...
    See Also
    --------
    xlearn.discriminant_analysis.LinearDiscriminantAnalysis : Linear
        Discriminant Analysis.
    xlearn.decomposition.PCA : Principal component analysis (PCA).
