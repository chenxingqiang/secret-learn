...
VALID_METRICS = dict(
    ...
    # xlearn.metrics.pairwise doc string
...
def sort_graph_by_row_values(graph, copy=False, warn_when_not_sorted=True):
    ...
    >>> from xlearn.neighbors import sort_graph_by_row_values
    >>> X = csr_matrix(
    ...     [[0., 3., 1.],
    ...      [3., 0., 2.],
    ...      [1., 2., 0.]])
    ...
    if warn_when_not_sorted:
        warnings.warn(
            (
                ...
                " function xlearn.neighbors.sort_graph_by_row_values to sort the input"
...
class NeighborsBase(MultiOutputMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def _check_algorithm_metric(self):
        ...
        if callable(self.metric):
            ...
            raise ValueError(
                ...
                "sorted(xlearn.neighbors.VALID_METRICS['%s']) "
    ...
    def _fit(self, X, y=None):
        ...
        if self.__xlearn_tags__().target_tags.required:
...
class KNeighborsMixin:
    ...
    def _kneighbors_reduce_func(self, dist, start, n_neighbors, return_distance):
        ...
        Callback to :func:`xlearn.metrics.pairwise.pairwise_distances_chunked`
