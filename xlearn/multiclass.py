...
class OneVsRestClassifier(
    ...
    xlearn.multioutput.MultiOutputClassifier : Alternate way of extending an
        estimator for multilabel classification.
    xlearn.preprocessing.MultiLabelBinarizer : Transform iterable of iterables
...
class OneVsOneClassifier(MetaEstimatorMixin, ClassifierMixin, BaseEstimator):
    ...
    def fit(self, X, y, **fit_params):
        ...
        **fit_params : dict
        ...
        pairwise = self.__xlearn_tags__().input_tags.pairwise
