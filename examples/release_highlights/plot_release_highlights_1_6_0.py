...
#
#     with xlearn.config_context(enable_metadata_routing=True):
#         est_gs = GridSearchCV(
#             Pipeline(
#                 (
#                     StandardScaler(),
...
# from the :mod:`xlearn.model_selection` module and the metrics from the
...
#
# - :func:`xlearn.utils.validation.validate_data` is introduced and replaces the
#   previously private `BaseEstimator._validate_data` method. This function extends
#   :func:`~xlearn.utils.validation.check_array` and adds support for remembering
...
#   :func:`~xlearn.utils.estimator_checks.parametrize_with_checks`. See their
