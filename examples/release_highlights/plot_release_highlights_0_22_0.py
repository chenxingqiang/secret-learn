...
# :func:`~xlearn.metrics.pairwise.nan_euclidean_distances`, is used to find the nearest
# neighbors.
#
...
# ----------------------------------------------
# The :func:`~xlearn.metrics.roc_auc_score` function can also be used in multi-class
