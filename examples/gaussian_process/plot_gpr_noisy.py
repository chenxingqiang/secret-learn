...
#
# Now, we will initialize the :class:`~xlearn.gaussian_process.kernels.RBF`
# with a larger `length_scale` initial value and the
# :class:`~xlearn.gaussian_process.kernels.WhiteKernel` with a smaller initial
...
# :class:`~xlearn.gaussian_process.GaussianProcessRegressor` class.
#
