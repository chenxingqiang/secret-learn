...
learned by :class:`~xlearn.discriminant_analysis.LinearDiscriminantAnalysis` (LDA) and
:class:`~xlearn.discriminant_analysis.QuadraticDiscriminantAnalysis` (QDA). The
...
# i.e., :class:`~xlearn.discriminant_analysis.LinearDiscriminantAnalysis` (LDA) and
# :class:`~xlearn.discriminant_analysis.QuadraticDiscriminantAnalysis` (QDA). The
