...
The paths are computed using :func:`~xlearn.linear_model.lasso_path`,
:func:`~xlearn.linear_model.lars_path`, and :func:`~xlearn.linear_model.enet_path`.
...
from xlearn.linear_model import enet_path, lars_path, lasso_path
