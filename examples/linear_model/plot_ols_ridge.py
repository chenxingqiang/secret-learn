...
1. Ordinary Least Squares:
   ...
   :class:`~xlearn.linear_model.LinearRegression`, on a single feature of
...
2. Ordinary Least Squares and Ridge Regression Variance:
   ...
   regression, :class:`~xlearn.linear_model.Ridge`, reduces this variance
...
#
# Techniques like :class:`~xlearn.linear_model.Ridge` or
# :class:`~xlearn.linear_model.Lasso` (which applies an L1 penalty) are both
