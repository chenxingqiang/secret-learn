...
from secretlearn.secret_sharing.linear_models.orthogonal_matching_pursuit_cv import SSOrthogonalMatchingPursuitCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SSOrthogonalMatchingPursuitCV Usage Example")
    print("="*70)
