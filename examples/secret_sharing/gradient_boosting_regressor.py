...
from secretlearn.secret_sharing.ensemble.gradient_boosting_regressor import SSGradientBoostingRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SSGradientBoostingRegressor Usage Example")
    print("="*70)
