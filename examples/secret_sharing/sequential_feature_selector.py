...
from secretlearn.secret_sharing.feature_selection.sequential_feature_selector import SSSequentialFeatureSelector


def main():
    """Main example function"""
    print("="*70)
    print(f" SSSequentialFeatureSelector Usage Example")
    print("="*70)
