...
from secretlearn.secret_sharing.neighbors.neighborhood_components_analysis import SSNeighborhoodComponentsAnalysis
...
def main():
    ...
    model = SSNeighborhoodComponentsAnalysis(spu)
    model.fit(fed_X)
