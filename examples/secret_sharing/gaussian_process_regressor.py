...
from secretlearn.secret_sharing.gaussian_process.gaussian_process_regressor import SSGaussianProcessRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SSGaussianProcessRegressor Usage Example")
    print("="*70)
