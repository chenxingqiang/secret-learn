...
from secretlearn.secret_sharing.discriminant_analysis.linear_discriminant_analysis import SSLinearDiscriminantAnalysis


def main():
    """Main example function"""
    print("="*70)
    print(f" SSLinearDiscriminantAnalysis Usage Example")
    print("="*70)
