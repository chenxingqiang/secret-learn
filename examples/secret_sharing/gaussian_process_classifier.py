...
from secretlearn.secret_sharing.gaussian_process.gaussian_process_classifier import SSGaussianProcessClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" SSGaussianProcessClassifier Usage Example")
    print("="*70)
