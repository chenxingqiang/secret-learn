...
:class:`~xlearn.ensemble.HistGradientBoostingRegressor` on the Bike Sharing
Demand dataset.
...
# step in a convenience tool such as `xlearn.datasets.fetch_openml`.
#
...
from xlearn.datasets import fetch_file
...
# :class:`~xlearn.model_selection.train_test_split`) with a proper time
# series evaluation strategy using
# :class:`~xlearn.model_selection.TimeSeriesSplit`. We observed that the
# model trained using :class:`~xlearn.model_selection.train_test_split`,
