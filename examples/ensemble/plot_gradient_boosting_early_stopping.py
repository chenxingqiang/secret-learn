...
# -----------------------------
# Two :class:`~xlearn.ensemble.GradientBoostingRegressor` models are trained:
...
# Error Calculation
# -----------------
# The code calculates the :func:`~xlearn.metrics.mean_squared_error` for both
...
# Summary
# -------
# In our example with the :class:`~xlearn.ensemble.GradientBoostingRegressor`
