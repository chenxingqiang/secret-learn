...
"""
Usage Example for FLMultiTaskElasticNetCV
...
from secretlearn.FL.linear_models.multi_task_elastic_net_cv import FLMultiTaskElasticNetCV


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMultiTaskElasticNetCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLMultiTaskElasticNetCV...")
    ...
    model = FLMultiTaskElasticNetCV(devices)
