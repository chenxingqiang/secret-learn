...
from secretlearn.FL.naive_bayes.complement_nb import FLComplementNB


def main():
    """Main example function"""
    print("="*70)
    print(f" FLComplementNB Usage Example")
    print("="*70)
