...
from secretlearn.FL.linear_models.elastic_net_cv import FLElasticNetCV


def main():
    """Main example function"""
    print("="*70)
    print(f" FLElasticNetCV Usage Example")
    print("="*70)
