...
from secretlearn.FL.naive_bayes.categorical_nb import FLCategoricalNB


def main():
    """Main example function"""
    print("="*70)
    print(f" FLCategoricalNB Usage Example")
    print("="*70)
