...
from secretlearn.FL.ensemble.adaboost_classifier import FLAdaBoostClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLAdaBoostClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLAdaBoostClassifier...")
    ...
    model = FLAdaBoostClassifier(devices)
