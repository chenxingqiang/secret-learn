...
"""
Usage Example for FLBernoulliNB
...
from secretlearn.FL.naive_bayes.bernoulli_nb import FLBernoulliNB


def main():
    """Main example function"""
    print("="*70)
    print(f" FLBernoulliNB Usage Example")
    print("="*70)
