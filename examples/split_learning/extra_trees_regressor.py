...
"""
Usage Example for SLExtraTreesRegressor
...
from secretlearn.split_learning.ensemble.extra_trees_regressor import SLExtraTreesRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLExtraTreesRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLExtraTreesRegressor...")
    ...
    model = SLExtraTreesRegressor(devices)
