...
"""
Usage Example for SLSequentialFeatureSelector
...
from secretlearn.split_learning.feature_selection.sequential_feature_selector import SLSequentialFeatureSelector


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSequentialFeatureSelector Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLSequentialFeatureSelector...")
    ...
    model = SLSequentialFeatureSelector(devices)
