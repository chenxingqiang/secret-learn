...
from secretlearn.split_learning.clustering.mean_shift import SLMeanShift


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMeanShift Usage Example")
    print("="*70)
