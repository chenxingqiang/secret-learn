...
"""
Usage Example for SLComplementNB
...
from secretlearn.split_learning.naive_bayes.complement_nb import SLComplementNB


def main():
    """Main example function"""
    print("="*70)
    print(f" SLComplementNB Usage Example")
    print("="*70)
