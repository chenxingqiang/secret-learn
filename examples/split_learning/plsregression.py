...
"""
Usage Example for SLPLSRegression
...
from secretlearn.split_learning.cross_decomposition.plsregression import SLPLSRegression


def main():
    """Main example function"""
    print("="*70)
    print(f" SLPLSRegression Usage Example")
    print("="*70)
