...
"""
Usage Example for SLKBinsDiscretizer
...
from secretlearn.split_learning.preprocessing.k_bins_discretizer import SLKBinsDiscretizer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLKBinsDiscretizer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLKBinsDiscretizer...")
    ...
    model = SLKBinsDiscretizer(devices)
