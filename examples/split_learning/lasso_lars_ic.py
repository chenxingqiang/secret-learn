...
"""
Usage Example for SLLassoLarsIC
...
from secretlearn.split_learning.linear_models.lasso_lars_ic import SLLassoLarsIC


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLassoLarsIC Usage Example")
    print("="*70)
