...
"""
Usage Example for SLGaussianProcessRegressor
...
from secretlearn.split_learning.gaussian_process.gaussian_process_regressor import SLGaussianProcessRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLGaussianProcessRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLGaussianProcessRegressor...")
    ...
    model = SLGaussianProcessRegressor(devices)
