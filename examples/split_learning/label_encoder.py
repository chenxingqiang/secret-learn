...
"""
Usage Example for SLLabelEncoder
...
from secretlearn.split_learning.preprocessing.label_encoder import SLLabelEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLabelEncoder Usage Example")
    print("="*70)
