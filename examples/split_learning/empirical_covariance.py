...
"""
Usage Example for SLEmpiricalCovariance
...
from secretlearn.split_learning.covariance.empirical_covariance import SLEmpiricalCovariance


def main():
    """Main example function"""
    print("="*70)
    print(f" SLEmpiricalCovariance Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLEmpiricalCovariance...")
    ...
    model = SLEmpiricalCovariance(devices)
