...
"""
Usage Example for SLKernelRidge
...
from secretlearn.split_learning.kernel_ridge.kernel_ridge import SLKernelRidge


def main():
    """Main example function"""
    print("="*70)
    print(f" SLKernelRidge Usage Example")
    print("="*70)
