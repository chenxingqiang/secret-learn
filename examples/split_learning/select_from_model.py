...
"""
Usage Example for SLSelectFromModel
...
from secretlearn.split_learning.feature_selection.select_from_model import SLSelectFromModel


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSelectFromModel Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLSelectFromModel...")
    ...
    model = SLSelectFromModel(devices)
