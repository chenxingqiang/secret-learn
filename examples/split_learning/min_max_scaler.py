...
"""
Usage Example for SLMinMaxScaler
...
from secretlearn.split_learning.preprocessing.min_max_scaler import SLMinMaxScaler


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMinMaxScaler Usage Example")
    print("="*70)
