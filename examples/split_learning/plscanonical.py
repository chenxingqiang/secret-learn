...
"""
Usage Example for SLPLSCanonical
...
from secretlearn.split_learning.cross_decomposition.plscanonical import SLPLSCanonical


def main():
    """Main example function"""
    print("="*70)
    print(f" SLPLSCanonical Usage Example")
    print("="*70)
