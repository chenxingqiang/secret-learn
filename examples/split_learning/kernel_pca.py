...
from secretlearn.split_learning.decomposition.kernel_pca import SLKernelPCA


def main():
    """Main example function"""
    print("="*70)
    print(f" SLKernelPCA Usage Example")
    print("="*70)
