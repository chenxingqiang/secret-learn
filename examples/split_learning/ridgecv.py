...
from secretlearn.split_learning.linear_models.ridgecv import SLRidgeCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLRidgeCV Usage Example")
    print("="*70)
