...
"""
Usage Example for SLCategoricalNB
...
from secretlearn.split_learning.naive_bayes.categorical_nb import SLCategoricalNB


def main():
    """Main example function"""
    print("="*70)
    print(f" SLCategoricalNB Usage Example")
    print("="*70)
