...
from secretlearn.split_learning.preprocessing.binarizer import SLBinarizer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLBinarizer Usage Example")
    print("="*70)
