...
"""
Usage Example for SLMiniBatchNMF
...
from secretlearn.split_learning.decomposition.mini_batch_nmf import SLMiniBatchNMF


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMiniBatchNMF Usage Example")
    print("="*70)
