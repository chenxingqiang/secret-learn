...
"""
Usage Example for SLNearestCentroid
...
from secretlearn.split_learning.neighbors.nearest_centroid import SLNearestCentroid


def main():
    """Main example function"""
    print("="*70)
    print(f" SLNearestCentroid Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLNearestCentroid...")
    ...
    model = SLNearestCentroid(devices)
