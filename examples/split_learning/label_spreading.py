...
"""
Usage Example for SLLabelSpreading
...
from secretlearn.split_learning.semi_supervised.label_spreading import SLLabelSpreading


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLabelSpreading Usage Example")
    print("="*70)
    ...
    model = SLLabelSpreading(devices)
