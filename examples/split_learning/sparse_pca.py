...
from secretlearn.split_learning.decomposition.sparse_pca import SLSparsePCA


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSparsePCA Usage Example")
    print("="*70)
