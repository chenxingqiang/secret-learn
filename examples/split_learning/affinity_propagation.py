...
"""
Usage Example for SLAffinityPropagation
...
from secretlearn.split_learning.clustering.affinity_propagation import SLAffinityPropagation


def main():
    """Main example function"""
    print("="*70)
    print(f" SLAffinityPropagation Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLAffinityPropagation...")
    ...
    model = SLAffinityPropagation(devices)
