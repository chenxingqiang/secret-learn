...
"""
Usage Example for SLRobustScaler
...
from secretlearn.split_learning.preprocessing.robust_scaler import SLRobustScaler


def main():
    """Main example function"""
    print("="*70)
    print(f" SLRobustScaler Usage Example")
    print("="*70)
