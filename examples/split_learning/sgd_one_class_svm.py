...
"""
Usage Example for SLSGDOneClassSVM
...
from secretlearn.split_learning.linear_models.sgd_one_class_svm import SLSGDOneClassSVM


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSGDOneClassSVM Usage Example")
    print("="*70)
    ...
    model = SLSGDOneClassSVM(devices)
    model.fit(fed_X)
