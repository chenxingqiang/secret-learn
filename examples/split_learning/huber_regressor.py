...
"""
Usage Example for SLHuberRegressor
...
from secretlearn.split_learning.linear_models.huber_regressor import SLHuberRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLHuberRegressor Usage Example")
    print("="*70)
    ...
    model = SLHuberRegressor(devices)
