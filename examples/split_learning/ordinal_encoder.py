...
"""
Usage Example for SLOrdinalEncoder
...
from secretlearn.split_learning.preprocessing.ordinal_encoder import SLOrdinalEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" SLOrdinalEncoder Usage Example")
    print("="*70)
    ...
    model = SLOrdinalEncoder(devices)
    model.fit(fed_X)
