...
"""
Usage Example for SLNormalizer
...
from secretlearn.split_learning.preprocessing.normalizer import SLNormalizer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLNormalizer Usage Example")
    print("="*70)
