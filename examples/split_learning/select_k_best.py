...
"""
Usage Example for SLSelectKBest
...
from secretlearn.split_learning.feature_selection.select_k_best import SLSelectKBest


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSelectKBest Usage Example")
    print("="*70)
