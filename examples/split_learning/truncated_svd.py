...
"""
Usage Example for SLTruncatedSVD
...
from secretlearn.split_learning.decomposition.truncated_svd import SLTruncatedSVD


def main():
    """Main example function"""
    print("="*70)
    print(f" SLTruncatedSVD Usage Example")
    print("="*70)
