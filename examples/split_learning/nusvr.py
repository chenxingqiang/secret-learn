...
from secretlearn.split_learning.svm.nusvr import SLNuSVR


def main():
    """Main example function"""
    print("="*70)
    print(f" SLNuSVR Usage Example")
    print("="*70)
