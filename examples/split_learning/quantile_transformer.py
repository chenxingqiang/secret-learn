...
"""
Usage Example for SLQuantileTransformer
...
from secretlearn.split_learning.preprocessing.quantile_transformer import SLQuantileTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLQuantileTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLQuantileTransformer...")
    ...
    model = SLQuantileTransformer(devices)
