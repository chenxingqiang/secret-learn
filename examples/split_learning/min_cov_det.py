...
from secretlearn.split_learning.covariance.min_cov_det import SLMinCovDet


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMinCovDet Usage Example")
    print("="*70)
