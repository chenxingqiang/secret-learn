...
from secretlearn.split_learning.feature_selection.rfecv import SLRFECV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLRFECV Usage Example")
    print("="*70)
