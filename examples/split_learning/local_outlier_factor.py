...
"""
Usage Example for SLLocalOutlierFactor
...
from secretlearn.split_learning.neighbors.local_outlier_factor import SLLocalOutlierFactor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLocalOutlierFactor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLLocalOutlierFactor...")
    ...
    model = SLLocalOutlierFactor(devices)
    model.fit(fed_X)
