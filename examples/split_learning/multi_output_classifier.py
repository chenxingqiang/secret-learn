...
"""
Usage Example for SLMultiOutputClassifier
...
from secretlearn.split_learning.multioutput.multi_output_classifier import SLMultiOutputClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMultiOutputClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLMultiOutputClassifier...")
    ...
    model = SLMultiOutputClassifier(devices)
