...
"""
Usage Example for SLBisectingKMeans
...
from secretlearn.split_learning.clustering.bisecting_kmeans import SLBisectingKMeans


def main():
    """Main example function"""
    print("="*70)
    print(f" SLBisectingKMeans Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLBisectingKMeans...")
    ...
    model = SLBisectingKMeans(devices)
    model.fit(fed_X)
