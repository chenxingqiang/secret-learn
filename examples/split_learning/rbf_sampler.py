...
"""
Usage Example for SLRBFSampler
...
from secretlearn.split_learning.kernel_approximation.rbf_sampler import SLRBFSampler


def main():
    """Main example function"""
    print("="*70)
    print(f" SLRBFSampler Usage Example")
    print("="*70)
