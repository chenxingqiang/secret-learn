...
"""
Usage Example for SLPolynomialFeatures
...
from secretlearn.split_learning.preprocessing.polynomial_features import SLPolynomialFeatures


def main():
    """Main example function"""
    print("="*70)
    print(f" SLPolynomialFeatures Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLPolynomialFeatures...")
    ...
    model = SLPolynomialFeatures(devices)
