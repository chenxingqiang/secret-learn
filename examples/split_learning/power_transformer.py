...
"""
Usage Example for SLPowerTransformer
...
from secretlearn.split_learning.preprocessing.power_transformer import SLPowerTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLPowerTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLPowerTransformer...")
    ...
    model = SLPowerTransformer(devices)
