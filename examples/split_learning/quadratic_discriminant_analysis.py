...
"""
Usage Example for SLQuadraticDiscriminantAnalysis
...
from secretlearn.split_learning.discriminant_analysis.quadratic_discriminant_analysis import SLQuadraticDiscriminantAnalysis


def main():
    """Main example function"""
    print("="*70)
    print(f" SLQuadraticDiscriminantAnalysis Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLQuadraticDiscriminantAnalysis...")
    ...
    model = SLQuadraticDiscriminantAnalysis(devices)
