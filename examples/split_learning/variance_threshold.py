...
"""
Usage Example for SLVarianceThreshold
...
from secretlearn.split_learning.feature_selection.variance_threshold import SLVarianceThreshold


def main():
    """Main example function"""
    print("="*70)
    print(f" SLVarianceThreshold Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLVarianceThreshold...")
    ...
    model = SLVarianceThreshold(devices)
