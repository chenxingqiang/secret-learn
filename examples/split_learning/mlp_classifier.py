...
"""
Usage Example for SLMLPClassifier
...
from secretlearn.split_learning.neural_network.mlp_classifier import SLMLPClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMLPClassifier Usage Example")
    print("="*70)
