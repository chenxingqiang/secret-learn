...
"""
Usage Example for SLOrthogonalMatchingPursuitCV
...
from secretlearn.split_learning.linear_models.orthogonal_matching_pursuit_cv import SLOrthogonalMatchingPursuitCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLOrthogonalMatchingPursuitCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLOrthogonalMatchingPursuitCV...")
    ...
    model = SLOrthogonalMatchingPursuitCV(devices)
