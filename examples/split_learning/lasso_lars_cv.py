...
"""
Usage Example for SLLassoLarsCV
...
from secretlearn.split_learning.linear_models.lasso_lars_cv import SLLassoLarsCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLassoLarsCV Usage Example")
    print("="*70)
