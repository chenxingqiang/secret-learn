...
from secretlearn.split_learning.linear_models.lars_cv import SLLarsCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLarsCV Usage Example")
    print("="*70)
