...
from secretlearn.split_learning.decomposition.fast_ica import SLFastICA


def main():
    """Main example function"""
    print("="*70)
    print(f" SLFastICA Usage Example")
    print("="*70)
