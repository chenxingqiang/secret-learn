...
"""
Usage Example for SLMiniBatchSparsePCA
...
from secretlearn.split_learning.decomposition.mini_batch_sparse_pca import SLMiniBatchSparsePCA


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMiniBatchSparsePCA Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLMiniBatchSparsePCA...")
    ...
    model = SLMiniBatchSparsePCA(devices)
    model.fit(fed_X)
