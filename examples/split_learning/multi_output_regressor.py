...
"""
Usage Example for SLMultiOutputRegressor
...
from secretlearn.split_learning.multioutput.multi_output_regressor import SLMultiOutputRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMultiOutputRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLMultiOutputRegressor...")
    ...
    model = SLMultiOutputRegressor(devices)
