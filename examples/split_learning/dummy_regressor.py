...
"""
Usage Example for SLDummyRegressor
...
from secretlearn.split_learning.dummy.dummy_regressor import SLDummyRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLDummyRegressor Usage Example")
    print("="*70)
    ...
    model = SLDummyRegressor(devices)
