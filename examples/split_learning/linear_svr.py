...
from secretlearn.split_learning.svm.linear_svr import SLLinearSVR


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLinearSVR Usage Example")
    print("="*70)
