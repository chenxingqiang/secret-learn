...
from secretlearn.split_learning.clustering.hdbscan import SLHDBSCAN


def main():
    """Main example function"""
    print("="*70)
    print(f" SLHDBSCAN Usage Example")
    print("="*70)
