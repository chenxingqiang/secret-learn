...
"""
Usage Example for SLLinearDiscriminantAnalysis
...
from secretlearn.split_learning.discriminant_analysis.linear_discriminant_analysis import SLLinearDiscriminantAnalysis


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLinearDiscriminantAnalysis Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLLinearDiscriminantAnalysis...")
    ...
    model = SLLinearDiscriminantAnalysis(devices)
