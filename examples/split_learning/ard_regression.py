...
"""
Usage Example for SLARDRegression
...
from secretlearn.split_learning.linear_models.ard_regression import SLARDRegression


def main():
    """Main example function"""
    print("="*70)
    print(f" SLARDRegression Usage Example")
    print("="*70)
