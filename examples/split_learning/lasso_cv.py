...
from secretlearn.split_learning.linear_models.lasso_cv import SLLassoCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLassoCV Usage Example")
    print("="*70)
