...
from secretlearn.split_learning.clustering.optics import SLOPTICS


def main():
    """Main example function"""
    print("="*70)
    print(f" SLOPTICS Usage Example")
    print("="*70)
