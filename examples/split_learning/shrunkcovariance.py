...
"""
Usage Example for SLShrunkCovariance
...
from secretlearn.split_learning.covariance.shrunkcovariance import SLShrunkCovariance


def main():
    """Main example function"""
    print("="*70)
    print(f" SLShrunkCovariance Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLShrunkCovariance...")
    ...
    model = SLShrunkCovariance(devices)
    model.fit(fed_X)
