...
"""
Usage Example for SLFactorAnalysis
...
from secretlearn.split_learning.decomposition.factor_analysis import SLFactorAnalysis


def main():
    """Main example function"""
    print("="*70)
    print(f" SLFactorAnalysis Usage Example")
    print("="*70)
    ...
    model = SLFactorAnalysis(devices)
