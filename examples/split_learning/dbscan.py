...
from secretlearn.split_learning.clustering.dbscan import SLDBSCAN


def main():
    """Main example function"""
    print("="*70)
    print(f" SLDBSCAN Usage Example")
    print("="*70)
