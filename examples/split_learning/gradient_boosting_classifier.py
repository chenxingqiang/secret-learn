...
"""
Usage Example for SLGradientBoostingClassifier
...
def main():
    ...
    print("="*70)
    print(f" SLGradientBoostingClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLGradientBoostingClassifier...")
    ...
    model = SLGradientBoostingClassifier(devices)
