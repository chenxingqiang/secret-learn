...
"""
Usage Example for SLMLPRegressor
...
from secretlearn.split_learning.neural_network.mlp_regressor import SLMLPRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMLPRegressor Usage Example")
    print("="*70)
