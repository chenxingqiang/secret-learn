...
"""
Usage Example for SLGradientBoostingRegressor
...
from secretlearn.split_learning.ensemble.gradient_boosting_regressor import SLGradientBoostingRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLGradientBoostingRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLGradientBoostingRegressor...")
    ...
    model = SLGradientBoostingRegressor(devices)
