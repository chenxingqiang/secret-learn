...
"""
Usage Example for SLGraphicalLassoCV
...
from secretlearn.split_learning.covariance.graphical_lasso_cv import SLGraphicalLassoCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLGraphicalLassoCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLGraphicalLassoCV...")
    ...
    model = SLGraphicalLassoCV(devices)
    model.fit(fed_X)
