...
"""
Usage Example for SLLabelPropagation
...
from secretlearn.split_learning.semi_supervised.label_propagation import SLLabelPropagation


def main():
    """Main example function"""
    print("="*70)
    print(f" SLLabelPropagation Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLLabelPropagation...")
    ...
    model = SLLabelPropagation(devices)
