...
from secretlearn.split_learning.naive_bayes.bernoulli_nb import SLBernoulliNB


def main():
    """Main example function"""
    print("="*70)
    print(f" SLBernoulliNB Usage Example")
    print("="*70)
