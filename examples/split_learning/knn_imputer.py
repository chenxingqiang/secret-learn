...
"""
Usage Example for SLKNNImputer
...
from secretlearn.split_learning.impute.knn_imputer import SLKNNImputer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLKNNImputer Usage Example")
    print("="*70)
