...
"""
Usage Example for SLMultiTaskElasticNetCV
...
from secretlearn.split_learning.linear_models.multi_task_elastic_net_cv import SLMultiTaskElasticNetCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMultiTaskElasticNetCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLMultiTaskElasticNetCV...")
    ...
    model = SLMultiTaskElasticNetCV(devices)
