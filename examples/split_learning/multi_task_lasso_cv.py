...
"""
Usage Example for SLMultiTaskLassoCV
...
from secretlearn.split_learning.linear_models.multi_task_lasso_cv import SLMultiTaskLassoCV


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMultiTaskLassoCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLMultiTaskLassoCV...")
    ...
    model = SLMultiTaskLassoCV(devices)
