...
"""
Usage Example for SLBernoulliRBM
...
from secretlearn.split_learning.neural_network.bernoulli_rbm import SLBernoulliRBM


def main():
    """Main example function"""
    print("="*70)
    print(f" SLBernoulliRBM Usage Example")
    print("="*70)
