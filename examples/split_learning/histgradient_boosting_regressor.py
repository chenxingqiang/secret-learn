...
"""
Usage Example for SLHistGradientBoostingRegressor
...
def main():
    ...
    print("="*70)
    print(f" SLHistGradientBoostingRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLHistGradientBoostingRegressor...")
    ...
    model = SLHistGradientBoostingRegressor(devices)
