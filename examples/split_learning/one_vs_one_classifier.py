...
"""
Usage Example for SLOneVsOneClassifier
...
from secretlearn.split_learning.multiclass.one_vs_one_classifier import SLOneVsOneClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" SLOneVsOneClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLOneVsOneClassifier...")
    ...
    model = SLOneVsOneClassifier(devices)
