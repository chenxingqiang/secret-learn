...
python examples/split_learning/distributed/bob_remote.py --alice_addr <YOUR_LOCAL_IP>:9497
```
...
```bash
python examples/split_learning/distributed/alice_local.py --bob_addr 47.80.8.23:9498
```
