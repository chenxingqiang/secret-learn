...
"""
Usage Example for SLMaxAbsScaler
...
from secretlearn.split_learning.preprocessing.max_abs_scaler import SLMaxAbsScaler


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMaxAbsScaler Usage Example")
    print("="*70)
