...
"""
Usage Example for SLPerceptron
...
from secretlearn.split_learning.linear_models.perceptron import SLPerceptron


def main():
    """Main example function"""
    print("="*70)
    print(f" SLPerceptron Usage Example")
    print("="*70)
