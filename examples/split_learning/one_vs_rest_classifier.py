...
"""
Usage Example for SLOneVsRestClassifier
...
from secretlearn.split_learning.multiclass.one_vs_rest_classifier import SLOneVsRestClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" SLOneVsRestClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLOneVsRestClassifier...")
    ...
    model = SLOneVsRestClassifier(devices)
