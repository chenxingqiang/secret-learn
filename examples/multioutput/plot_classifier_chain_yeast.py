...
==================================================
This example shows how to use :class:`~xlearn.multioutput.ClassifierChain` to solve
...
:class:`~xlearn.multioutput.ClassifierChain` is the meta-estimator (i.e. an estimator
...
# Fit models
# ----------
# We fit :class:`~xlearn.linear_model.LogisticRegression` wrapped by
# :class:`~xlearn.multiclass.OneVsRestClassifier` and ensemble of multiple
# :class:`~xlearn.multioutput.ClassifierChain`.
#
# LogisticRegression wrapped by OneVsRestClassifier
# **************************************************
# Since by default :class:`~xlearn.linear_model.LogisticRegression` can't
...
#
# - Independent model wrapped by :class:`~xlearn.multiclass.OneVsRestClassifier`
...
#   between the labels.
# - :class:`~xlearn.multioutput.ClassifierChain` takes advantage of correlation
