...
This example showcases some use cases of :class:`~xlearn.frozen.FrozenEstimator`.

:class:`~xlearn.frozen.FrozenEstimator` is a utility class that allows to freeze a
fitted estimator. This is useful, for instance, when we want to pass a fitted estimator
to a meta-estimator, such as :class:`~xlearn.model_selection.FixedThresholdClassifier`
...
# using :class:`~xlearn.model_selection.FixedThresholdClassifier` and wrapping the
# classifier with :class:`~xlearn.frozen.FrozenEstimator`.
...
from xlearn.model_selection import FixedThresholdClassifier, train_test_split
...
# :class:`~xlearn.frozen.FrozenEstimator` and passing it to
# :class:`~xlearn.model_selection.FixedThresholdClassifier`.
...
# :class:`~xlearn.model_selection.FixedThresholdClassifier` does not refit the
...
# --------------------------------------
# You can use :class:`~xlearn.frozen.FrozenEstimator` to calibrate a pre-fitted
# classifier using :class:`~xlearn.calibration.CalibratedClassifierCV`.
