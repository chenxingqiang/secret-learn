...
:mod:`xlearn.decomposition` (see the documentation chapter
:ref:`decompositions`).
"""
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# Mini-batch sparse PCA (:class:`~xlearn.decomposition.MiniBatchSparsePCA`)
...
# :class:`~xlearn.decomposition.SparsePCA`.
...
# ^^^^^^^^^^^^^^^^^^^
#
# By default, :class:`~xlearn.decomposition.MiniBatchDictionaryLearning`
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# :class:`xlearn.cluster.MiniBatchKMeans` is computationally efficient and
# implements on-line learning with a
# :meth:`~xlearn.cluster.MiniBatchKMeans.partial_fit` method. That is
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# :class:`~xlearn.decomposition.FactorAnalysis` is similar to
# :class:`~xlearn.decomposition.PCA` but has the advantage of modelling the
...
#
# :class:`~xlearn.decomposition.MiniBatchDictionaryLearning` implements a
...
# :class:`~xlearn.decomposition.MiniBatchDictionaryLearning` estimator on all
