...
:func:`~xlearn.inspection.permutation_importance` of the features to a trained
:class:`~xlearn.ensemble.RandomForestClassifier` using the
...
# %%
# We then train a :class:`~xlearn.ensemble.RandomForestClassifier` on the
