...
"""
Usage Example for SSHistGradientBoostingRegressor

Usage:
    Terminal 1: python histgradient_boosting_regressor.py --party bob
    Terminal 2: python histgradient_boosting_regressor.py --party alice

This example demonstrates how to use the privacy-preserving HistgradientBoostingRegressor
...
from secretlearn.SS.ensemble.histgradient_boosting_regressor import SSHistGradientBoostingRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSHistGradientBoostingRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSHistGradientBoostingRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSHistGradientBoostingRegressor...")
    ...
    model = SSHistGradientBoostingRegressor(spu)
