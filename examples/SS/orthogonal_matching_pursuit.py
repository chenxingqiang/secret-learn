...
"""
Usage Example for SSOrthogonalMatchingPursuit

Usage:
    Terminal 1: python orthogonal_matching_pursuit.py --party bob
    Terminal 2: python orthogonal_matching_pursuit.py --party alice

This example demonstrates how to use the privacy-preserving OrthogonalMatchingPursuit
...
from secretlearn.SS.linear_models.orthogonal_matching_pursuit import SSOrthogonalMatchingPursuit


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOrthogonalMatchingPursuit')
...
def main():
    ...
    print("="*70)
    print(f" SSOrthogonalMatchingPursuit - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSOrthogonalMatchingPursuit...")
    ...
    model = FLOrthogonalMatchingPursuit(devices)
