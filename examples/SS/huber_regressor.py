...
"""
Usage Example for SSHuberRegressor

Usage:
    Terminal 1: python huber_regressor.py --party bob
    Terminal 2: python huber_regressor.py --party alice

This example demonstrates how to use the privacy-preserving HuberRegressor
...
from secretlearn.SS.linear_models.huber_regressor import SSHuberRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSHuberRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSHuberRegressor - Party: {party_name.upper()}")
    print("="*70)
