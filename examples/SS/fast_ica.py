...
"""
Usage Example for SSFastIca

Usage:
    Terminal 1: python fast_ica.py --party bob
    Terminal 2: python fast_ica.py --party alice
...
from secretlearn.SS.decomposition.fast_ica import SSFastIca


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSFastIca')
...
def main():
    ...
    print("="*70)
    print(f" SSFastIca - Party: {party_name.upper()}")
    print("="*70)
