...
"""
Usage Example for SSSgdClassifier

Usage:
    Terminal 1: python sgd_classifier.py --party bob
    Terminal 2: python sgd_classifier.py --party alice

This example demonstrates how to use the privacy-preserving SgdClassifier
...
from secretlearn.SS.linear_models.sgd_classifier import SSSgdClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSgdClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSSgdClassifier - Party: {party_name.upper()}")
    print("="*70)
