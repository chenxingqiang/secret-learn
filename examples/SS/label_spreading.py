...
"""
Usage Example for SSLabelSpreading

Usage:
    Terminal 1: python label_spreading.py --party bob
    Terminal 2: python label_spreading.py --party alice

This example demonstrates how to use the privacy-preserving LabelSpreading
...
from secretlearn.SS.semi_supervised.label_spreading import SSLabelSpreading


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLabelSpreading')
...
def main():
    ...
    print("="*70)
    print(f" SSLabelSpreading - Party: {party_name.upper()}")
    print("="*70)
