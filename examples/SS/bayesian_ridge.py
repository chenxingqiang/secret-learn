...
"""
Usage Example for SSBayesianRidge

Usage:
    Terminal 1: python bayesian_ridge.py --party bob
    Terminal 2: python bayesian_ridge.py --party alice

This example demonstrates how to use the privacy-preserving BayesianRidge
...
from secretlearn.SS.linear_models.bayesian_ridge import SSBayesianRidge


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBayesianRidge')
...
def main():
    ...
    print("="*70)
    print(f" SSBayesianRidge - Party: {party_name.upper()}")
    print("="*70)
