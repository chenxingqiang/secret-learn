...
"""
Usage Example for SSRidgecv

Usage:
    Terminal 1: python ridgecv.py --party bob
    Terminal 2: python ridgecv.py --party alice
...
from secretlearn.SS.linear_models.ridgecv import SSRidgecv


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRidgecv')
...
def main():
    ...
    print("="*70)
    print(f" SSRidgecv - Party: {party_name.upper()}")
    print("="*70)
