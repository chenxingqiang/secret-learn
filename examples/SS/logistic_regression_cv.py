...
"""
Usage Example for SSLogisticRegressionCV

Usage:
    Terminal 1: python logistic_regression_cv.py --party bob
    Terminal 2: python logistic_regression_cv.py --party alice

This example demonstrates how to use the privacy-preserving LogisticRegressionCv
...
from secretlearn.SS.linear_models.logistic_regression_cv import SSLogisticRegressionCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLogisticRegressionCV')
...
def main():
    ...
    print("="*70)
    print(f" SSLogisticRegressionCV - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSLogisticRegressionCV...")
    ...
    model = SSLogisticRegressionCV(spu)
