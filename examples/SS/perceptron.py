...
"""
Usage Example for SSPerceptron

Usage:
    Terminal 1: python perceptron.py --party bob
    Terminal 2: python perceptron.py --party alice

This example demonstrates how to use the privacy-preserving Perceptron
...
from secretlearn.SS.linear_models.perceptron import SSPerceptron


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPerceptron')
...
def main():
    ...
    print("="*70)
    print(f" SSPerceptron - Party: {party_name.upper()}")
    print("="*70)
