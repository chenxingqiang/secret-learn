...
"""
Usage Example for SSTruncatedSvd

Usage:
    Terminal 1: python truncated_svd.py --party bob
    Terminal 2: python truncated_svd.py --party alice
...
from secretlearn.SS.decomposition.truncated_svd import SSTruncatedSvd


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSTruncatedSvd')
...
def main():
    ...
    print("="*70)
    print(f" SSTruncatedSvd - Party: {party_name.upper()}")
    print("="*70)
