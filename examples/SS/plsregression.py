...
"""
Usage Example for SSPLSRegression

Usage:
    Terminal 1: python plsregression.py --party bob
    Terminal 2: python plsregression.py --party alice
...
from secretlearn.SS.cross_decomposition.plsregression import SSPLSRegression


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPLSRegression')
...
def main():
    ...
    print("="*70)
    print(f" SSPLSRegression - Party: {party_name.upper()}")
    print("="*70)
