...
"""
Usage Example for SSRidgeClassifier

Usage:
    Terminal 1: python ridge_classifier.py --party bob
    Terminal 2: python ridge_classifier.py --party alice

This example demonstrates how to use the privacy-preserving RidgeClassifier
...
from secretlearn.SS.linear_models.ridge_classifier import SSRidgeClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRidgeClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSRidgeClassifier - Party: {party_name.upper()}")
    print("="*70)
