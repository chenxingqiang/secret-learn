...
"""
Usage Example for SSLatentDirichletAllocation

Usage:
    Terminal 1: python latent_dirichlet_allocation.py --party bob
    Terminal 2: python latent_dirichlet_allocation.py --party alice

This example demonstrates how to use the privacy-preserving LatentDirichletAllocation
...
from secretlearn.SS.decomposition.latent_dirichlet_allocation import SSLatentDirichletAllocation


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLatentDirichletAllocation')
...
def main():
    ...
    print("="*70)
    print(f" SSLatentDirichletAllocation - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSLatentDirichletAllocation...")
    ...
    model = FLLatentDirichletAllocation(devices)
