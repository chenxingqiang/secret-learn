...
"""
Usage Example for SSLabelEncoder

Usage:
    Terminal 1: python label_encoder.py --party bob
    Terminal 2: python label_encoder.py --party alice
...
from secretlearn.SS.preprocessing.label_encoder import SSLabelEncoder


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLabelEncoder')
...
def main():
    ...
    print("="*70)
    print(f" SSLabelEncoder - Party: {party_name.upper()}")
    print("="*70)
