...
Usage:
    Terminal 1: python calibrated_classifier_cv.py --party bob
    Terminal 2: python calibrated_classifier_cv.py --party alice
...
from secretlearn.SS.calibration.calibrated_classifier_cv import SSCalibratedClassifierCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSCalibratedClassifierCV')
...
def main():
    ...
    print("="*70)
    print(f" SSCalibratedClassifierCV - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSCalibratedClassifierCV...")
    ...
    model = SSCalibratedClassifierCV(spu)
