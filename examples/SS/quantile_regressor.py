...
"""
Usage Example for SSQuantileRegressor

Usage:
    Terminal 1: python quantile_regressor.py --party bob
    Terminal 2: python quantile_regressor.py --party alice

This example demonstrates how to use the privacy-preserving QuantileRegressor
...
from secretlearn.SS.linear_models.quantile_regressor import SSQuantileRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSQuantileRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSQuantileRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSQuantileRegressor...")
    ...
    model = FLQuantileRegressor(devices)
