...
"""
Usage Example for SSMultiTaskElasticNet

Usage:
    Terminal 1: python multi_task_elastic_net.py --party bob
    Terminal 2: python multi_task_elastic_net.py --party alice

This example demonstrates how to use the privacy-preserving MultiTaskElasticNet
...
from secretlearn.SS.linear_models.multi_task_elastic_net import SSMultiTaskElasticNet


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMultiTaskElasticNet')
...
def main():
    ...
    print("="*70)
    print(f" SSMultiTaskElasticNet - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMultiTaskElasticNet...")
    ...
    model = FLMultiTaskElasticNet(devices)
