...
"""
Usage Example for SSGraphicalLassoCV

Usage:
    Terminal 1: python graphical_lasso_cv.py --party bob
    Terminal 2: python graphical_lasso_cv.py --party alice

This example demonstrates how to use the privacy-preserving GraphicalLassoCv
...
from secretlearn.SS.covariance.graphical_lasso_cv import SSGraphicalLassoCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSGraphicalLassoCV')
...
def main():
    ...
    print("="*70)
    print(f" SSGraphicalLassoCV - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSGraphicalLassoCV...")
