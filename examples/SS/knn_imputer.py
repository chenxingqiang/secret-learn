...
"""
Usage Example for SSKNNImputer

Usage:
    Terminal 1: python knn_imputer.py --party bob
    Terminal 2: python knn_imputer.py --party alice
...
from secretlearn.SS.impute.knn_imputer import SSKNNImputer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKNNImputer')
...
def main():
    ...
    print("="*70)
    print(f" SSKNNImputer - Party: {party_name.upper()}")
    print("="*70)
