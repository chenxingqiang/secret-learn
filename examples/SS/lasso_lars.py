...
Usage:
    Terminal 1: python lasso_lars.py --party bob
    Terminal 2: python lasso_lars.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLassoLars')
...
def main():
    ...
    print("="*70)
    print(f" SSLassoLars - Party: {party_name.upper()}")
    print("="*70)
