...
"""
Usage Example for SSGaussianNB

Usage:
    Terminal 1: python gaussian_nb.py --party bob
    Terminal 2: python gaussian_nb.py --party alice
...
from secretlearn.SS.naive_bayes.gaussian_nb import SSGaussianNB


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSGaussianNB')
...
def main():
    ...
    print("="*70)
    print(f" SSGaussianNB - Party: {party_name.upper()}")
    print("="*70)
