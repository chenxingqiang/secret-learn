...
"""
Usage Example for SSFactorAnalysis

Usage:
    Terminal 1: python factor_analysis.py --party bob
    Terminal 2: python factor_analysis.py --party alice

This example demonstrates how to use the privacy-preserving FactorAnalysis
...
from secretlearn.SS.decomposition.factor_analysis import SSFactorAnalysis


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSFactorAnalysis')
...
def main():
    ...
    print("="*70)
    print(f" SSFactorAnalysis - Party: {party_name.upper()}")
    print("="*70)
