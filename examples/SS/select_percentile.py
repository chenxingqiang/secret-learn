...
"""
Usage Example for SSSelectPercentile

Usage:
    Terminal 1: python select_percentile.py --party bob
    Terminal 2: python select_percentile.py --party alice

This example demonstrates how to use the privacy-preserving SelectPercentile
...
from secretlearn.SS.feature_selection.select_percentile import SSSelectPercentile


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSelectPercentile')
...
def main():
    ...
    print("="*70)
    print(f" SSSelectPercentile - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSSelectPercentile...")
    ...
    model = FLSelectPercentile(devices)
