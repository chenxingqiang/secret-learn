...
"""
Usage Example for SSMaxAbsScaler

Usage:
    Terminal 1: python max_abs_scaler.py --party bob
    Terminal 2: python max_abs_scaler.py --party alice

This example demonstrates how to use the privacy-preserving MaxAbsScaler
...
from secretlearn.SS.preprocessing.max_abs_scaler import SSMaxAbsScaler


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMaxAbsScaler')
...
def main():
    ...
    print("="*70)
    print(f" SSMaxAbsScaler - Party: {party_name.upper()}")
    print("="*70)
