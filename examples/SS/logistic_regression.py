...
"""
Usage Example for SSLogisticRegression

Usage:
    Terminal 1: python logistic_regression.py --party bob
    Terminal 2: python logistic_regression.py --party alice

This example demonstrates how to use the privacy-preserving LogisticRegression
...
from secretlearn.SS.linear_models.logistic_regression import SSLogisticRegression


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLogisticRegression')
...
def main():
    ...
    print("="*70)
    print(f" SSLogisticRegression - Party: {party_name.upper()}")
    print("="*70)
