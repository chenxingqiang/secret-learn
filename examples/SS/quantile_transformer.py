...
"""
Usage Example for SSQuantileTransformer

Usage:
    Terminal 1: python quantile_transformer.py --party bob
    Terminal 2: python quantile_transformer.py --party alice

This example demonstrates how to use the privacy-preserving QuantileTransformer
...
from secretlearn.SS.preprocessing.quantile_transformer import SSQuantileTransformer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSQuantileTransformer')
...
def main():
    ...
    print("="*70)
    print(f" SSQuantileTransformer - Party: {party_name.upper()}")
    print("="*70)
