...
"""
Usage Example for SSGaussianMixture

Usage:
    Terminal 1: python gaussian_mixture.py --party bob
    Terminal 2: python gaussian_mixture.py --party alice

This example demonstrates how to use the privacy-preserving GaussianMixture
...
from secretlearn.SS.mixture.gaussian_mixture import SSGaussianMixture


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSGaussianMixture')
...
def main():
    ...
    print("="*70)
    print(f" SSGaussianMixture - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSGaussianMixture...")
    ...
    model = FLGaussianMixture(devices)
