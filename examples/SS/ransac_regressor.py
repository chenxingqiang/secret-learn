...
"""
Usage Example for SSRansacRegressor

Usage:
    Terminal 1: python ransac_regressor.py --party bob
    Terminal 2: python ransac_regressor.py --party alice

This example demonstrates how to use the privacy-preserving RansacRegressor
...
from secretlearn.SS.linear_models.ransac_regressor import SSRansacRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRansacRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSRansacRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSRansacRegressor...")
