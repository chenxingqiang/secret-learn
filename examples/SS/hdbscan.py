...
"""
Usage Example for SSHDBSCAN

Usage:
    Terminal 1: python hdbscan.py --party bob
    Terminal 2: python hdbscan.py --party alice
...
from secretlearn.SS.clustering.hdbscan import SSHDBSCAN


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSHDBSCAN')
...
def main():
    ...
    print("="*70)
    print(f" SSHDBSCAN - Party: {party_name.upper()}")
    print("="*70)
