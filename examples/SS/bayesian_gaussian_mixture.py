...
"""
Usage Example for SSBayesianGaussianMixture

Usage:
    Terminal 1: python bayesian_gaussian_mixture.py --party bob
    Terminal 2: python bayesian_gaussian_mixture.py --party alice

This example demonstrates how to use the privacy-preserving BayesianGaussianMixture
...
from secretlearn.SS.mixture.bayesian_gaussian_mixture import SSBayesianGaussianMixture


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBayesianGaussianMixture')
...
def main():
    ...
    print("="*70)
    print(f" SSBayesianGaussianMixture - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSBayesianGaussianMixture...")
    ...
    model = FLBayesianGaussianMixture(devices)
