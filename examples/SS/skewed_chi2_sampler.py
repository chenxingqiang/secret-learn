...
"""
Usage Example for SSSkewedChi2Sampler

Usage:
    Terminal 1: python skewed_chi2_sampler.py --party bob
    Terminal 2: python skewed_chi2_sampler.py --party alice

This example demonstrates how to use the privacy-preserving SkewedChi2Sampler
...
from secretlearn.SS.kernel_approximation.skewed_chi2_sampler import SSSkewedChi2Sampler


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSkewedChi2Sampler')
...
def main():
    ...
    print("="*70)
    print(f" SSSkewedChi2Sampler - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSSkewedChi2Sampler...")
    ...
    model = FLSkewedChi2Sampler(devices)
