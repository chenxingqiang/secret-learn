...
"""
Usage Example for SSLocalOutlierFactor

Usage:
    Terminal 1: python local_outlier_factor.py --party bob
    Terminal 2: python local_outlier_factor.py --party alice

This example demonstrates how to use the privacy-preserving LocalOutlierFactor
...
from secretlearn.SS.neighbors.local_outlier_factor import SSLocalOutlierFactor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLocalOutlierFactor')
...
def main():
    ...
    print("="*70)
    print(f" SSLocalOutlierFactor - Party: {party_name.upper()}")
    print("="*70)
