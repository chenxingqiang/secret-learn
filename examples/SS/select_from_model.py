...
"""
Usage Example for SSSelectFromModel

Usage:
    Terminal 1: python select_from_model.py --party bob
    Terminal 2: python select_from_model.py --party alice

This example demonstrates how to use the privacy-preserving SelectFromModel
...
from secretlearn.SS.feature_selection.select_from_model import SSSelectFromModel


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSelectFromModel')
...
def main():
    ...
    print("="*70)
    print(f" SSSelectFromModel - Party: {party_name.upper()}")
    print("="*70)
