...
"""
Usage Example for SSKernelPca

Usage:
    Terminal 1: python kernel_pca.py --party bob
    Terminal 2: python kernel_pca.py --party alice
...
from secretlearn.SS.decomposition.kernel_pca import SSKernelPca


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKernelPca')
...
def main():
    ...
    print("="*70)
    print(f" SSKernelPca - Party: {party_name.upper()}")
    print("="*70)
