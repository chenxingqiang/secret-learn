...
"""
Usage Example for SSTweedieRegressor

Usage:
    Terminal 1: python tweedie_regressor.py --party bob
    Terminal 2: python tweedie_regressor.py --party alice

This example demonstrates how to use the privacy-preserving TweedieRegressor
...
from secretlearn.SS.linear_models.tweedie_regressor import SSTweedieRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSTweedieRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSTweedieRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSTweedieRegressor...")
    ...
    model = FLTweedieRegressor(devices)
