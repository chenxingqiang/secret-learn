...
"""
Usage Example for SSComplementNB

Usage:
    Terminal 1: python complement_nb.py --party bob
    Terminal 2: python complement_nb.py --party alice
...
from secretlearn.SS.naive_bayes.complement_nb import SSComplementNB


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSComplementNB')
...
def main():
    ...
    print("="*70)
    print(f" SSComplementNB - Party: {party_name.upper()}")
    print("="*70)
