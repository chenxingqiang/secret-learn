...
"""
Usage Example for SSOneHotEncoder

Usage:
    Terminal 1: python one_hot_encoder.py --party bob
    Terminal 2: python one_hot_encoder.py --party alice

This example demonstrates how to use the privacy-preserving OneHotEncoder
...
from secretlearn.SS.preprocessing.one_hot_encoder import SSOneHotEncoder


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOneHotEncoder')
...
def main():
    ...
    print("="*70)
    print(f" SSOneHotEncoder - Party: {party_name.upper()}")
    print("="*70)
