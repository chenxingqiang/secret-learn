...
"""
Usage Example for SSMultiOutputRegressor

Usage:
    Terminal 1: python multi_output_regressor.py --party bob
    Terminal 2: python multi_output_regressor.py --party alice

This example demonstrates how to use the privacy-preserving MultiOutputRegressor
...
from secretlearn.SS.multioutput.multi_output_regressor import SSMultiOutputRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMultiOutputRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSMultiOutputRegressor - Party: {party_name.upper()}")
    print("="*70)
