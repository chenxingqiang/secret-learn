...
"""
Usage Example for SSMiniBatchKmeans

Usage:
    Terminal 1: python mini_batch_kmeans.py --party bob
    Terminal 2: python mini_batch_kmeans.py --party alice

This example demonstrates how to use the privacy-preserving MiniBatchKmeans
...
from secretlearn.SS.clustering.mini_batch_kmeans import SSMiniBatchKmeans


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMiniBatchKmeans')
...
def main():
    ...
    print("="*70)
    print(f" SSMiniBatchKmeans - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMiniBatchKmeans...")
