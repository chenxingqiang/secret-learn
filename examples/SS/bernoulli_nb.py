...
"""
Usage Example for SSBernoulliNB

Usage:
    Terminal 1: python bernoulli_nb.py --party bob
    Terminal 2: python bernoulli_nb.py --party alice
...
from secretlearn.SS.naive_bayes.bernoulli_nb import SSBernoulliNB


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBernoulliNB')
...
def main():
    ...
    print("="*70)
    print(f" SSBernoulliNB - Party: {party_name.upper()}")
    print("="*70)
