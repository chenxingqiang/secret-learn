...
"""
Usage Example for SSKNeighborsClassifier

Usage:
    Terminal 1: python k_neighbors_classifier.py --party bob
    Terminal 2: python k_neighbors_classifier.py --party alice

This example demonstrates how to use the privacy-preserving KNeighborsClassifier
...
from secretlearn.SS.neighbors.k_neighbors_classifier import SSKNeighborsClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKNeighborsClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSKNeighborsClassifier - Party: {party_name.upper()}")
    print("="*70)
