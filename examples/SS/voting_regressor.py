...
"""
Usage Example for SSVotingRegressor

Usage:
    Terminal 1: python voting_regressor.py --party bob
    Terminal 2: python voting_regressor.py --party alice

This example demonstrates how to use the privacy-preserving VotingRegressor
...
from secretlearn.SS.ensemble.voting_regressor import SSVotingRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSVotingRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSVotingRegressor - Party: {party_name.upper()}")
    print("="*70)
