...
"""
Usage Example for SSSplinetransformer

Usage:
    Terminal 1: python splinetransformer.py --party bob
    Terminal 2: python splinetransformer.py --party alice

This example demonstrates how to use the privacy-preserving Splinetransformer
...
from secretlearn.SS.preprocessing.splinetransformer import SSSplinetransformer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSplinetransformer')
...
def main():
    ...
    print("="*70)
    print(f" SSSplinetransformer - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSSplinetransformer...")
