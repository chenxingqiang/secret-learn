...
"""
Usage Example for SSNormalizer

Usage:
    Terminal 1: python normalizer.py --party bob
    Terminal 2: python normalizer.py --party alice

This example demonstrates how to use the privacy-preserving Normalizer
...
from secretlearn.SS.preprocessing.normalizer import SSNormalizer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNormalizer')
...
def main():
    ...
    print("="*70)
    print(f" SSNormalizer - Party: {party_name.upper()}")
    print("="*70)
