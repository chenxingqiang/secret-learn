...
"""
Usage Example for SSShrunkcovariance

Usage:
    Terminal 1: python shrunkcovariance.py --party bob
    Terminal 2: python shrunkcovariance.py --party alice

This example demonstrates how to use the privacy-preserving Shrunkcovariance
...
from secretlearn.SS.covariance.shrunkcovariance import SSShrunkcovariance


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSShrunkcovariance')
...
def main():
    ...
    print("="*70)
    print(f" SSShrunkcovariance - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSShrunkcovariance...")
