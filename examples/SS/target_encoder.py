...
"""
Usage Example for SSTargetEncoder

Usage:
    Terminal 1: python target_encoder.py --party bob
    Terminal 2: python target_encoder.py --party alice

This example demonstrates how to use the privacy-preserving TargetEncoder
...
from secretlearn.SS.preprocessing.target_encoder import SSTargetEncoder


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSTargetEncoder')
...
def main():
    ...
    print("="*70)
    print(f" SSTargetEncoder - Party: {party_name.upper()}")
    print("="*70)
