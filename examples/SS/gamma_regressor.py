...
"""
Usage Example for SSGammaRegressor

Usage:
    Terminal 1: python gamma_regressor.py --party bob
    Terminal 2: python gamma_regressor.py --party alice

This example demonstrates how to use the privacy-preserving GammaRegressor
...
from secretlearn.SS.linear_models.gamma_regressor import SSGammaRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSGammaRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSGammaRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    model = FLGammaRegressor(devices)
