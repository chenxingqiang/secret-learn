...
"""
Usage Example for SSNusvc

Usage:
    Terminal 1: python nusvc.py --party bob
    Terminal 2: python nusvc.py --party alice
...
from secretlearn.SS.svm.nusvc import SSNusvc


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNusvc')
...
def main():
    ...
    print("="*70)
    print(f" SSNusvc - Party: {party_name.upper()}")
    print("="*70)
