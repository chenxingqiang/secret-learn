...
"""
Usage Example for SSLinearRegression

Usage:
    Terminal 1: python linear_regression.py --party bob
    Terminal 2: python linear_regression.py --party alice

This example demonstrates how to use the privacy-preserving LinearRegression
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLinearRegression')
...
def main():
    ...
    print("="*70)
    print(f" SSLinearRegression - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSLinearRegression...")
