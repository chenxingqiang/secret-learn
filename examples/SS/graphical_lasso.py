...
"""
Usage Example for SSGraphicalLasso

Usage:
    Terminal 1: python graphical_lasso.py --party bob
    Terminal 2: python graphical_lasso.py --party alice

This example demonstrates how to use the privacy-preserving GraphicalLasso
...
from secretlearn.SS.covariance.graphical_lasso import SSGraphicalLasso


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSGraphicalLasso')
...
def main():
    ...
    print("="*70)
    print(f" SSGraphicalLasso - Party: {party_name.upper()}")
    print("="*70)
    ...
    model = FLGraphicalLasso(devices)
