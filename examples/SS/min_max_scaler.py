...
"""
Usage Example for SSMinMaxScaler

Usage:
    Terminal 1: python min_max_scaler.py --party bob
    Terminal 2: python min_max_scaler.py --party alice

This example demonstrates how to use the privacy-preserving MinMaxScaler
...
from secretlearn.SS.preprocessing.min_max_scaler import SSMinMaxScaler


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMinMaxScaler')
...
def main():
    ...
    print("="*70)
    print(f" SSMinMaxScaler - Party: {party_name.upper()}")
    print("="*70)
