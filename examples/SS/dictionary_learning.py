...
"""
Usage Example for SSDictionaryLearning

Usage:
    Terminal 1: python dictionary_learning.py --party bob
    Terminal 2: python dictionary_learning.py --party alice

This example demonstrates how to use the privacy-preserving DictionaryLearning
...
from secretlearn.SS.decomposition.dictionary_learning import SSDictionaryLearning


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSDictionaryLearning')
...
def main():
    ...
    print("="*70)
    print(f" SSDictionaryLearning - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSDictionaryLearning...")
    ...
    model = FLDictionaryLearning(devices)
