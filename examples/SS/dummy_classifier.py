...
"""
Usage Example for SSDummyClassifier

Usage:
    Terminal 1: python dummy_classifier.py --party bob
    Terminal 2: python dummy_classifier.py --party alice
...
from secretlearn.SS.dummy.dummy_classifier import SSDummyClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSDummyClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSDummyClassifier - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSDummyClassifier...")
