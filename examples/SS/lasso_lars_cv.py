...
"""
Usage Example for SSLassoLarsCV

Usage:
    Terminal 1: python lasso_lars_cv.py --party bob
    Terminal 2: python lasso_lars_cv.py --party alice
...
from secretlearn.SS.linear_models.lasso_lars_cv import SSLassoLarsCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLassoLarsCV')
...
def main():
    ...
    print("="*70)
    print(f" SSLassoLarsCV - Party: {party_name.upper()}")
    print("="*70)
