...
"""
Usage Example for SSMiniBatchDictionarylearning

Usage:
    Terminal 1: python mini_batch_dictionarylearning.py --party bob
    Terminal 2: python mini_batch_dictionarylearning.py --party alice

This example demonstrates how to use the privacy-preserving MiniBatchDictionarylearning
...
from secretlearn.SS.decomposition.mini_batch_dictionarylearning import SSMiniBatchDictionarylearning


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMiniBatchDictionarylearning')
...
def main():
    ...
    print("="*70)
    print(f" SSMiniBatchDictionarylearning - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMiniBatchDictionarylearning...")
    ...
    model = SSMiniBatchDictionarylearning(spu)
