...
"""
Usage Example for SSFeatureHasher

Usage:
    Terminal 1: python feature_hasher.py --party bob
    Terminal 2: python feature_hasher.py --party alice

This example demonstrates how to use the privacy-preserving FeatureHasher
...
from secretlearn.SS.feature_extraction.feature_hasher import SSFeatureHasher


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSFeatureHasher')
...
def main():
    ...
    print("="*70)
    print(f" SSFeatureHasher - Party: {party_name.upper()}")
    print("="*70)
