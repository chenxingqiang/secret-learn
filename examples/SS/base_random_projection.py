...
"""
Usage Example for SSBaseRandomProjection

Usage:
    Terminal 1: python base_random_projection.py --party bob
    Terminal 2: python base_random_projection.py --party alice

This example demonstrates how to use the privacy-preserving BaseRandomProjection
...
from secretlearn.SS.random_projection.base_random_projection import SSBaseRandomProjection


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBaseRandomProjection')
...
def main():
    ...
    print("="*70)
    print(f" SSBaseRandomProjection - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSBaseRandomProjection...")
    ...
    model = FLBaseRandomProjection(devices)
