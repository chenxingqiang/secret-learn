...
"""
Usage Example for SSIncrementalPca

Usage:
    Terminal 1: python incremental_pca.py --party bob
    Terminal 2: python incremental_pca.py --party alice

This example demonstrates how to use the privacy-preserving IncrementalPca
...
from secretlearn.SS.decomposition.incremental_pca import SSIncrementalPca


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSIncrementalPca')
...
def main():
    ...
    print("="*70)
    print(f" SSIncrementalPca - Party: {party_name.upper()}")
    print("="*70)
