...
"""
Usage Example for SSRobustScaler

Usage:
    Terminal 1: python robust_scaler.py --party bob
    Terminal 2: python robust_scaler.py --party alice
...
from secretlearn.SS.preprocessing.robust_scaler import SSRobustScaler


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRobustScaler')
...
def main():
    ...
    print("="*70)
    print(f" SSRobustScaler - Party: {party_name.upper()}")
    print("="*70)
