...
"""
Usage Example for SSOneVsOneClassifier

Usage:
    Terminal 1: python one_vs_one_classifier.py --party bob
    Terminal 2: python one_vs_one_classifier.py --party alice

This example demonstrates how to use the privacy-preserving OneVsOneClassifier
...
from secretlearn.SS.multiclass.one_vs_one_classifier import SSOneVsOneClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOneVsOneClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSOneVsOneClassifier - Party: {party_name.upper()}")
    print("="*70)
