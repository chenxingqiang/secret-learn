...
"""
Usage Example for SSOneClassSVM

Usage:
    Terminal 1: python one_class_svm.py --party bob
    Terminal 2: python one_class_svm.py --party alice
...
from secretlearn.SS.svm.one_class_svm import SSOneClassSVM


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOneClassSVM')
...
def main():
    ...
    print("="*70)
    print(f" SSOneClassSVM - Party: {party_name.upper()}")
    print("="*70)
