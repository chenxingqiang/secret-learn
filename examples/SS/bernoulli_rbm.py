...
"""
Usage Example for SSBernoulliRBM

Usage:
    Terminal 1: python bernoulli_rbm.py --party bob
    Terminal 2: python bernoulli_rbm.py --party alice
...
from secretlearn.SS.neural_network.bernoulli_rbm import SSBernoulliRBM


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBernoulliRBM')
...
def main():
    ...
    print("="*70)
    print(f" SSBernoulliRBM - Party: {party_name.upper()}")
    print("="*70)
