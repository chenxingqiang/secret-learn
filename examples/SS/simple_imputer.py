...
"""
Usage Example for SSSimpleImputer

Usage:
    Terminal 1: python simple_imputer.py --party bob
    Terminal 2: python simple_imputer.py --party alice

This example demonstrates how to use the privacy-preserving SimpleImputer
...
from secretlearn.SS.impute.simple_imputer import SSSimpleImputer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSimpleImputer')
...
def main():
    ...
    print("="*70)
    print(f" SSSimpleImputer - Party: {party_name.upper()}")
    print("="*70)
