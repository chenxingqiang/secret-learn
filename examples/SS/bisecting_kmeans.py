...
"""
Usage Example for SSBisectingKMeans

Usage:
    Terminal 1: python bisecting_kmeans.py --party bob
    Terminal 2: python bisecting_kmeans.py --party alice

This example demonstrates how to use the privacy-preserving BisectingKmeans
...
from secretlearn.SS.clustering.bisecting_kmeans import SSBisectingKMeans


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBisectingKMeans')
...
def main():
    ...
    print("="*70)
    print(f" SSBisectingKMeans - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSBisectingKMeans...")
