...
"""
Usage Example for SSBinarizer

Usage:
    Terminal 1: python binarizer.py --party bob
    Terminal 2: python binarizer.py --party alice

This example demonstrates how to use the privacy-preserving Binarizer
...
from secretlearn.SS.preprocessing.binarizer import SSBinarizer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBinarizer')
...
def main():
    ...
    print("="*70)
    print(f" SSBinarizer - Party: {party_name.upper()}")
    print("="*70)
