...
"""
Usage Example for SSRidgeClassifierCV

Usage:
    Terminal 1: python ridge_classifier_cv.py --party bob
    Terminal 2: python ridge_classifier_cv.py --party alice

This example demonstrates how to use the privacy-preserving RidgeClassifierCv
...
from secretlearn.SS.linear_models.ridge_classifier_cv import SSRidgeClassifierCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRidgeClassifierCV')
...
def main():
    ...
    print("="*70)
    print(f" SSRidgeClassifierCV - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSRidgeClassifierCV...")
