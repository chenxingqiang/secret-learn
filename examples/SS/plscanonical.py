...
"""
Usage Example for SSPLSCanonical

Usage:
    Terminal 1: python plscanonical.py --party bob
    Terminal 2: python plscanonical.py --party alice
...
from secretlearn.SS.cross_decomposition.plscanonical import SSPLSCanonical


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPLSCanonical')
