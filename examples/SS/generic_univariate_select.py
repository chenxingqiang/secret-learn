...
"""
Usage Example for SSGenericUnivariateSelect

Usage:
    Terminal 1: python generic_univariate_select.py --party bob
    Terminal 2: python generic_univariate_select.py --party alice

This example demonstrates how to use the privacy-preserving GenericUnivariateSelect
...
from secretlearn.SS.feature_selection.generic_univariate_select import SSGenericUnivariateSelect


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSGenericUnivariateSelect')
...
def main():
    ...
    print("="*70)
    print(f" SSGenericUnivariateSelect - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSGenericUnivariateSelect...")
    ...
    model = FLGenericUnivariateSelect(devices)
