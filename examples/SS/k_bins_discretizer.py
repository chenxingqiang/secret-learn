...
"""
Usage Example for SSKBinsDiscretizer

Usage:
    Terminal 1: python k_bins_discretizer.py --party bob
    Terminal 2: python k_bins_discretizer.py --party alice

This example demonstrates how to use the privacy-preserving KBinsDiscretizer
...
from secretlearn.SS.preprocessing.k_bins_discretizer import SSKBinsDiscretizer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKBinsDiscretizer')
...
def main():
    ...
    print("="*70)
    print(f" SSKBinsDiscretizer - Party: {party_name.upper()}")
    print("="*70)
