...
Usage:
    Terminal 1: python elastic_net_cv.py --party bob
    Terminal 2: python elastic_net_cv.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSElasticNetCV')
...
def main():
    ...
    print("="*70)
    print(f" SSElasticNetCV - Party: {party_name.upper()}")
    print("="*70)
