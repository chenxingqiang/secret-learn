...
"""
Usage Example for SSRadiusNeighborsTransformer

Usage:
    Terminal 1: python radius_neighbors_transformer.py --party bob
    Terminal 2: python radius_neighbors_transformer.py --party alice

This example demonstrates how to use the privacy-preserving RadiusNeighborsTransformer
in SecretFlow's secret sharing environment.
"""
...
from secretlearn.SS.neighbors.radius_neighbors_transformer import SSRadiusNeighborsTransformer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRadiusNeighborsTransformer')
...
def main():
    ...
    print("="*70)
    print(f" SSRadiusNeighborsTransformer - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSRadiusNeighborsTransformer...")
    ...
    model = FLRadiusNeighborsTransformer(devices)
