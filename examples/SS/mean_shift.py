...
"""
Usage Example for SSMeanShift

Usage:
    Terminal 1: python mean_shift.py --party bob
    Terminal 2: python mean_shift.py --party alice
...
from secretlearn.SS.clustering.mean_shift import SSMeanShift


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMeanShift')
...
def main():
    ...
    print("="*70)
    print(f" SSMeanShift - Party: {party_name.upper()}")
    print("="*70)
