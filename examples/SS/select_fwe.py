...
Usage:
    Terminal 1: python select_fwe.py --party bob
    Terminal 2: python select_fwe.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSelectFwe')
...
def main():
    ...
    print("="*70)
    print(f" SSSelectFwe - Party: {party_name.upper()}")
    print("="*70)
