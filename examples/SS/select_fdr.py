...
Usage:
    Terminal 1: python select_fdr.py --party bob
    Terminal 2: python select_fdr.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSelectFdr')
...
def main():
    ...
    print("="*70)
    print(f" SSSelectFdr - Party: {party_name.upper()}")
    print("="*70)
