...
Usage:
    Terminal 1: python dbscan.py --party bob
    Terminal 2: python dbscan.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSDBSCAN')
...
def main():
    ...
    print("="*70)
    print(f" SSDBSCAN - Party: {party_name.upper()}")
    print("="*70)
