...
"""
Usage Example for SSNearestCentroid

Usage:
    Terminal 1: python nearest_centroid.py --party bob
    Terminal 2: python nearest_centroid.py --party alice

This example demonstrates how to use the privacy-preserving NearestCentroid
...
from secretlearn.SS.neighbors.nearest_centroid import SSNearestCentroid


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNearestCentroid')
...
def main():
    ...
    print("="*70)
    print(f" SSNearestCentroid - Party: {party_name.upper()}")
    print("="*70)
