...
"""
Usage Example for SSFeatureAgglomeration

Usage:
    Terminal 1: python feature_agglomeration.py --party bob
    Terminal 2: python feature_agglomeration.py --party alice

This example demonstrates how to use the privacy-preserving FeatureAgglomeration
...
from secretlearn.SS.clustering.feature_agglomeration import SSFeatureAgglomeration


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSFeatureAgglomeration')
...
def main():
    ...
    print("="*70)
    print(f" SSFeatureAgglomeration - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSFeatureAgglomeration...")
    ...
    model = FLFeatureAgglomeration(devices)
