...
"""
Usage Example for SSMultiTaskLasso

Usage:
    Terminal 1: python multi_task_lasso.py --party bob
    Terminal 2: python multi_task_lasso.py --party alice

This example demonstrates how to use the privacy-preserving MultiTaskLasso
...
from secretlearn.SS.linear_models.multi_task_lasso import SSMultiTaskLasso


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMultiTaskLasso')
...
def main():
    ...
    print("="*70)
    print(f" SSMultiTaskLasso - Party: {party_name.upper()}")
    print("="*70)
    ...
    model = FLMultiTaskLasso(devices)
