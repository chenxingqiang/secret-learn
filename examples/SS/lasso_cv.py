...
"""
Usage Example for SSLassoCv

Usage:
    Terminal 1: python lasso_cv.py --party bob
    Terminal 2: python lasso_cv.py --party alice
...
from secretlearn.SS.linear_models.lasso_cv import SSLassoCv


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLassoCv')
...
def main():
    ...
    print("="*70)
    print(f" SSLassoCv - Party: {party_name.upper()}")
    print("="*70)
