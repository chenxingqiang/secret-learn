...
"""
Usage Example for SSIsotonicRegression

Usage:
    Terminal 1: python isotonic_regression.py --party bob
    Terminal 2: python isotonic_regression.py --party alice

This example demonstrates how to use the privacy-preserving IsotonicRegression
...
from secretlearn.SS.isotonic.isotonic_regression import SSIsotonicRegression


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSIsotonicRegression')
...
def main():
    ...
    print("="*70)
    print(f" SSIsotonicRegression - Party: {party_name.upper()}")
    print("="*70)
