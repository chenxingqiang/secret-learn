...
"""
Usage Example for SSOrdinalEncoder

Usage:
    Terminal 1: python ordinal_encoder.py --party bob
    Terminal 2: python ordinal_encoder.py --party alice

This example demonstrates how to use the privacy-preserving OrdinalEncoder
...
from secretlearn.SS.preprocessing.ordinal_encoder import SSOrdinalEncoder


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOrdinalEncoder')
...
def main():
    ...
    print("="*70)
    print(f" SSOrdinalEncoder - Party: {party_name.upper()}")
    print("="*70)
