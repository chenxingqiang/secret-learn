...
"""
Usage Example for SSExtraTreesRegressor

Usage:
    Terminal 1: python extra_trees_regressor.py --party bob
    Terminal 2: python extra_trees_regressor.py --party alice

This example demonstrates how to use the privacy-preserving ExtraTreesRegressor
...
from secretlearn.SS.ensemble.extra_trees_regressor import SSExtraTreesRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSExtraTreesRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSExtraTreesRegressor - Party: {party_name.upper()}")
    print("="*70)
