...
"""
Usage Example for SS CCA

Usage:
    Terminal 1: python cca.py --party bob
    Terminal 2: python cca.py --party alice
...
from secretlearn.SS.cross_decomposition.cca import SS CCA


def parse_args():
    parser = argparse.ArgumentParser(description='SS SS')
...
def main():
    ...
    print("="*70)
    print(f" SS - Party: {party_name.upper()}")
    print("="*70)
