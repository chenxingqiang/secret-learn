...
"""
Usage Example for SSSpectralEmbedding

Usage:
    Terminal 1: python spectral_embedding.py --party bob
    Terminal 2: python spectral_embedding.py --party alice

This example demonstrates how to use the privacy-preserving SpectralEmbedding
...
from secretlearn.SS.manifold.spectral_embedding import SSSpectralEmbedding


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSpectralEmbedding')
...
def main():
    ...
    print("="*70)
    print(f" SSSpectralEmbedding - Party: {party_name.upper()}")
    print("="*70)
