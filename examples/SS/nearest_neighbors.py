...
"""
Usage Example for SSNearestNeighbors

Usage:
    Terminal 1: python nearest_neighbors.py --party bob
    Terminal 2: python nearest_neighbors.py --party alice

This example demonstrates how to use the privacy-preserving NearestNeighbors
...
from secretlearn.SS.neighbors.nearest_neighbors import SSNearestNeighbors


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNearestNeighbors')
...
def main():
    ...
    print("="*70)
    print(f" SSNearestNeighbors - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSNearestNeighbors...")
    ...
    model = FLNearestNeighbors(devices)
