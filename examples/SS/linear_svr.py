...
"""
Usage Example for SSLinearSVR

Usage:
    Terminal 1: python linear_svr.py --party bob
    Terminal 2: python linear_svr.py --party alice
...
from secretlearn.SS.svm.linear_svr import SSLinearSVR


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLinearSVR')
...
def main():
    ...
    print("="*70)
    print(f" SSLinearSVR - Party: {party_name.upper()}")
    print("="*70)
