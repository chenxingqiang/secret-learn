...
"""
Usage Example for SSOAS

Usage:
    Terminal 1: python oas.py --party bob
    Terminal 2: python oas.py --party alice
...
from secretlearn.SS.covariance.oas import SSOAS


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOAS')
...
def main():
    ...
    print("="*70)
    print(f" SSOAS - Party: {party_name.upper()}")
    print("="*70)
