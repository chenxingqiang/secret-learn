...
"""
Usage Example for SSExtraTreeRegressor

Usage:
    Terminal 1: python extra_tree_regressor.py --party bob
    Terminal 2: python extra_tree_regressor.py --party alice

This example demonstrates how to use the privacy-preserving ExtraTreeRegressor
...
from secretlearn.SS.tree.extra_tree_regressor import SSExtraTreeRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSExtraTreeRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSExtraTreeRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSExtraTreeRegressor...")
    ...
    model = FLExtraTreeRegressor(devices)
