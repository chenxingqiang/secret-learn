...
"""
Usage Example for SSVotingClassifier

Usage:
    Terminal 1: python voting_classifier.py --party bob
    Terminal 2: python voting_classifier.py --party alice

This example demonstrates how to use the privacy-preserving VotingClassifier
...
from secretlearn.SS.ensemble.voting_classifier import SSVotingClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSVotingClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSVotingClassifier - Party: {party_name.upper()}")
    print("="*70)
