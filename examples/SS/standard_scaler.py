...
"""
Usage Example for SSStandardScaler

Usage:
    Terminal 1: python standard_scaler.py --party bob
    Terminal 2: python standard_scaler.py --party alice

This example demonstrates how to use the privacy-preserving StandardScaler
...
from secretlearn.SS.preprocessing.standard_scaler import SSStandardScaler


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSStandardScaler')
...
def main():
    ...
    print("="*70)
    print(f" SSStandardScaler - Party: {party_name.upper()}")
    print("="*70)
