...
"""
Usage Example for SSEmpiricalCovariance

Usage:
    Terminal 1: python empirical_covariance.py --party bob
    Terminal 2: python empirical_covariance.py --party alice
...
from secretlearn.SS.covariance.empirical_covariance import SSEmpiricalCovariance


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSEmpiricalCovariance')
...
def main():
    ...
    print("="*70)
    print(f" SSEmpiricalCovariance - Party: {party_name.upper()}")
    print("="*70)
