...
"""
Usage Example for SSLassoLarsIC

Usage:
    Terminal 1: python lasso_lars_ic.py --party bob
    Terminal 2: python lasso_lars_ic.py --party alice
...
from secretlearn.SS.linear_models.lasso_lars_ic import SSLassoLarsIC


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLassoLarsIC')
...
def main():
    ...
    print("="*70)
    print(f" SSLassoLarsIC - Party: {party_name.upper()}")
    print("="*70)
