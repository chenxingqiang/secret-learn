...
"""
Usage Example for SSFunctionTransformer

Usage:
    Terminal 1: python function_transformer.py --party bob
    Terminal 2: python function_transformer.py --party alice

This example demonstrates how to use the privacy-preserving FunctionTransformer
...
from secretlearn.SS.preprocessing.function_transformer import SSFunctionTransformer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSFunctionTransformer')
...
def main():
    ...
    print("="*70)
    print(f" SSFunctionTransformer - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSFunctionTransformer...")
    ...
    model = FLFunctionTransformer(devices)
