...
Usage:
    Terminal 1: python isolation_forest.py --party bob
    Terminal 2: python isolation_forest.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSIsolationForest')
...
def main():
    ...
    print("="*70)
    print(f" SSIsolationForest - Party: {party_name.upper()}")
    print("="*70)
