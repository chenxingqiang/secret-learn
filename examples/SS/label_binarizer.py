...
"""
Usage Example for SSLabelBinarizer

Usage:
    Terminal 1: python label_binarizer.py --party bob
    Terminal 2: python label_binarizer.py --party alice

This example demonstrates how to use the privacy-preserving LabelBinarizer
...
from secretlearn.SS.naive_bayes.label_binarizer import SSLabelBinarizer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLabelBinarizer')
...
def main():
    ...
    print("="*70)
    print(f" SSLabelBinarizer - Party: {party_name.upper()}")
    print("="*70)
    ...
    model = FLLabelBinarizer(devices)
