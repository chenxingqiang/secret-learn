...
"""
Usage Example for SSNusvr

Usage:
    Terminal 1: python nusvr.py --party bob
    Terminal 2: python nusvr.py --party alice
...
from secretlearn.SS.svm.nusvr import SSNusvr


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNusvr')
...
def main():
    ...
    print("="*70)
    print(f" SSNusvr - Party: {party_name.upper()}")
    print("="*70)
