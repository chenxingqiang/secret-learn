...
"""
Usage Example for SSSvc

Usage:
    Terminal 1: python svc.py --party bob
    Terminal 2: python svc.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSvc')
...
def main():
    ...
    print("="*70)
    print(f" SSSvc - Party: {party_name.upper()}")
    print("="*70)
