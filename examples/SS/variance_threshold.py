...
"""
Usage Example for SSVarianceThreshold

Usage:
    Terminal 1: python variance_threshold.py --party bob
    Terminal 2: python variance_threshold.py --party alice

This example demonstrates how to use the privacy-preserving VarianceThreshold
...
from secretlearn.SS.feature_selection.variance_threshold import SSVarianceThreshold


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSVarianceThreshold')
...
def main():
    ...
    print("="*70)
    print(f" SSVarianceThreshold - Party: {party_name.upper()}")
    print("="*70)
