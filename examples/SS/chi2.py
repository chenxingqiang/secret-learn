...
"""
Usage Example for SSChi2

Usage:
    Terminal 1: python chi2.py --party bob
    Terminal 2: python chi2.py --party alice
...
from secretlearn.SS.feature_selection.chi2 import SSChi2


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSChi2')
...
def main():
    ...
    print("="*70)
    print(f" SSChi2 - Party: {party_name.upper()}")
    print("="*70)
