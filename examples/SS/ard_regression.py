...
"""
Usage Example for SSARDRegression

Usage:
    Terminal 1: python ard_regression.py --party bob
    Terminal 2: python ard_regression.py --party alice

This example demonstrates how to use the privacy-preserving ArdRegression
...
from secretlearn.SS.linear_models.ard_regression import SSARDRegression


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSARDRegression')
...
def main():
    ...
    print("="*70)
    print(f" SSARDRegression - Party: {party_name.upper()}")
    print("="*70)
