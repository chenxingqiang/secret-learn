...
"""
Usage Example for SSHistGradientBoostingClassifier

Usage:
    Terminal 1: python histgradient_boosting_classifier.py --party bob
    Terminal 2: python histgradient_boosting_classifier.py --party alice

This example demonstrates how to use the privacy-preserving HistgradientBoostingClassifier
...
from secretlearn.SS.ensemble.histgradient_boosting_classifier import SSHistGradientBoostingClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSHistGradientBoostingClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSHistGradientBoostingClassifier - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSHistGradientBoostingClassifier...")
    ...
    model = SSHistGradientBoostingClassifier(spu)
