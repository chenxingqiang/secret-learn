...
"""
Usage Example for SSKNeighborsTransformer

Usage:
    Terminal 1: python k_neighbors_transformer.py --party bob
    Terminal 2: python k_neighbors_transformer.py --party alice

This example demonstrates how to use the privacy-preserving KNeighborsTransformer
...
from secretlearn.SS.neighbors.k_neighbors_transformer import SSKNeighborsTransformer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKNeighborsTransformer')
...
def main():
    ...
    print("="*70)
    print(f" SSKNeighborsTransformer - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSKNeighborsTransformer...")
    ...
    model = FLKNeighborsTransformer(devices)
