...
Usage:
    Terminal 1: python multi_task_elastic_net_cv.py --party bob
    Terminal 2: python multi_task_elastic_net_cv.py --party alice
...
from secretlearn.SS.linear_models.multi_task_elastic_net_cv import SSMultiTaskElasticNetCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMultiTaskElasticNetCV')
...
def main():
    ...
    print("="*70)
    print(f" SSMultiTaskElasticNetCV - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMultiTaskElasticNetCV...")
    ...
    model = SSMultiTaskElasticNetCV(spu)
