...
"""
Usage Example for SSBaggingClassifier

Usage:
    Terminal 1: python bagging_classifier.py --party bob
    Terminal 2: python bagging_classifier.py --party alice

This example demonstrates how to use the privacy-preserving BaggingClassifier
...
from secretlearn.SS.ensemble.bagging_classifier import SSBaggingClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBaggingClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSBaggingClassifier - Party: {party_name.upper()}")
    print("="*70)
