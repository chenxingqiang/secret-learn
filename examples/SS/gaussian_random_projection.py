...
"""
Usage Example for SSGaussianRandomProjection

Usage:
    Terminal 1: python gaussian_random_projection.py --party bob
    Terminal 2: python gaussian_random_projection.py --party alice

This example demonstrates how to use the privacy-preserving GaussianRandomProjection
...
from secretlearn.SS.random_projection.gaussian_random_projection import SSGaussianRandomProjection


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSGaussianRandomProjection')
...
def main():
    ...
    print("="*70)
    print(f" SSGaussianRandomProjection - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSGaussianRandomProjection...")
    ...
    model = FLGaussianRandomProjection(devices)
