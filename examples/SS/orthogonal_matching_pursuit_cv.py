...
"""
Usage Example for SSOrthogonalMatchingPursuitCV

Usage:
    Terminal 1: python orthogonal_matching_pursuit_cv.py --party bob
    Terminal 2: python orthogonal_matching_pursuit_cv.py --party alice

This example demonstrates how to use the privacy-preserving OrthogonalMatchingPursuitCv
...
from secretlearn.SS.linear_models.orthogonal_matching_pursuit_cv import SSOrthogonalMatchingPursuitCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOrthogonalMatchingPursuitCV')
...
def main():
    ...
    print("="*70)
    print(f" SSOrthogonalMatchingPursuitCV - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSOrthogonalMatchingPursuitCV...")
    ...
    model = SSOrthogonalMatchingPursuitCV(spu)
