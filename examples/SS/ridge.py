...
"""
Usage Example for SSRidge

Usage:
    Terminal 1: python ridge.py --party bob
    Terminal 2: python ridge.py --party alice

This example demonstrates how to use the privacy-preserving Ridge
...
from secretlearn.SS.linear_models.ridge import SSRidge


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRidge')
...
def main():
    ...
    print("="*70)
    print(f" SSRidge - Party: {party_name.upper()}")
    print("="*70)
