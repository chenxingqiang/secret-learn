...
"""
Usage Example for SSPolynomialFeatures

Usage:
    Terminal 1: python polynomial_features.py --party bob
    Terminal 2: python polynomial_features.py --party alice

This example demonstrates how to use the privacy-preserving PolynomialFeatures
...
from secretlearn.SS.preprocessing.polynomial_features import SSPolynomialFeatures


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPolynomialFeatures')
...
def main():
    ...
    print("="*70)
    print(f" SSPolynomialFeatures - Party: {party_name.upper()}")
    print("="*70)
