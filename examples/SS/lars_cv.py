...
"""
Usage Example for SSLarsCV

Usage:
    Terminal 1: python lars_cv.py --party bob
    Terminal 2: python lars_cv.py --party alice
...
from secretlearn.SS.linear_models.lars_cv import SSLarsCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLarsCV')
...
def main():
    ...
    print("="*70)
    print(f" SSLarsCV - Party: {party_name.upper()}")
    print("="*70)
