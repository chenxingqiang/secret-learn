...
"""
Usage Example for SSExtraTreesClassifier

Usage:
    Terminal 1: python extra_trees_classifier.py --party bob
    Terminal 2: python extra_trees_classifier.py --party alice

This example demonstrates how to use the privacy-preserving ExtraTreesClassifier
...
from secretlearn.SS.ensemble.extra_trees_classifier import SSExtraTreesClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSExtraTreesClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSExtraTreesClassifier - Party: {party_name.upper()}")
    print("="*70)
