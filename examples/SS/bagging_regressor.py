...
"""
Usage Example for SSBaggingRegressor

Usage:
    Terminal 1: python bagging_regressor.py --party bob
    Terminal 2: python bagging_regressor.py --party alice

This example demonstrates how to use the privacy-preserving BaggingRegressor
...
from secretlearn.SS.ensemble.bagging_regressor import SSBaggingRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBaggingRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSBaggingRegressor - Party: {party_name.upper()}")
    print("="*70)
