...
"""
Usage Example for SSStackingClassifier

Usage:
    Terminal 1: python stacking_classifier.py --party bob
    Terminal 2: python stacking_classifier.py --party alice

This example demonstrates how to use the privacy-preserving StackingClassifier
...
from secretlearn.SS.ensemble.stacking_classifier import SSStackingClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSStackingClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSStackingClassifier - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSStackingClassifier...")
    ...
    model = FLStackingClassifier(devices)
