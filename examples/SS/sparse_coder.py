...
Usage:
    Terminal 1: python sparse_coder.py --party bob
    Terminal 2: python sparse_coder.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSparseCoder')
...
def main():
    ...
    print("="*70)
    print(f" SSSparseCoder - Party: {party_name.upper()}")
    print("="*70)
