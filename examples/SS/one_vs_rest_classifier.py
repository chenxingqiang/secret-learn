...
"""
Usage Example for SSOneVsRestClassifier

Usage:
    Terminal 1: python one_vs_rest_classifier.py --party bob
    Terminal 2: python one_vs_rest_classifier.py --party alice

This example demonstrates how to use the privacy-preserving OneVsRestClassifier
...
from secretlearn.SS.multiclass.one_vs_rest_classifier import SSOneVsRestClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOneVsRestClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSOneVsRestClassifier - Party: {party_name.upper()}")
    print("="*70)
