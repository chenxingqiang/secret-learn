...
"""
Usage Example for SSDummyRegressor

Usage:
    Terminal 1: python dummy_regressor.py --party bob
    Terminal 2: python dummy_regressor.py --party alice

This example demonstrates how to use the privacy-preserving DummyRegressor
...
from secretlearn.SS.dummy.dummy_regressor import SSDummyRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSDummyRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSDummyRegressor - Party: {party_name.upper()}")
    print("="*70)
