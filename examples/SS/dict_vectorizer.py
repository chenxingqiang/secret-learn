...
"""
Usage Example for SSDictVectorizer

Usage:
    Terminal 1: python dict_vectorizer.py --party bob
    Terminal 2: python dict_vectorizer.py --party alice

This example demonstrates how to use the privacy-preserving DictVectorizer
...
from secretlearn.SS.feature_extraction.dict_vectorizer import SSDictVectorizer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSDictVectorizer')
...
def main():
    ...
    print("="*70)
    print(f" SSDictVectorizer - Party: {party_name.upper()}")
    print("="*70)
    ...
    model = FLDictVectorizer(devices)
