...
"""
Usage Example for SSStackingRegressor

Usage:
    Terminal 1: python stacking_regressor.py --party bob
    Terminal 2: python stacking_regressor.py --party alice

This example demonstrates how to use the privacy-preserving StackingRegressor
...
from secretlearn.SS.ensemble.stacking_regressor import SSStackingRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSStackingRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSStackingRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSStackingRegressor...")
    ...
    model = FLStackingRegressor(devices)
