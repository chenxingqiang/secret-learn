...
Usage:
    Terminal 1: python nystroem.py --party bob
    Terminal 2: python nystroem.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNystroem')
...
def main():
    ...
    print("="*70)
    print(f" SSNystroem - Party: {party_name.upper()}")
    print("="*70)
