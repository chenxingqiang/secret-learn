...
"""
Usage Example for SSNeighborhoodComponentsAnalysis

Usage:
    Terminal 1: python neighborhood_components_analysis.py --party bob
    Terminal 2: python neighborhood_components_analysis.py --party alice

This example demonstrates how to use the privacy-preserving NeighborhoodComponentsAnalysis
...
from secretlearn.SS.neighbors.neighborhood_components_analysis import SSNeighborhoodComponentsAnalysis


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNeighborhoodComponentsAnalysis')
...
def main():
    ...
    print("="*70)
    print(f" SSNeighborhoodComponentsAnalysis - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSNeighborhoodComponentsAnalysis...")
