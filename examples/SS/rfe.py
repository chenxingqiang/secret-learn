...
"""
Usage Example for SSRfe

Usage:
    Terminal 1: python rfe.py --party bob
    Terminal 2: python rfe.py --party alice
...
from secretlearn.SS.feature_selection.rfe import SSRfe


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRfe')
...
def main():
    ...
    print("="*70)
    print(f" SSRfe - Party: {party_name.upper()}")
    print("="*70)
