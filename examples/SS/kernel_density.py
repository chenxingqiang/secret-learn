...
"""
Usage Example for SSKernelDensity

Usage:
    Terminal 1: python kernel_density.py --party bob
    Terminal 2: python kernel_density.py --party alice

This example demonstrates how to use the privacy-preserving KernelDensity
...
from secretlearn.SS.neighbors.kernel_density import SSKernelDensity


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKernelDensity')
...
def main():
    ...
    print("="*70)
    print(f" SSKernelDensity - Party: {party_name.upper()}")
    print("="*70)
