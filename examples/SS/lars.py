...
Usage:
    Terminal 1: python lars.py --party bob
    Terminal 2: python lars.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLars')
...
def main():
    ...
    print("="*70)
    print(f" SSLars - Party: {party_name.upper()}")
    print("="*70)
