...
"""
Usage Example for SSAffinityPropagation

Usage:
    Terminal 1: python affinity_propagation.py --party bob
    Terminal 2: python affinity_propagation.py --party alice

This example demonstrates how to use the privacy-preserving AffinityPropagation
...
from secretlearn.SS.clustering.affinity_propagation import SSAffinityPropagation


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSAffinityPropagation')
...
def main():
    ...
    print("="*70)
    print(f" SSAffinityPropagation - Party: {party_name.upper()}")
    print("="*70)
