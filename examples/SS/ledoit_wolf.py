...
"""
Usage Example for SSLedoitWolf

Usage:
    Terminal 1: python ledoit_wolf.py --party bob
    Terminal 2: python ledoit_wolf.py --party alice
...
from secretlearn.SS.covariance.ledoit_wolf import SSLedoitWolf


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLedoitWolf')
...
def main():
    ...
    print("="*70)
    print(f" SSLedoitWolf - Party: {party_name.upper()}")
    print("="*70)
