...
"""
Usage Example for SSMiniBatchSparsePCA

Usage:
    Terminal 1: python mini_batch_sparse_pca.py --party bob
    Terminal 2: python mini_batch_sparse_pca.py --party alice

This example demonstrates how to use the privacy-preserving MiniBatchSparsePca
...
from secretlearn.SS.decomposition.mini_batch_sparse_pca import SSMiniBatchSparsePCA


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMiniBatchSparsePCA')
...
def main():
    ...
    print("="*70)
    print(f" SSMiniBatchSparsePCA - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMiniBatchSparsePCA...")
    ...
    model = SSMiniBatchSparsePCA(spu)
