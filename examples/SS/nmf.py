...
"""
Usage Example for SSNmf

Usage:
    Terminal 1: python nmf.py --party bob
    Terminal 2: python nmf.py --party alice
...
from secretlearn.SS.decomposition.nmf import SSNmf


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSNmf')
...
def main():
    ...
    print("="*70)
    print(f" SSNmf - Party: {party_name.upper()}")
    print("="*70)
