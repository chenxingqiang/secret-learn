...
"""
Usage Example for SSMiniBatchNmf

Usage:
    Terminal 1: python mini_batch_nmf.py --party bob
    Terminal 2: python mini_batch_nmf.py --party alice

This example demonstrates how to use the privacy-preserving MiniBatchNmf
...
from secretlearn.SS.decomposition.mini_batch_nmf import SSMiniBatchNmf


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMiniBatchNmf')
...
def main():
    ...
    print("="*70)
    print(f" SSMiniBatchNmf - Party: {party_name.upper()}")
    print("="*70)
