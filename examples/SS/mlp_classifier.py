...
"""
Usage Example for SSMLPClassifier

Usage:
    Terminal 1: python mlp_classifier.py --party bob
    Terminal 2: python mlp_classifier.py --party alice

This example demonstrates how to use the privacy-preserving MlpClassifier
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMLPClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSMLPClassifier - Party: {party_name.upper()}")
    print("="*70)
