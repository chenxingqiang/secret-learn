...
"""
Usage Example for SSLabelPropagation

Usage:
    Terminal 1: python label_propagation.py --party bob
    Terminal 2: python label_propagation.py --party alice

This example demonstrates how to use the privacy-preserving LabelPropagation
...
from secretlearn.SS.semi_supervised.label_propagation import SSLabelPropagation


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLabelPropagation')
...
def main():
    ...
    print("="*70)
    print(f" SSLabelPropagation - Party: {party_name.upper()}")
    print("="*70)
