...
"""
Usage Example for SSSpectralBiclustering

Usage:
    Terminal 1: python spectral_biclustering.py --party bob
    Terminal 2: python spectral_biclustering.py --party alice

This example demonstrates how to use the privacy-preserving SpectralBiclustering
...
from secretlearn.SS.clustering.spectral_biclustering import SSSpectralBiclustering


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSpectralBiclustering')
...
def main():
    ...
    print("="*70)
    print(f" SSSpectralBiclustering - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSSpectralBiclustering...")
    ...
    model = FLSpectralBiclustering(devices)
