...
"""
Usage Example for SSKNeighborsRegressor

Usage:
    Terminal 1: python k_neighbors_regressor.py --party bob
    Terminal 2: python k_neighbors_regressor.py --party alice

This example demonstrates how to use the privacy-preserving KNeighborsRegressor
...
from secretlearn.SS.neighbors.k_neighbors_regressor import SSKNeighborsRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKNeighborsRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSKNeighborsRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSKNeighborsRegressor...")
    ...
    model = SSKNeighborsRegressor(spu)
