...
Usage:
    Terminal 1: python select_fpr.py --party bob
    Terminal 2: python select_fpr.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSelectFpr')
...
def main():
    ...
    print("="*70)
    print(f" SSSelectFpr - Party: {party_name.upper()}")
    print("="*70)
