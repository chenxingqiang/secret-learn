...
"""
Usage Example for SSSGDOneClassSVM

Usage:
    Terminal 1: python sgd_one_class_svm.py --party bob
    Terminal 2: python sgd_one_class_svm.py --party alice

This example demonstrates how to use the privacy-preserving SgdOneClassSvm
...
from secretlearn.SS.linear_models.sgd_one_class_svm import SSSGDOneClassSVM


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSGDOneClassSVM')
...
def main():
    ...
    print("="*70)
    print(f" SSSGDOneClassSVM - Party: {party_name.upper()}")
    print("="*70)
