...
"""
Usage Example for SSSparseRandomProjection

Usage:
    Terminal 1: python sparse_random_projection.py --party bob
    Terminal 2: python sparse_random_projection.py --party alice

This example demonstrates how to use the privacy-preserving SparseRandomProjection
...
from secretlearn.SS.random_projection.sparse_random_projection import SSSparseRandomProjection


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSparseRandomProjection')
...
def main():
    ...
    print("="*70)
    print(f" SSSparseRandomProjection - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSSparseRandomProjection...")
    ...
    model = FLSparseRandomProjection(devices)
