...
"""
Usage Example for SSSpectralClustering

Usage:
    Terminal 1: python spectral_clustering.py --party bob
    Terminal 2: python spectral_clustering.py --party alice

This example demonstrates how to use the privacy-preserving SpectralClustering
...
from secretlearn.SS.clustering.spectral_clustering import SSSpectralClustering


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSpectralClustering')
...
def main():
    ...
    print("="*70)
    print(f" SSSpectralClustering - Party: {party_name.upper()}")
    print("="*70)
