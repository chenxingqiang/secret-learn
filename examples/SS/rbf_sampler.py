...
"""
Usage Example for SSRBFSampler

Usage:
    Terminal 1: python rbf_sampler.py --party bob
    Terminal 2: python rbf_sampler.py --party alice
...
from secretlearn.SS.kernel_approximation.rbf_sampler import SSRBFSampler


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRBFSampler')
...
def main():
    ...
    print("="*70)
    print(f" SSRBFSampler - Party: {party_name.upper()}")
    print("="*70)
