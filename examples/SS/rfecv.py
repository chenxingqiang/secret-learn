...
"""
Usage Example for SSRFECV

Usage:
    Terminal 1: python rfecv.py --party bob
    Terminal 2: python rfecv.py --party alice
...
from secretlearn.SS.feature_selection.rfecv import SSRFECV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRFECV')
...
def main():
    ...
    print("="*70)
    print(f" SSRFECV - Party: {party_name.upper()}")
    print("="*70)
