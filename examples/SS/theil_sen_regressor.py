...
"""
Usage Example for SSTheilSenRegressor

Usage:
    Terminal 1: python theil_sen_regressor.py --party bob
    Terminal 2: python theil_sen_regressor.py --party alice

This example demonstrates how to use the privacy-preserving TheilSenRegressor
...
from secretlearn.SS.linear_models.theil_sen_regressor import SSTheilSenRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSTheilSenRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSTheilSenRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSTheilSenRegressor...")
    ...
    model = FLTheilSenRegressor(devices)
