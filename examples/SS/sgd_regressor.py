...
"""
Usage Example for SSSgdRegressor

Usage:
    Terminal 1: python sgd_regressor.py --party bob
    Terminal 2: python sgd_regressor.py --party alice
...
from secretlearn.SS.linear_models.sgd_regressor import SSSgdRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSgdRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSSgdRegressor - Party: {party_name.upper()}")
    print("="*70)
