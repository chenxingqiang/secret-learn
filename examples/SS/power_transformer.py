...
"""
Usage Example for SSPowerTransformer

Usage:
    Terminal 1: python power_transformer.py --party bob
    Terminal 2: python power_transformer.py --party alice

This example demonstrates how to use the privacy-preserving PowerTransformer
...
from secretlearn.SS.preprocessing.power_transformer import SSPowerTransformer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPowerTransformer')
...
def main():
    ...
    print("="*70)
    print(f" SSPowerTransformer - Party: {party_name.upper()}")
    print("="*70)
