...
"""
Usage Example for SSKmeans

Usage:
    Terminal 1: python kmeans.py --party bob
    Terminal 2: python kmeans.py --party alice
...
def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKmeans')
...
def main():
    ...
    print("="*70)
    print(f" SSKmeans - Party: {party_name.upper()}")
    print("="*70)
