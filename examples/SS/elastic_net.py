...
"""
Usage Example for SSElasticNet

Usage:
    Terminal 1: python elastic_net.py --party bob
    Terminal 2: python elastic_net.py --party alice
...
from secretlearn.SS.linear_models.elastic_net import SSElasticNet


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSElasticNet')
...
def main():
    ...
    print("="*70)
    print(f" SSElasticNet - Party: {party_name.upper()}")
    print("="*70)
