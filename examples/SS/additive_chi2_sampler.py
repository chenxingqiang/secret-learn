...
"""
Usage Example for SSAdditiveChi2Sampler

Usage:
    Terminal 1: python additive_chi2_sampler.py --party bob
    Terminal 2: python additive_chi2_sampler.py --party alice

This example demonstrates how to use the privacy-preserving AdditiveChi2Sampler
...
from secretlearn.SS.kernel_approximation.additive_chi2_sampler import SSAdditiveChi2Sampler


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSAdditiveChi2Sampler')
...
def main():
    ...
    print("="*70)
    print(f" SSAdditiveChi2Sampler - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSAdditiveChi2Sampler...")
    ...
    model = FLAdditiveChi2Sampler(devices)
