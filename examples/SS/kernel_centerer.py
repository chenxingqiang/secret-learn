...
"""
Usage Example for SSKernelCenterer

Usage:
    Terminal 1: python kernel_centerer.py --party bob
    Terminal 2: python kernel_centerer.py --party alice

This example demonstrates how to use the privacy-preserving KernelCenterer
...
from secretlearn.SS.preprocessing.kernel_centerer import SSKernelCenterer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKernelCenterer')
...
def main():
    ...
    print("="*70)
    print(f" SSKernelCenterer - Party: {party_name.upper()}")
    print("="*70)
    ...
    model = FLKernelCenterer(devices)
