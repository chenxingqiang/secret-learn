...
"""
Usage Example for SSEllipticEnvelope

Usage:
    Terminal 1: python elliptic_envelope.py --party bob
    Terminal 2: python elliptic_envelope.py --party alice

This example demonstrates how to use the privacy-preserving EllipticEnvelope
...
from secretlearn.SS.covariance.elliptic_envelope import SSEllipticEnvelope


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSEllipticEnvelope')
...
def main():
    ...
    print("="*70)
    print(f" SSEllipticEnvelope - Party: {party_name.upper()}")
    print("="*70)
