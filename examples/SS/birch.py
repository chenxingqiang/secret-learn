...
"""
Usage Example for SSBirch

Usage:
    Terminal 1: python birch.py --party bob
    Terminal 2: python birch.py --party alice
...
from secretlearn.SS.clustering.birch import SSBirch


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSBirch')
...
def main():
    ...
    print("="*70)
    print(f" SSBirch - Party: {party_name.upper()}")
    print("="*70)
