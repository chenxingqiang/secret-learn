...
"""
Usage Example for SSSparsePCA

Usage:
    Terminal 1: python sparse_pca.py --party bob
    Terminal 2: python sparse_pca.py --party alice
...
from secretlearn.SS.decomposition.sparse_pca import SSSparsePCA


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSparsePCA')
...
def main():
    ...
    print("="*70)
    print(f" SSSparsePCA - Party: {party_name.upper()}")
    print("="*70)
