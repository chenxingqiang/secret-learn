...
"""
Usage Example for SSPca

Usage:
    Terminal 1: python pca.py --party bob
    Terminal 2: python pca.py --party alice

This example demonstrates how to use the privacy-preserving Pca
...
from secretlearn.SS.decomposition.pca import SSPca


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPca')
...
def main():
    ...
    print("="*70)
    print(f" SSPca - Party: {party_name.upper()}")
    print("="*70)
