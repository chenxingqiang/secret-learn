...
"""
Usage Example for SSMLPRegressor

Usage:
    Terminal 1: python mlp_regressor.py --party bob
    Terminal 2: python mlp_regressor.py --party alice
...
from secretlearn.SS.neural_network.mlp_regressor import SSMLPRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMLPRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSMLPRegressor - Party: {party_name.upper()}")
    print("="*70)
