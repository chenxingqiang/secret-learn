...
"""
Usage Example for SSMultiTaskLassoCV

Usage:
    Terminal 1: python multi_task_lasso_cv.py --party bob
    Terminal 2: python multi_task_lasso_cv.py --party alice

This example demonstrates how to use the privacy-preserving MultiTaskLassoCv
...
from secretlearn.SS.linear_models.multi_task_lasso_cv import SSMultiTaskLassoCV


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMultiTaskLassoCV')
...
def main():
    ...
    print("="*70)
    print(f" SSMultiTaskLassoCV - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMultiTaskLassoCV...")
