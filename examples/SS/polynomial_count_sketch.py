...
"""
Usage Example for SSPolynomialCountSketch

Usage:
    Terminal 1: python polynomial_count_sketch.py --party bob
    Terminal 2: python polynomial_count_sketch.py --party alice

This example demonstrates how to use the privacy-preserving PolynomialCountSketch
...
from secretlearn.SS.kernel_approximation.polynomial_count_sketch import SSPolynomialCountSketch


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPolynomialCountSketch')
...
def main():
    ...
    print("="*70)
    print(f" SSPolynomialCountSketch - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSPolynomialCountSketch...")
    ...
    model = FLPolynomialCountSketch(devices)
