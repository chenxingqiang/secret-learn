...
"""
Usage Example for SSMultiLabelBinarizer

Usage:
    Terminal 1: python multi_label_binarizer.py --party bob
    Terminal 2: python multi_label_binarizer.py --party alice

This example demonstrates how to use the privacy-preserving MultiLabelBinarizer
...
from secretlearn.SS.preprocessing.multi_label_binarizer import SSMultiLabelBinarizer


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMultiLabelBinarizer')
...
def main():
    ...
    print("="*70)
    print(f" SSMultiLabelBinarizer - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMultiLabelBinarizer...")
    ...
    model = FLMultiLabelBinarizer(devices)
