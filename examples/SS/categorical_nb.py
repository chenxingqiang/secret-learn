...
"""
Usage Example for SSCategoricalNB

Usage:
    Terminal 1: python categorical_nb.py --party bob
    Terminal 2: python categorical_nb.py --party alice
...
from secretlearn.SS.naive_bayes.categorical_nb import SSCategoricalNB


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSCategoricalNB')
...
def main():
    ...
    print("="*70)
    print(f" SSCategoricalNB - Party: {party_name.upper()}")
    print("="*70)
