...
"""
Usage Example for SSLasso

Usage:
    Terminal 1: python lasso.py --party bob
    Terminal 2: python lasso.py --party alice
...
from secretlearn.SS.linear_models.lasso import SSLasso


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSLasso')
...
def main():
    ...
    print("="*70)
    print(f" SSLasso - Party: {party_name.upper()}")
    print("="*70)
