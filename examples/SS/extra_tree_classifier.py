...
"""
Usage Example for SSExtraTreeClassifier

Usage:
    Terminal 1: python extra_tree_classifier.py --party bob
    Terminal 2: python extra_tree_classifier.py --party alice

This example demonstrates how to use the privacy-preserving ExtraTreeClassifier
...
from secretlearn.SS.tree.extra_tree_classifier import SSExtraTreeClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSExtraTreeClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSExtraTreeClassifier - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSExtraTreeClassifier...")
    ...
    model = FLExtraTreeClassifier(devices)
