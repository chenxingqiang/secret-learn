...
"""
Usage Example for SSTsne

Usage:
    Terminal 1: python tsne.py --party bob
    Terminal 2: python tsne.py --party alice
...
from secretlearn.SS.manifold.tsne import SSTsne


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSTsne')
...
def main():
    ...
    print("="*70)
    print(f" SSTsne - Party: {party_name.upper()}")
    print("="*70)
