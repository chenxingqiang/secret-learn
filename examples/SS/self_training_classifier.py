...
"""
Usage Example for SSSelfTrainingClassifier

Usage:
    Terminal 1: python self_training_classifier.py --party bob
    Terminal 2: python self_training_classifier.py --party alice

This example demonstrates how to use the privacy-preserving SelfTrainingClassifier
...
from secretlearn.SS.semi_supervised.self_training_classifier import SSSelfTrainingClassifier


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSelfTrainingClassifier')
...
def main():
    ...
    print("="*70)
    print(f" SSSelfTrainingClassifier - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSSelfTrainingClassifier...")
    ...
    model = FLSelfTrainingClassifier(devices)
