...
"""
Usage Example for SSSpectralCoclustering

Usage:
    Terminal 1: python spectral_coclustering.py --party bob
    Terminal 2: python spectral_coclustering.py --party alice

This example demonstrates how to use the privacy-preserving SpectralCoclustering
...
from secretlearn.SS.clustering.spectral_coclustering import SSSpectralCoclustering


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSpectralCoclustering')
...
def main():
    ...
    print("="*70)
    print(f" SSSpectralCoclustering - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSSpectralCoclustering...")
    ...
    model = FLSpectralCoclustering(devices)
