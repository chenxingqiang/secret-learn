...
"""
Usage Example for SSMissingIndicator

Usage:
    Terminal 1: python missing_indicator.py --party bob
    Terminal 2: python missing_indicator.py --party alice

This example demonstrates how to use the privacy-preserving MissingIndicator
...
from secretlearn.SS.impute.missing_indicator import SSMissingIndicator


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMissingIndicator')
...
def main():
    ...
    print("="*70)
    print(f" SSMissingIndicator - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSMissingIndicator...")
    ...
    model = FLMissingIndicator(devices)
