...
"""
Usage Example for SSPoissonRegressor

Usage:
    Terminal 1: python poisson_regressor.py --party bob
    Terminal 2: python poisson_regressor.py --party alice

This example demonstrates how to use the privacy-preserving PoissonRegressor
...
from secretlearn.SS.linear_models.poisson_regressor import SSPoissonRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSPoissonRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSPoissonRegressor - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSPoissonRegressor...")
    ...
    model = FLPoissonRegressor(devices)
