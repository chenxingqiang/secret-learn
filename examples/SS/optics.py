...
"""
Usage Example for SSOPTICS

Usage:
    Terminal 1: python optics.py --party bob
    Terminal 2: python optics.py --party alice
...
from secretlearn.SS.clustering.optics import SSOPTICS


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSOPTICS')
...
def main():
    ...
    print("="*70)
    print(f" SSOPTICS - Party: {party_name.upper()}")
    print("="*70)
