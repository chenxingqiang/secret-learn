...
"""
Usage Example for SSKernelRidge

Usage:
    Terminal 1: python kernel_ridge.py --party bob
    Terminal 2: python kernel_ridge.py --party alice
...
from secretlearn.SS.kernel_ridge.kernel_ridge import SSKernelRidge


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSKernelRidge')
...
def main():
    ...
    print("="*70)
    print(f" SSKernelRidge - Party: {party_name.upper()}")
    print("="*70)
