...
"""
Usage Example for SSSvr

Usage:
    Terminal 1: python svr.py --party bob
    Terminal 2: python svr.py --party alice
...
from secretlearn.SS.svm.svr import SSSvr


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSSvr')
...
def main():
    ...
    print("="*70)
    print(f" SSSvr - Party: {party_name.upper()}")
    print("="*70)
