...
"""
Usage Example for SSIsomap

Usage:
    Terminal 1: python isomap.py --party bob
    Terminal 2: python isomap.py --party alice
...
from secretlearn.SS.manifold.isomap import SSIsomap


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSIsomap')
...
def main():
    ...
    print("="*70)
    print(f" SSIsomap - Party: {party_name.upper()}")
    print("="*70)
