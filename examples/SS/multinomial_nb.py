...
"""
Usage Example for SSMultinomialNB

Usage:
    Terminal 1: python multinomial_nb.py --party bob
    Terminal 2: python multinomial_nb.py --party alice

This example demonstrates how to use the privacy-preserving MultinomialNb
...
from secretlearn.SS.naive_bayes.multinomial_nb import SSMultinomialNB


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMultinomialNB')
...
def main():
    ...
    print("="*70)
    print(f" SSMultinomialNB - Party: {party_name.upper()}")
    print("="*70)
