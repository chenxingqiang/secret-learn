...
"""
Usage Example for SSRandomTreesEmbedding

Usage:
    Terminal 1: python random_trees_embedding.py --party bob
    Terminal 2: python random_trees_embedding.py --party alice

This example demonstrates how to use the privacy-preserving RandomTreesEmbedding
...
from secretlearn.SS.ensemble.random_trees_embedding import SSRandomTreesEmbedding


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSRandomTreesEmbedding')
...
def main():
    ...
    print("="*70)
    print(f" SSRandomTreesEmbedding - Party: {party_name.upper()}")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSRandomTreesEmbedding...")
    ...
    model = FLRandomTreesEmbedding(devices)
