...
"""
Usage Example for SSMinCovDet

Usage:
    Terminal 1: python min_cov_det.py --party bob
    Terminal 2: python min_cov_det.py --party alice
...
from secretlearn.SS.covariance.min_cov_det import SSMinCovDet


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSMinCovDet')
...
def main():
    ...
    print("="*70)
    print(f" SSMinCovDet - Party: {party_name.upper()}")
    print("="*70)
