...
:func:`~xlearn.model_selection.cross_val_predict` together with
:class:`~xlearn.metrics.PredictionErrorDisplay` to visualize prediction
errors.
"""
...
# %%
# :func:`~xlearn.model_selection.cross_val_predict` returns an array of the
...
# :class:`~xlearn.metrics.PredictionErrorDisplay` to visualize the
# prediction errors.
#
...
# :func:`~xlearn.model_selection.cross_val_predict` for visualization
...
# :func:`~xlearn.model_selection.cross_val_score` or
# :func:`~xlearn.model_selection.cross_validate` instead.
