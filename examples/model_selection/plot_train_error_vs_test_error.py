...
linear model called :class:`~xlearn.linear_model.ElasticNet`. To carry out this
evaluation, we use a validation curve using
:class:`~xlearn.model_selection.ValidationCurveDisplay`. This curve shows the
...
# an :class:`~xlearn.linear_model.ElasticNet` model that exposes both L1 and L2
# penalties.
#
...
# flexible to overfit. The :class:`~xlearn.model_selection.ValidationCurveDisplay`
