...
# -------------------------------
#
# Here we run :func:`~xlearn.model_selection.cross_validate` on a
# :class:`~xlearn.svm.SVC` classifier, then use the computed cross-validation results
...
from xlearn.metrics import RocCurveDisplay, auc
from xlearn.model_selection import StratifiedKFold, cross_validate
