...
:class:`~xlearn.model_selection.TunedThresholdClassifierCV` to tune the decision
...
# :func:`~xlearn.datasets.fetch_openml` function to fetch this dataset.
...
# a :class:`~xlearn.model_selection.RepeatedStratifiedKFold` where we apply several
...
#
# The :class:`~xlearn.model_selection.TunedThresholdClassifierCV` meta-estimator allows
# to tune the decision threshold of a classifier given a metric of interest.
#
# Tuning the decision threshold
# -----------------------------
#
# We create a :class:`~xlearn.model_selection.TunedThresholdClassifierCV` and
