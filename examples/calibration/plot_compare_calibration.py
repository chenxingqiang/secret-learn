...
# -----------------------
#
# :class:`~xlearn.linear_model.LogisticRegressionCV` returns reasonably well
...
# :class:`~xlearn.linear_model.LogisticRegressionCV` class was configured to
...
#
# * :class:`~xlearn.naive_bayes.GaussianNB` tends to push probabilities to 0
...
#
# * :class:`~xlearn.svm.LinearSVC` is not a natural probabilistic classifier.
...
#   methods [1]_.
#
# * :class:`~xlearn.ensemble.RandomForestClassifier`'s prediction histogram
