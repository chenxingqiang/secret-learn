...
parsed_version = parse(xlearn.__version__)
...
default_global_config = xlearn.get_config()


def reset_xlearn_config(gallery_conf, fname):
    """Reset xlearn config to default values."""
    xlearn.set_config(**default_global_config)
...
sphinx_gallery_conf = {
    ...
    "reset_modules": ("matplotlib", "seaborn", reset_xlearn_config),
}
if with_jupyterlite:
...
from xlearn.experimental import (  # noqa: F401
...
if os.environ.get("XLEARN_WARNINGS_AS_ERRORS", "0") != "0":
    turn_warnings_into_errors()

# maps functions with a class name that is indistinguishable when case is
# ignore to another filename
autosummary_filename_map = {
    "xlearn.cluster.dbscan": "dbscan-function",
    "xlearn.covariance.oas": "oas-function",
    "xlearn.decomposition.fastica": "fastica-function",
}
