...
- :class:`xlearn.compose.TransformedTargetRegressor`
- :class:`xlearn.covariance.GraphicalLassoCV`
- :class:`xlearn.ensemble.StackingClassifier`
- :class:`xlearn.ensemble.StackingRegressor`
- :class:`xlearn.ensemble.VotingClassifier`
- :class:`xlearn.ensemble.VotingRegressor`
- :class:`xlearn.ensemble.BaggingClassifier`
- :class:`xlearn.ensemble.BaggingRegressor`
- :class:`xlearn.feature_selection.RFE`
- :class:`xlearn.feature_selection.RFECV`
- :class:`xlearn.feature_selection.SelectFromModel`
- :class:`xlearn.feature_selection.SequentialFeatureSelector`
- :class:`xlearn.impute.IterativeImputer`
- :class:`xlearn.linear_model.ElasticNetCV`
- :class:`xlearn.linear_model.LarsCV`
- :class:`xlearn.linear_model.LassoCV`
- :class:`xlearn.linear_model.LassoLarsCV`
- :class:`xlearn.linear_model.LogisticRegressionCV`
- :class:`xlearn.linear_model.MultiTaskElasticNetCV`
- :class:`xlearn.linear_model.MultiTaskLassoCV`
- :class:`xlearn.linear_model.OrthogonalMatchingPursuitCV`
- :class:`xlearn.linear_model.RANSACRegressor`
- :class:`xlearn.linear_model.RidgeClassifierCV`
- :class:`xlearn.linear_model.RidgeCV`
- :class:`xlearn.model_selection.GridSearchCV`
- :class:`xlearn.model_selection.HalvingGridSearchCV`
- :class:`xlearn.model_selection.HalvingRandomSearchCV`
- :class:`xlearn.model_selection.RandomizedSearchCV`
- :class:`xlearn.model_selection.permutation_test_score`
- :func:`xlearn.model_selection.cross_validate`
- :func:`xlearn.model_selection.cross_val_score`
- :func:`xlearn.model_selection.cross_val_predict`
- :class:`xlearn.model_selection.learning_curve`
- :class:`xlearn.model_selection.validation_curve`
- :class:`xlearn.multiclass.OneVsOneClassifier`
- :class:`xlearn.multiclass.OneVsRestClassifier`
- :class:`xlearn.multiclass.OutputCodeClassifier`
- :class:`xlearn.multioutput.ClassifierChain`
- :class:`xlearn.multioutput.MultiOutputClassifier`
- :class:`xlearn.multioutput.MultiOutputRegressor`
- :class:`xlearn.multioutput.RegressorChain`
- :class:`xlearn.pipeline.FeatureUnion`
- :class:`xlearn.pipeline.Pipeline`
- :class:`xlearn.semi_supervised.SelfTrainingClassifier`

Meta-estimators and tools not supporting metadata routing yet:

- :class:`xlearn.ensemble.AdaBoostClassifier`
- :class:`xlearn.ensemble.AdaBoostRegressor`
