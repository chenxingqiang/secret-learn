...
def _get_submodule(module_name, submodule_name):
    ...
    `module_name` is e.g. `xlearn.feature_extraction`, and `submodule_name` is e.g.
    `image`, so we get the docstring and hook for `xlearn.feature_extraction.image`
...
e.g., `xlearn.feature_extraction`, the hook would be `feature_extraction_ref`; for a
section, e.g., "From text" under `xlearn.feature_extraction`, the hook would be
`feature_extraction_ref-from-text`. However, note that a better way is to refer using
the :mod: directive, e.g., :mod:`xlearn.feature_extraction` for the module and
:mod:`xlearn.feature_extraction.text` for the section. Only in case that a section
is not a particular submodule does the hook become useful, e.g., the "Loaders" section
under `xlearn.datasets`.
"""
...
API_REFERENCE = {
    ...
    "xlearn.feature_extraction": {
        ...
        "sections": [
            ...
            {
                "title": "From images",
                "description": _get_submodule("xlearn.feature_extraction", "image"),
                "autosummary": [
            ...
            {
                "title": "From text",
                "description": _get_submodule("xlearn.feature_extraction", "text"),
                "autosummary": [
    ...
    "xlearn.gaussian_process": {
        ...
        "sections": [
            ...
            {
                "title": "Kernels",
                "description": _get_submodule("xlearn.gaussian_process", "kernels"),
                "autosummary": [
        ...
        "sections": [
            ...
            },
            {
                ...
                "description": (
                    ...
                    ":class:`~xlearn.linear_model.SGDClassifier` with an appropriate "
                    "penalty."
                ),
                "autosummary": [
                    "ElasticNet",
    ...
    "xlearn.metrics": {
        ...
        "sections": [
            ...
            },
            {
                ...
                "description": (
                    _get_submodule("xlearn.metrics", "cluster")
                    + "\n\n"
            ...
            },
            {
                ...
                "description": (
                    _get_submodule("xlearn.metrics", "pairwise")
                    + "\n\n"
                    + _get_guide("metrics")
                ),
                "autosummary": [
    ...
    "xlearn.utils": {
        ...
        "sections": [
            ...
            },
            {
                ...
                "description": _get_submodule("xlearn.utils", "validation"),
                "autosummary": [
                    "check_X_y",
                    "check_array",
            ...
            },
            {
                ...
                "description": _get_submodule("xlearn.utils", "metaestimators"),
                "autosummary": ["metaestimators.available_if"],
            },
            {
                "title": "Weight handling based on class labels",
                "description": _get_submodule("xlearn.utils", "class_weight"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("xlearn.utils", "multiclass"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("xlearn.utils", "extmath"),
                "autosummary": [
                    "extmath.density",
                    "extmath.fast_logdet",
            ...
            },
            {
                ...
                "description": _get_submodule("xlearn.utils", "sparsefuncs"),
                "autosummary": [
            ...
            {
                "title": None,
                "description": _get_submodule("xlearn.utils", "sparsefuncs_fast"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("xlearn.utils", "estimator_checks"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("xlearn.utils", "parallel"),
                "autosummary": [
                    "parallel.Parallel",
                    "parallel.delayed",
                ],
...
Note that the autosummary here assumes that the current module is `xlearn`, i.e., if
`xlearn.utils.Memory` is deprecated, one should put `utils.Memory` in the "entries"
