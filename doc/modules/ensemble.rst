...
:class:`~xlearn.neighbors.KNeighborsClassifier` estimators, each built on random
...
.. dropdown:: Using the :class:`VotingClassifier` with :class:`~xlearn.model_selection.GridSearchCV`
