...
:class:`~xlearn.model_selection.TunedThresholdClassifierCV` tunes this threshold using
...
.. note::
    ...
    :func:`~xlearn.metrics.make_scorer`. Refer to :ref:`scoring_callable` to get
    ...
    :func:`~xlearn.metrics.f1_score`::
        ...
        >>> from xlearn.metrics import make_scorer, f1_score
...
By default :class:`~xlearn.model_selection.TunedThresholdClassifierCV` uses a 5-fold
...
:class:`~xlearn.model_selection.FixedThresholdClassifier`. In case that you don't want
to refit the model when calling `fit`, wrap your sub-estimator with a
:class:`~xlearn.frozen.FrozenEstimator` and do
