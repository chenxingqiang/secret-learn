...
- :func:`xlearn.metrics.cluster.entropy`
- :func:`xlearn.metrics.accuracy_score`
- :func:`xlearn.metrics.d2_tweedie_score`
- :func:`xlearn.metrics.explained_variance_score`
- :func:`xlearn.metrics.f1_score`
- :func:`xlearn.metrics.fbeta_score`
- :func:`xlearn.metrics.hamming_loss`
- :func:`xlearn.metrics.jaccard_score`
- :func:`xlearn.metrics.max_error`
- :func:`xlearn.metrics.mean_absolute_error`
- :func:`xlearn.metrics.mean_absolute_percentage_error`
- :func:`xlearn.metrics.mean_gamma_deviance`
- :func:`xlearn.metrics.mean_pinball_loss`
- :func:`xlearn.metrics.mean_poisson_deviance` (requires `enabling array API support for SciPy <https://docs.scipy.org/doc/scipy/dev/api-dev/array_api.html#using-array-api-standard-support>`_)
- :func:`xlearn.metrics.mean_squared_error`
- :func:`xlearn.metrics.mean_squared_log_error`
- :func:`xlearn.metrics.mean_tweedie_deviance`
- :func:`xlearn.metrics.multilabel_confusion_matrix`
- :func:`xlearn.metrics.pairwise.additive_chi2_kernel`
- :func:`xlearn.metrics.pairwise.chi2_kernel`
- :func:`xlearn.metrics.pairwise.cosine_similarity`
- :func:`xlearn.metrics.pairwise.cosine_distances`
- :func:`xlearn.metrics.pairwise.euclidean_distances` (see :ref:`device_support_for_float64`)
- :func:`xlearn.metrics.pairwise.linear_kernel`
- :func:`xlearn.metrics.pairwise.paired_cosine_distances`
- :func:`xlearn.metrics.pairwise.paired_euclidean_distances`
- :func:`xlearn.metrics.pairwise.polynomial_kernel`
- :func:`xlearn.metrics.pairwise.rbf_kernel` (see :ref:`device_support_for_float64`)
- :func:`xlearn.metrics.pairwise.sigmoid_kernel`
- :func:`xlearn.metrics.precision_score`
- :func:`xlearn.metrics.precision_recall_fscore_support`
- :func:`xlearn.metrics.r2_score`
- :func:`xlearn.metrics.recall_score`
- :func:`xlearn.metrics.root_mean_squared_error`
- :func:`xlearn.metrics.root_mean_squared_log_error`
- :func:`xlearn.metrics.zero_one_loss`
...
* :class:`~xlearn.preprocessing.TargetEncoder`, which will transform categorial
  `X` but also requires `y`, meaning both `X` and `y` need to be on CPU.
* :class:`FunctionTransformer(func=partial(torch.asarray, device="cuda")) <xlearn.preprocessing.FunctionTransformer>`,
  which moves `X` to GPU, to improve performance in the next step.
* :class:`~xlearn.linear_model.Ridge`, whose performance can be improved when
...
:func:`~xlearn.model_selection.cross_validate` or
:class:`~xlearn.model_selection.GridSearchCV`, the scoring function internally
