...
Note that recently, :class:`~xlearn.ensemble.HistGradientBoostingClassifier` and
:class:`~xlearn.ensemble.HistGradientBoostingRegressor` gained native support for
...
:mod:`xlearn.datasets` or randomly generated with functions of ``numpy.random`` with
