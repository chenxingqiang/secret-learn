...
.. prompt:: bash $
  ...
  pytest -v xlearn/linear_model/tests/test_logistic.py::test_sparsify
...
.. prompt:: bash $
  ...
  pytest xlearn/tests/test_common.py -v -k LogisticRegression
...
.. note::
    ...
    example CPU architecture reported by OpenBLAS in `xlearn.show_versions()`.
