...
for i in "${!algorithms[@]}"; do
    ...
    if python xlearn/secretflow/algorithm_migrator_standalone.py --algorithm "$algo" --mode "$mode"; then
        ((success++))
    fi
    echo ""
done
...
if python xlearn/secretflow/algorithm_migrator_standalone.py --algorithm "sklearn.ensemble.IsolationForest" --mode ss; then
    ((success++))
fi
echo ""
